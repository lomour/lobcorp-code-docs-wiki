...
Class for the Meltdown of Gold Qliphoth meltdowns (gold). On success, interrupts [An Arbiter](/api/Global/Core-Suppressions/Binah-Suppression/BinahCoreScript) and makes her tired. On failure, she gets a recovery buff.
