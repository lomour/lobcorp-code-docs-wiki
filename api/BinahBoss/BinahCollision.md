...
public class BinahCollision : MonoBehaviour
```
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → BinahCollision

## Constructors
### BinahCollision()
```csharp
public BinahCollision()
```
...
## Methods
### Init(CreatureModel, BinahCoreScript, IsolateRoom)
```csharp
...
| `isolate` | `Global.IsolateRoom` |  |

### Init(CreatureModel, BinahCoreScript, MapNode)
```csharp
