...
Clears overload blizzard particle effects, maybe? 
...
## Constructors
### BinahOverloadClearParticle()
```csharp
public BinahOverloadClearParticle()
```
...
## Methods
### Init(BinahCoreScript, Vector3, OverloadType)
```csharp
