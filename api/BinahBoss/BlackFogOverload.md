...
Class for the Meltdown of Dark Fog Qliphoth meltdowns (silver). Success makes [An Arbiter](/api/Global/Core-Suppressions/Binah-Suppression/BinahCoreScript) vulnerable to all damage.
