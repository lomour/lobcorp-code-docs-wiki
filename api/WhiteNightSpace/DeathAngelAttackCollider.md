...
public class DeathAngelAttackCollider : MonoBehaviour
```
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → DeathAngelAttackCollider

## Constructors

### DeathAngelAttackCollider()
```csharp
public DeathAngelAttackCollider()
```
