...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → [DeathAngelApostle](/api/WhiteNightSpace/DeathAngelApostle) → WandApostle
...
### Laser
```csharp
public ApostleLaser Laser { get; }
```

#### Property Value
**Type:** WhiteNightSpace.ApostleLaser

### WandAnim
```csharp
private WandApostleAnim WandAnim { get; }
```

#### Property Value
**Type:** WhiteNightSpace.WandApostleAnim
