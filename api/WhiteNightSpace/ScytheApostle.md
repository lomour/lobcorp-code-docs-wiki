...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → [DeathAngelApostle](/api/WhiteNightSpace/DeathAngelApostle) → ScytheApostle
...
### ScytheAnim
```csharp
private ScytheApostleAnim ScytheAnim { get; }
```

#### Property Value
**Type:** WhiteNightSpace.ScytheApostleAnim
...
### OnStartInstantKill(WorkerModel)
```csharp
