---
uid: WhiteNightSpace.PlagueDoctorAnim
canonical_path: /api/WhiteNightSpace/PlagueDoctorAnim
---
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → PlagueDoctorAnim
...
#### Field Value
**Type:** WhiteNightSpace.PlagueDoctorSkeletonAnim
...
### Script
```csharp
public PlagueDoctor Script { get; }
```
...
| Name | Type | Description |
| --- | --- | --- |
| `plagueDoctor` | `WhiteNightSpace.PlagueDoctor` |  |

### StartAdventNameEffect(int, string)
```csharp
