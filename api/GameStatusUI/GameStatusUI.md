...
extends , [IObserver](/api/Global/Notices/IObserver)
The in-game UI containing basically everything during management:
- [Trumpet UI](/api/GameStatusUI/EmergencyUI)
- [End-of-day / Restart UI](/api/Global/Scenes/GameSceneController)
- [Energy UI](/api/GameStatusUI/EnergyController)
- [Play speed and pause UI](/api/Global/Play-Speed-Controls/PlaySpeedSettingUI)
- [System log UI](/api/Global/UI/Work-Log/SystemLogScript)
- [Angela's messages UI](/api/Global/Conversation/Angela/AngelaConversationUI)
- [Sephirah (and other) messages UI](/api/Global/Conversation/SefiraConversationController)
...
#### Field Value
**Type:** GameStatusUI.GameStatusUI
...
#### Field Value
**Type:** GameStatusUI.EnergyController
...
#### Field Value
**Type:** Global.GameSceneController

### sefiraConversationController
```csharp
...
#### Field Value
**Type:** Global.SefiraConversationController

## Properties
### Window
```csharp
public static GameStatusUI Window { get; }
```
