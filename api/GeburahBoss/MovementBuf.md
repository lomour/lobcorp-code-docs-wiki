...
Used on [The Red Mist](/api/Global/Core-Suppressions/Gebura-Suppression/GeburahCoreScript) for her [chase attack](/api/GeburahBoss/ChaseAction) and [Gold Rush attack](/api/GeburahBoss/GreedyTelepeort) (including the [phase 4 version](/api/GeburahBoss/GreedyThrow)).

Also used to apply a slowing debuff to agents hit by projectile of the Phase 4 Gold Rush attack.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → MovementBuf
