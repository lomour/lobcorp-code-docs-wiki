...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → RenderTextureCamera

## Constructors

### RenderTextureCamera()
```csharp
public RenderTextureCamera()
```
...
### UpdatedRenderCameras
```csharp
private static Hashtable UpdatedRenderCameras
```
