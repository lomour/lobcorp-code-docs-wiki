...
## Constructors
### CreatureInfoKitLayoutController()
```csharp
...
#### Returns
**Type:** CreatureInfo.CreatureInfoKitDataSlot

### SetDataList(CreatureModel)
```csharp
...
### SetDataList(CreatureTypeInfo, CreatureObserveInfoModel)
```csharp
