---
uid: CreatureInfo.CreatureInfoKitDataSlot
canonical_path: /api/CreatureInfo/CreatureInfoKitDataSlot
---
# Class CreatureInfoKitDataSlot
...
## Constructors
### CreatureInfoKitDataSlot()
```csharp
public CreatureInfoKitDataSlot()
```
...
### positionRef
```csharp
[Header("Width Realted - no need to edit")]
...
```csharp
[SerializeField]
private float startLeftWidth
```

#### Field Value
**Type:** System.Single

### startRightPositionFix
```csharp
[SerializeField]
private float startRightPositionFix
```
...
| --- | --- | --- |
| `reference` | `UnityEngine.RectTransform` |  |
