...
**Methods:**
void SetModel([EquipmentModel](/api/Global/EGO/EquipmentModel) Model): populates class from an EquipmentModel 
void SetProb(float prob): Creates the drop chance string.

void SetEmpty(): Makes the drop chance string... none? 
void SetModel([EquipmentTypeInfo](/api/Global/EGO/EquipmentTypeInfo) info): populates class from an EquipmentTypeInfo object 
