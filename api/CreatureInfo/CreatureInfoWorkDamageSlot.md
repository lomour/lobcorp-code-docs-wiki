---
uid: CreatureInfo.CreatureInfoWorkDamageSlot
canonical_path: /api/CreatureInfo/CreatureInfoWorkDamageSlot
---
# Class CreatureInfoWorkDamageSlot
...
## Constructors
### CreatureInfoWorkDamageSlot()
```csharp
public CreatureInfoWorkDamageSlot()
```
