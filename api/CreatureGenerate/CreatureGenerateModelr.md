...
---
uid: CreatureGenerate.CreatureGenerateModelr
canonical_path: /api/CreatureGenerate/CreatureGenerateModelr
---
...
### CreatureGenerateModelr()
```csharp
public CreatureGenerateModelr()
```
