...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → AtlasRegionAttacher
...
```csharp
[SerializeField]
protected List<AtlasRegionAttacher.SlotRegionPair> attachments
```

#### Field Value
**Type:** System.Collections.Generic.List{Spine.Unity.Modules.AtlasRegionAttacher.SlotRegionPair}
