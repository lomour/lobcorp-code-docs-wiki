...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → SkeletonUtilityKinematicShadow
...
### shadowTable
```csharp
private readonly List<SkeletonUtilityKinematicShadow.TransformPair> shadowTable
```

#### Field Value
**Type:** System.Collections.Generic.List{Spine.Unity.Modules.SkeletonUtilityKinematicShadow.TransformPair}
