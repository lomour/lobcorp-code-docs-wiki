...
```csharp
public struct SkeletonRendererCustomMaterials.SlotMaterialOverride : IEquatable<SkeletonRendererCustomMaterials.SlotMaterialOverride>
```
...
| --- | --- | --- |
| `other` | `Spine.Unity.Modules.SkeletonRendererCustomMaterials.SlotMaterialOverride` |  |
