...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [SkeletonUtilityConstraint](/api/Spine/Unity/SkeletonUtilityConstraint) → SkeletonUtilityEyeConstraint
