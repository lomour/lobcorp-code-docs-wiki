...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → SpriteAttacher
...
#### Field Value
**Type:** System.Collections.Generic.Dictionary{UnityEngine.Texture,Spine.AtlasPage}
...
### AnimationOverrideSpriteAttach(ISkeletonAnimation)
```csharp
