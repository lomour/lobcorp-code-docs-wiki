...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → SkeletonGhostRenderer
...
### Initialize(Mesh, Material[], Color32, bool, float, int, int)
```csharp
