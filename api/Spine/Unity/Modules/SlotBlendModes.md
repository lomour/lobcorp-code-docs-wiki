...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → SlotBlendModes
...
#### Field Value
**Type:** System.Collections.Generic.Dictionary{Spine.Unity.Modules.SlotBlendModes.MaterialTexturePair,UnityEngine.Material}

### multiplyMaterialSource
```csharp
...
### MaterialTable
```csharp
internal static Dictionary<SlotBlendModes.MaterialTexturePair, Material> MaterialTable { get; }
```
...
### GetMaterialFor(Material, Texture2D)
```csharp
...
| --- | --- | --- |
| `materialSource` | `UnityEngine.Material` |  |
