...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → SkeletonPartsRenderer
...
### NewPartsRendererGameObject(Transform, string)
```csharp
...
### RenderParts(ExposedList<SubmeshInstruction>, int, int)
```csharp
