...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → BoneFollower
...
### HandleRebuildRenderer(SkeletonRenderer)
```csharp
