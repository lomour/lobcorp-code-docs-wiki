---
title: SkeletonUtilityBone
description: 
published: true
date: 2026-02-20T22:50:16.552Z
tags: 
editor: markdown
dateCreated: 2026-01-15T06:04:54.896Z
---

# Class SkeletonUtilityBone
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → SkeletonUtilityBone
...
## Methods
### AddBoundingBox(string, string, string)
```csharp
...
### BoneTransformModeIncompatible(Bone)
```csharp
