---
uid: Assets.Scripts.UI.Isolate.IsolateDescription
canonical_path: /api/Assets/Scripts/UI/Isolate/IsolateDescription
---

# Class IsolateDescription
...
**Type:** Assets.Scripts.UI.Isolate.DescController
...
**Type:** Assets.Scripts.UI.Isolate.IsolateDescription.OnDisplayEnd
...
```csharp
public AutoSizeSetter SizeFitter { get; }
```

#### Property Value

**Type:** Assets.Scripts.UI.Effect.Utils.AutoSizeSetter
...
| Name | Type | Description |
| --- | --- | --- |
| `end` | `Assets.Scripts.UI.Isolate.IsolateDescription.OnDisplayEnd` |  |
