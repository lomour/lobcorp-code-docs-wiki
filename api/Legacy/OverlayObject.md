...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → OverlayObject
...
### SetText(string)
```csharp
public virtual void SetText(string desc)
```
...
```csharp
public virtual void SetText(string desc, string detail)
```
