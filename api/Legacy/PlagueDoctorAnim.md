---
uid: Legacy.PlagueDoctorAnim
canonical_path: /api/Legacy/PlagueDoctorAnim
---
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → PlagueDoctorAnim
