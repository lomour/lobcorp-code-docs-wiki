...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [HierarchicalData](/api/Global/Agents-and-Clerks/Uncontrollable-Actions/UncontrollableAction) → [Uncontrollable_DeathApostle](/api/Legacy/Uncontrollable_DeathApostle) → Uncontrollable_DeathApostleRanged
