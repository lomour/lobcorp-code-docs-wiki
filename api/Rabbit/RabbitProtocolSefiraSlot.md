...
UI element representing an [operation area](/api/Global/Rabbits/RabbitOperationArea) / department, for its selection on the [Rabbit Protocol UI](/api/Rabbit/RabbitProtocolWindow).
...
## Constructors
### RabbitProtocolSefiraSlot()
```csharp
public RabbitProtocolSefiraSlot()
```
...
| Name | Type | Description |
| --- | --- | --- |
| `list` | `Rabbit.RabbitProtocolWindow.SefiraInfo` |  |
