...
public class RabbitSpriteSetter : MonoBehaviour
```
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → RabbitSpriteSetter

## Constructors

### RabbitSpriteSetter()
```csharp
public RabbitSpriteSetter()
```
...
| --- | --- | --- |
| `swordSprite` | `UnityEngine.Sprite` |  |
| `gaugeSprite` | `UnityEngine.Sprite` |  |

### ChangeSpineSprite(Skeleton, Skin, SpineChangeData)
```csharp
