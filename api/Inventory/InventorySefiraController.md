...
### InventorySefiraController()
```csharp
public InventorySefiraController()
```
...
#### Field Value
**Type:** Inventory.InventoryAgentSlot
...
```csharp
[Header("SefiraSlots")]
public List<InventorySefiraPanel> panels
```

#### Field Value
**Type:** System.Collections.Generic.List{Inventory.InventorySefiraPanel}
...
### IsLowerAreaOpened
```csharp
private bool IsLowerAreaOpened { get; }
```
...
### IsMiddleAreaOpened
```csharp
private bool IsMiddleAreaOpened { get; }
```
