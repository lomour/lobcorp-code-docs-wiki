...
**Type:** Inventory.InventoryAgentController
...
**Type:** Inventory.InventoryItemController
...
**Type:** Inventory.InventorySefiraController
...
```csharp
public AgentModel CurrentSelectedAgent { get; }
```
...
```csharp
public static InventoryUI CurrentWindow { get; }
```
...
### OnClickEquipment(EquipmentModel)
...
### ReleaseEquipment(EquipmentModel, AgentModel)
