...
For assigning [agents](/api/Global/Agents-and-Clerks/Agents/AgentUnit) places (for work and suppression). Handles the logic for the:
...
## Implements
[IObserver](/api/Global/Mouse-Usage/Mouse-Listeners/IScrollTarget)
