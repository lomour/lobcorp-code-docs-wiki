...
UI for displaying the agents along with their [defense info](/api/Global/Damage/DefenseInfo) and equipment in the suppression window.
...
#### Field Value
**Type:** CommandWindow.AgentEquipmentSlot

### tooltips
```csharp
[Header("Defense Tooltip")]
