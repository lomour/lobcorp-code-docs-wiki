...
## Constructors
### BloodyTreeDeadScript()
```csharp
public BloodyTreeDeadScript()
```
...
## Methods
### GenerateParts(BloodyTreeAnim, WorkerModel, float)
```csharp
public void GenerateParts(BloodyTreeAnim script, WorkerModel worker, float scaleFactor = 1)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `script` | `Global.BloodyTreeAnim` |  |
| `worker` | `Global.WorkerModel` |  |
| `scaleFactor` | `System.Single` |  |

### GenerateParts(GeburahCoreAnim, WorkerModel, float)
```csharp
public void GenerateParts(GeburahCoreAnim geburah, WorkerModel worker, float scaleFactor = 1)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `geburah` | `Global.GeburahCoreAnim` |  |
| `worker` | `Global.WorkerModel` |  |
| `scaleFactor` | `System.Single` |  |

### GenerateParts(WraithAnim, WorkerModel, float)
```csharp
public void GenerateParts(WraithAnim wraith, WorkerModel worker, float scaleFactor = 1)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `wraith` | `Global.WraithAnim` |  |
| `worker` | `Global.WorkerModel` |  |
| `scaleFactor` | `System.Single` |  |

### GenList()
```csharp
public List<BloodyTreeDeadScript.GeneratbleRegion> GenList()
```

#### Returns
**Type:** System.Collections.Generic.List{DeadEffect.BloodyTreeDeadScript.GeneratbleRegion}
