...
---
uid: Global.MachineDusk
canonical_path: /api/Global/Machine/MachineDusk
---
...
### animScript
```csharp
public MachineDuskAnim animScript { get; }
```
...
### createCoolTime
```csharp
private static float createCoolTime { get; }
```
...
### createInitCoolTime
```csharp
private static float createInitCoolTime { get; }
```
