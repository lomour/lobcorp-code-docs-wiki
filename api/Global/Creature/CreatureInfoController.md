---
title: CreatureInfoController
description: 
published: true
date: 2026-02-20T21:41:12.885Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:33:42.926Z
---

# Class CreatureInfoController
...
## Derived
[CreatureInfoCaretakingRoot](/api/CreatureInfo/CreatureInfoCaretakingRoot), [CreatureInfoCaretakingSlot](/api/CreatureInfo/CreatureInfoCaretakingSlot), [CreatureInfoEquipmentRoot](/api/CreatureInfo/CreatureInfoEquipmentRoot), [CreatureInfoEscapeRoot](/api/CreatureInfo/CreatureInfoEscapeRoot), [CreatureInfoKitStatRoot](/api/CreatureInfo/CreatureInfoKitStatRoot), [CreatureInfoStatRoot](/api/CreatureInfo/CreatureInfoStatRoot), [CreatureInfoWorkRoot](/api/CreatureInfo/CreatureInfoWorkRoot), [CreatureInfoWorkSlot](/api/CreatureInfo/CreatureInfoWorkSlot)

## Constructors
### CreatureInfoController()
```csharp
...
### Cost
```csharp
public virtual Text Cost { get; set; }
```
