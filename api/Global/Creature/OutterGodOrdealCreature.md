---
uid: Global.OutterGodOrdealCreature
canonical_path: /api/Global/Creature/OutterGodOrdealCreature
---

# Class OutterGodOrdealCreature
...
## Derived
[OutterGodDawn](/api/Global/OutterGodMidnight/OutterGodDawn), [OutterGodMidnight](/api/Global/OutterGodMidnight/OutterGodMidnight), [OutterGodNoon](/api/Global/OutterGodMidnight/OutterGodNoon)
...
### OutterGodOrdealCreature()

```csharp
public OutterGodOrdealCreature()
```
...
| --- | --- | --- |
| `ordealScript` | `Global.OutterGodOrdeal` |  |
