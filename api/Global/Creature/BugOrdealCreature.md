---
title: BugOrdealCreature
description: 
published: true
date: 2026-02-20T21:40:36.133Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:32:44.776Z
---

# Class BugOrdealCreature
...
## Derived
[BugDawn](/api/Global/Misc/BugDawn), [BugDusk](/api/Global/Misc/BugDusk), [BugMidnight](/api/Global/Misc/BugMidnight)

## Constructors
### BugOrdealCreature()
```csharp
public BugOrdealCreature()
```
...
#### Field Value
**Type:** Global.BugOrdeal

### _phase
```csharp
protected BugOrdealCreature.BugPhase _phase
```
...
### Midnight
```csharp
public BugMidnight Midnight { get; }
```
...
### SetOrdeal(BugOrdeal, OrdealLevel, RiskLevel, string)
```csharp
