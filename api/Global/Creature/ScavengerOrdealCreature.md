---
uid: Global.ScavengerOrdealCreature
canonical_path: /api/Global/Creature/ScavengerOrdealCreature
---

# Class ScavengerOrdealCreature
...
### ScavengerOrdealCreature()

```csharp
public ScavengerOrdealCreature()
```
...
| --- | --- | --- |
| `ordealScript` | `Global.ScavengerOrdeal` |  |
