---
title: MachineOrdealCreature
description: 
published: true
date: 2026-02-20T21:42:38.378Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:36:05.153Z
---

# Class MachineOrdealCreature
...
## Derived
[MachineDawn](/api/Global/Machine/MachineDawn), [MachineDusk](/api/Global/Machine/MachineDusk), [MachineMidnight](/api/Global/Machine/MachineMidnight), [MachineNoon](/api/Global/Machine/MachineNoon)

## Constructors
### MachineOrdealCreature()
```csharp
...
### spawnByDuskTime
```csharp
protected static float spawnByDuskTime { get; }
```
...
| --- | --- | --- |
| `ordealScript` | `Global.MachineOrdeal` |  |
