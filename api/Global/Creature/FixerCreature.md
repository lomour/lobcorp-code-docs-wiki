...
---
uid: Global.FixerCreature
canonical_path: /api/Global/Creature/FixerCreature
---
...
## Derived
[FixerBlack](/api/Global/Misc/FixerBlack), [FixerClaw](/api/Global/Misc/FixerClaw), [FixerPale](/api/Global/Misc/FixerPale), [FixerRed](/api/Global/Misc/FixerRed), [FixerWhite](/api/Global/Misc/FixerWhite)

## Constructors

### FixerCreature()
```csharp
public FixerCreature()
```
...
| Name | Type | Description |
| --- | --- | --- |
| `ordealScript` | `Global.FixerOrdeal` |  |
