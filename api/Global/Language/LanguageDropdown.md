---
uid: Global.LanguageDropdown
canonical_path: /api/Global/Misc/LanguageDropdown
---
...
The dropdown for selecting the language in the [options menu](/api/Global/UI/Options/OptionUI).
