---
uid: Global.NetzachCoreAnim
canonical_path: /api/Global/Creature/NetzachCoreAnim
---
# Class NetzachCoreAnim
...
Animation handler for [Netzach](/api/Global/Core-Suppressions/Netzach-Suppression/NetzachBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → NetzachCoreAnim
...
| --- | --- | --- |
| `script` | `Global.NetzachCoreScript` |  |
