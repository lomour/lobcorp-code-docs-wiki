...
Netzach, as he appears in [his core suppression](/api/Global/Core-Suppressions/Netzach-Suppression/NetzachBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → NetzachCoreScript
