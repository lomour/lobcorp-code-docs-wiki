---
uid: Global.GeburahProjectile
canonical_path: /api/Global/Misc/GeburahProjectile
---
# Class GeburahProjectile
...
One of [The Red Mist](/api/Global/Core-Suppressions/Gebura-Suppression/GeburahCoreScript)'s projectile attacks.
...
### movementType
```csharp
public GeburahProjectile.MovementType movementType
```
...
### Init(ProjectileType, Vector3, Vector3, float, float, DamageInfo)
```csharp
...
| Name | Type | Description |
| --- | --- | --- |
| `projectileType` | `GeburahBoss.ProjectileType` |  |
...
### MovementInit(List<MovementInfo>)
```csharp
...
| Name | Type | Description |
| --- | --- | --- |
| `list` | `System.Collections.Generic.List{GeburahBoss.MovementInfo}` |  |
...
### SetArrivedAction(GeburahActionMethod)
```csharp
...
| Name | Type | Description |
| --- | --- | --- |
| `action` | `GeburahBoss.GeburahActionMethod` |  |
