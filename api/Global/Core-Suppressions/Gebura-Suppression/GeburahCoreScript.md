...
The Red Mist. [Geburah's core suppression](/api/Global/Core-Suppressions/Gebura-Suppression/GeburahBossBase) ends when she is defeated. 


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → GeburahCoreScript
