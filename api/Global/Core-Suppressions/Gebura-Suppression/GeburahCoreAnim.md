...
extends [CreatureAnimEventCalled](/api/Global/Abnormalities/CreatureAnimEventCalled)

Animation handler for [The Red Mist](/api/Global/Core-Suppressions/Gebura-Suppression/GeburahCoreScript).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → GeburahCoreAnim
