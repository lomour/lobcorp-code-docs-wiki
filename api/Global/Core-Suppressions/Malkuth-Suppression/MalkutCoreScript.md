...
Malkuth, as she appears in [her core suppression](/api/Global/Core-Suppressions/Malkuth-Suppression/MalkutBossBase).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → MalkutCoreScript
