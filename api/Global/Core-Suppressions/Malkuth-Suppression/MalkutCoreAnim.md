---
uid: Global.MalkutCoreAnim
canonical_path: /api/Global/Creature/MalkutCoreAnim
---
# Class MalkutCoreAnim
...
Animation handler for [Malkuth during her core suppression](/api/Global/Core-Suppressions/Malkuth-Suppression/MalkutCoreScript).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → MalkutCoreAnim
...
| --- | --- | --- |
| `script` | `Global.MalkutCoreScript` |  |
