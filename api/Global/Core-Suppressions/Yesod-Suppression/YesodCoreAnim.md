---
uid: Global.YesodCoreAnim
canonical_path: /api/Global/Creature/YesodCoreAnim
---
# Class YesodCoreAnim
...
Animation handler for [Yesod](/api/Global/Core-Suppressions/Yesod-Suppression/YesodBossBase).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → YesodCoreAnim
