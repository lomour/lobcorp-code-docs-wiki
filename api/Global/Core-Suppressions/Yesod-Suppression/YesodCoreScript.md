...
Yesod, as he appears in [his core suppression](/api/Global/Core-Suppressions/Yesod-Suppression/YesodBossBase).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → YesodCoreScript
