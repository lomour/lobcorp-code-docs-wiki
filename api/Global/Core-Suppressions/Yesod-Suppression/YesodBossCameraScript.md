---
uid: Global.YesodBossCameraScript
canonical_path: /api/Global/Script/YesodBossCameraScript
---
# Class YesodBossCameraScript
...
Script for distorting the camera during [Yesod's core suppression](/api/Global/Core-Suppressions/Yesod-Suppression/YesodBossBase).
...
## Constructors
### YesodBossCameraScript()
```csharp
public YesodBossCameraScript()
```
