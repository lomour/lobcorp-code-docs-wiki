---
uid: Global.TipherethCoreAnim
canonical_path: /api/Global/Creature/TipherethCoreAnim
---
# Class TipherethCoreAnim
...
Animation handler for [Tiphereth](/api/Global/Core-Suppressions/Tiphereth-Suppression/TipherethBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → TipherethCoreAnim
...
| Name | Type | Description |
| --- | --- | --- |
| `script` | `Global.TipherethCoreScript` |  |
