...
Tiphereth, as they appear in [Tiphereth's core suppression](/api/Global/Core-Suppressions/Tiphereth-Suppression/TipherethBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → TipherethCoreScript
