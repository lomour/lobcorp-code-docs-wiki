---
uid: Global.BinahWave
canonical_path: /api/Global/Misc/BinahWave
---
# Class BinahWave
...
[Binah](/api/Global/Core-Suppressions/Binah-Suppression/BinahBossBase)'s... wave... attack?
...
### Init(BinahCoreScript, ProjectileModel, ProjectileUnit)
```csharp
