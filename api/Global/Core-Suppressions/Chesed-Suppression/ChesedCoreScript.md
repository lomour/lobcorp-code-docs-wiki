...
Chesed, as he appears in [his core suppression](/api/Global/Core-Suppressions/Chesed-Suppression/ChesedBossBase).



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → ChesedCoreScript
