---
uid: Global.ChesedCoreAnim
canonical_path: /api/Global/Creature/ChesedCoreAnim
---
# Class ChesedCoreAnim
...
Animation handler for [Chesed](/api/Global/Core-Suppressions/Chesed-Suppression/ChesedBossBase).
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → ChesedCoreAnim
...
### Script
```csharp
public ChesedCoreScript Script { get; }
```
...
| --- | --- | --- |
| `script` | `Global.ChesedCoreScript` |  |
