---
uid: Global.ChokhmahCoreAnim
canonical_path: /api/Global/Creature/ChokhmahCoreAnim
---
# Class ChokhmahCoreAnim
...
Animation handler for [Hokma](/api/Global/Core-Suppressions/Hokma-Suppression/ChokhmahBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → ChokhmahCoreAnim
...
### closeTimer
```csharp
private UnscaledTimer closeTimer { get; }
```
...
| Name | Type | Description |
| --- | --- | --- |
| `script` | `Global.ChokhmahCoreScript` |  |
