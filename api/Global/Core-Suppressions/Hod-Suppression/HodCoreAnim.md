---
uid: Global.HodCoreAnim
canonical_path: /api/Global/Creature/HodCoreAnim
---
# Class HodCoreAnim
...
Animation handler for [Hod](/api/Global/Core-Suppressions/Hod-Suppression/HodBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → HodCoreAnim
