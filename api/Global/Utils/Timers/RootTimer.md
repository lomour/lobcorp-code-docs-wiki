---
uid: Global.RootTimer
canonical_path: /api/Global/Misc/RootTimer
---
# Class RootTimer
...
Keeps track of timers, maybe. See [GameManager](/api/Global/Global-Data/GameManager)
...
### timers
```csharp
private List<RootTimer.Timer> timers
```

#### Field Value
**Type:** System.Collections.Generic.List{RootTimer.Timer}

## Methods
### AddTimer(string, float)
```csharp
