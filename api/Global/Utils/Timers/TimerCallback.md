---
uid: Global.TimerCallback
canonical_path: /api/Global/Misc/TimerCallback
---
# Class TimerCallback
...
A timer which calls a function when it runs out. Used by [CreatureSpeech](/api/Global/Abnormalities/Lyrics/CreatureSpeech), maybe.
...
### Create(float, GameObject, Callback)
```csharp
