---
title: ButtonAnimationEvent
description: 
published: true
date: 2026-02-20T21:46:42.380Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:42:53.541Z
---

# Class ButtonAnimationEvent
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → ButtonAnimationEvent

## Constructors
### ButtonAnimationEvent()
```csharp
public ButtonAnimationEvent()
```
...
#### Field Value
**Type:** System.Collections.Generic.List{IButtonAnimCalled}
...
### ButtonAnimator
```csharp
public Animator ButtonAnimator { get; }
```
...
### onDisable
```csharp
public UnityEvent onDisable { get; set; }
```
...
## Methods
### GetInterface(GameObject, out IButtonAnimCalled)
```csharp
...
| --- | --- | --- |
| `behav` | `UnityEngine.GameObject` |  |
| `output` | `Global.IButtonAnimCalled` |  |
