...
description: 
published: true
date: 2026-02-20T21:47:14.567Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:43:47.719Z
---
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → SkeletonUIEvent

## Constructors
### SkeletonUIEvent()
```csharp
public SkeletonUIEvent()
```
