---
uid: Global.PostEndingCanvas
canonical_path: /api/Global/Misc/PostEndingCanvas
---
# Class PostEndingCanvas
...
Shows a video clip, then tells the  to load the [new title screen](/api/Global/UI/Title-Screen/AlterTitleController).
