---
uid: Global.RabbitAnimatorController
canonical_path: /api/Global/Misc/RabbitAnimatorController
---
# Class RabbitAnimatorController
...
Animation handler for [rabbits](/api/Global/Rabbits/Rabbit-Units/RabbitUnit).
...
## Constructors
### RabbitAnimatorController()
```csharp
public RabbitAnimatorController()
```
