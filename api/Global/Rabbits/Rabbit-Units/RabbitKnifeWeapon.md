---
uid: Global.RabbitKnifeWeapon
canonical_path: /api/Global/Weapon/RabbitKnifeWeapon
---
# Class RabbitKnifeWeapon
...
Script for a [rabbit](/api/Global/Rabbits/Rabbit-Units/RabbitModel)'s melee weapon which does damage 5 times with a random animation.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → RabbitKnifeWeapon

## Constructors
### RabbitKnifeWeapon()
```csharp
public RabbitKnifeWeapon()
```

## Fields
### _MAX_COUNT_ATTACK_PER_ANIM
```csharp
