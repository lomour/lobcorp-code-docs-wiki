...
Holds the information for creating a [RabbitSquad](/api/Global/Rabbits/Rabbit-Squads/RabbitSquad).

Holds the squad ID, the department ID, [RabbitTeamData](/api/Global/Rabbits/Portals/RabbitTeleportData) for the teleports. ^\[verify\]^
