...
---
uid: Global.EffectInvoker
canonical_path: /api/Global/Effect/EffectInvoker
---
...
## Derived
[DamageEffect](/api/Global/Effect/DamageEffect), [DamageParticleEffect](/api/Global/Effect/DamageParticleEffect), [EncounterEffect](/api/Global/Effect/EncounterEffect), [ShockwaveEffect](/api/Global/Effect/ShockwaveEffect)
...
### destroyEvent
```csharp
public EffectInvoker.OnDestroyEvent destroyEvent
```

#### Field Value
**Type:** Global.EffectInvoker.OnDestroyEvent
...
| `isUnscaled` | `System.Boolean` |  |

#### Returns
**Type:** Global.EffectInvoker

### Invoker(string, Vector3, float, bool)
```csharp
...
```csharp
public void SetDestroyEvent(EffectInvoker.OnDestroyEvent e)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `e` | `Global.EffectInvoker.OnDestroyEvent` |  |

### SetMovableSetting(MovableObjectNode)
```csharp
