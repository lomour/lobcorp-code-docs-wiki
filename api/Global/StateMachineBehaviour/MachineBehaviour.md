...
---
uid: Global.MachineBehaviour
canonical_path: /api/Global/StateMachineBehaviour/MachineBehaviour
---
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [ScriptableObject](#) → [StateMachineBehaviour](#) → MachineBehaviour

## Constructors

### MachineBehaviour()
```csharp
public MachineBehaviour()
```
