---
uid: Global.SuppressActionBehaviour
canonical_path: /api/Global/StateMachineBehaviour/SuppressActionBehaviour
---
# Class SuppressActionBehaviour
...
## Constructors
### SuppressActionBehaviour()
```csharp
public SuppressActionBehaviour()
```
