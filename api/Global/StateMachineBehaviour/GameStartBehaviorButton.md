...
---
uid: Global.GameStartBehaviorButton
canonical_path: /api/Global/StateMachineBehaviour/GameStartBehaviorButton
---

# Class GameStartBehaviorButton
...
Sets an animator's "Start" to false. ??

#unused 


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [ScriptableObject](#) → [StateMachineBehaviour](#) → GameStartBehaviorButton

## Constructors

### GameStartBehaviorButton()
```csharp
public GameStartBehaviorButton()
```
