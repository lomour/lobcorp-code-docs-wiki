...
---
uid: Global.ManageWorkParamSetter
canonical_path: /api/Global/StateMachineBehaviour/ManageWorkParamSetter
---

# Class ManageWorkParamSetter
...
Manages the work management animation? Seems unused?? 
...
### ManageWorkParamSetter()
```csharp
public ManageWorkParamSetter()
```
...
### randomSettedParams
```csharp
public List<ManageWorkParamSetter.RandomSettedParam> randomSettedParams
```

#### Field Value
**Type:** System.Collections.Generic.List{ManageWorkParamSetter.RandomSettedParam}
