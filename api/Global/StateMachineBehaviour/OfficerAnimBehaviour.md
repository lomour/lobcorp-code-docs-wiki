---
uid: Global.OfficerAnimBehaviour
canonical_path: /api/Global/StateMachineBehaviour/OfficerAnimBehaviour
---

# Class OfficerAnimBehaviour
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [ScriptableObject](#) → [StateMachineBehaviour](#) → OfficerAnimBehaviour
...
### OfficerAnimBehaviour()

```csharp
public OfficerAnimBehaviour()
```
