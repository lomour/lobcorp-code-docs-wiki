---
uid: Global.FengYunAnimStateBehavior
canonical_path: /api/Global/StateMachineBehaviour/FengYunAnimStateBehavior
---

# Class FengYunAnimStateBehavior
...
### FengYunAnimStateBehavior()

```csharp
public FengYunAnimStateBehavior()
```
