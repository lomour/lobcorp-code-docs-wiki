...
Part of [BugsForFoodEvent](/api/Global/Unused/Random-Events/Bugs-for-Food/FallingLegEvent) thing...



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [StandingItemScriptBase](/api/Global/Unused/StandingItem/StandingItemScriptBase) → ChopLeg
