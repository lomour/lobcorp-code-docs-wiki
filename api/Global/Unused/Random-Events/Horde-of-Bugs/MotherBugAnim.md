...
Animation handler for [MotherBug](/api/Global/Unused/Random-Events/Horde-of-Bugs/MotherBug)



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [StandingItemAnim](/api/Global/Unused/StandingItem/StandingItemAnim) → MotherBugAnim
