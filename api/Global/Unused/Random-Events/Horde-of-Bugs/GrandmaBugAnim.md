...
Animation handler for [GrandmaBug](/api/Global/Unused/Random-Events/Horde-of-Bugs/GrandmaBug)



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [StandingItemAnim](/api/Global/Unused/StandingItem/StandingItemAnim) → GrandmaBugAnim
