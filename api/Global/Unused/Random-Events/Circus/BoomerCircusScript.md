...
tied to [BoomerCircusEvent](/api/Global/Unused/Random-Events/Circus/BoomerCircusEvent) 




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [StandingItemScriptBase](/api/Global/Unused/StandingItem/StandingItemScriptBase) → BoomerCircusScript

## Derived
[CircusBoomer](/api/Global/Unused/Random-Events/Circus/CircusTent)
