---
uid: Global.CircusTentAnim
canonical_path: /api/Global/Standing/CircusTentAnim
---
# Class CircusTentAnim
...
animation handler for [CircusTent](/api/Global/Unused/Random-Events/Circus/CircusTent)




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [StandingItemAnim](/api/Global/Unused/StandingItem/StandingItemAnim) → CircusTentAnim
...
| Name | Type | Description |
| --- | --- | --- |
| `animState` | `Global.CircusTent.AnimationState` |  |
