...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [StandingItemScriptBase](/api/Global/Unused/Random-Events/Circus/BoomerCircusScript) → CircusBoomer
