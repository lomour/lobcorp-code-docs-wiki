...
animation handler for [CircusBoomer](/api/Global/Unused/Random-Events/Circus/CircusBoomer), I guess




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [StandingItemAnim](/api/Global/Unused/StandingItem/StandingItemAnim) → CircusBoomerAnim

## Implements
[IAnimatorEventCalled](/api/Global/Unused/IOverlapOnclick)
