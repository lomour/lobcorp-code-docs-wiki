...
Maintains a list of all [clerk actions](/api/Global/Unused/Clerk-Actions/OfficerSpecialAction), and a list of currently available clerk actions.

When an action is gotten, it is removed from the list of available actions until reset.

See also [Sefira](/api/Global/Departments/Sefira).
