...
See [CreatureFeelingState](/api/Global/Abnormalities/CreatureFeelingState)



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [MenuScript](/api/Global/Unused/MenuScript) → CreatureFeelingPreferScript
