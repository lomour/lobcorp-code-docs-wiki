...
A door between two [rooms](/api/Global/Map/Rooms-and-Hallways/PassageObjectModel).



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [ObjectModelBase](/api/Global/Map/ObjectModelBase) → DoorObjectModel
