...
A [room](/api/Global/Map/Rooms-and-Hallways/PassageObjectModel), as it appears in-game.
...
## Derived
[PassageWayObject](/api/Global/Map/Rooms-and-Hallways/PassageWayObject)

## Implements
[IObserver](/api/Global/Mouse-Usage/Mouse-Listeners/IMouseOnPointListener)
