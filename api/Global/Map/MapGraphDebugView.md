---
uid: Global.MapGraphDebugView
canonical_path: /api/Global/IOBserver/MapGraphDebugView
---
# Class MapGraphDebugView
...
A debug view for the [map](/api/Global/Map/MapGraph).
...
### instance
```csharp
public static MapGraphDebugView instance { get; }
```
