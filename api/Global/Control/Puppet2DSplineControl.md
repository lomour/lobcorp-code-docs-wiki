---
title: Puppet2DSplineControl
description: 
published: true
date: 2026-02-20T21:39:45.188Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:31:21.424Z
---

# Class Puppet2D_SplineControl
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → Puppet2D_SplineControl

## Constructors
### Puppet2D_SplineControl()
```csharp
public Puppet2D_SplineControl()
```
...
## Methods
### CatmullRom(List<Transform>, out List<Vector3>, int)
```csharp
...
| --- | --- | --- |
| `inCoordinates` | `System.Collections.Generic.List{UnityEngine.Transform}` |  |
| `outCoordinates` | `System.Collections.Generic.List{UnityEngine.Vector3}` |  |
...
### PointOnCurve(Vector3, Vector3, Vector3, Vector3, float)
```csharp
...
### RecursivelyFindFolderPath(string)
```csharp
