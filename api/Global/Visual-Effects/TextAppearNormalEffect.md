---
uid: Global.TextAppearNormalEffect
canonical_path: /api/Global/Effect/TextAppearNormalEffect
---
# Class TextAppearNormalEffect
...
Used by [Nothing There](/api/Global/Abnormalities/Nothing-There/Nothing)'s animator, maybe?
...
## Constructors
### TextAppearNormalEffect()
```csharp
public TextAppearNormalEffect()
```
...
## Methods
### Create(DestroyHandler, Vector2, float, string, Color)
```csharp
...
#### Returns
**Type:** Global.TextAppearNormalEffect

### Create(Vector2, string, Color)
```csharp
