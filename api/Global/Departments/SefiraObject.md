---
uid: Global.SefiraObject
canonical_path: /api/Global/Object/SefiraObject
---
# Class SefiraObject
...
Managed by [SefiraMapLayer](/api/Global/Game-Layers/SefiraMapLayer).
...
#### Field Value
**Type:** System.Collections.Generic.List{PassageObject}

### range
```csharp
public SefiraObject.AreaRange range
```

#### Field Value
**Type:** Global.SefiraObject.AreaRange
...
| --- | --- | --- |
| `mapObjModel` | `Global.BloodMapObjectModel` |  |
...
#### Returns
**Type:** System.Collections.ObjectModel.ReadOnlyCollection{PassageObject}
...
| Name | Type | Description |
| --- | --- | --- |
| `passageGroup` | `System.String` |  |
| `bActive` | `System.Boolean` |  |

### SetAreaActivateAll(bool)
```csharp
