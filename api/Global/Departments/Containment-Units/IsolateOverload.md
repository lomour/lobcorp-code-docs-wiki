---
uid: Global.IsolateOverload
canonical_path: /api/Global/Misc/IsolateOverload
---
# Class IsolateOverload
...
Qliphoth Meltdown on a [containment unit](/api/Global/Departments/Containment-Units/IsolateRoom).
...
### OriginPositionY
```csharp
public float OriginPositionY { get; }
```
