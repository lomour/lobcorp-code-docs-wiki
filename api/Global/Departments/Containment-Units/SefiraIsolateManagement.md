...
Manages [containment units](/api/Global/Departments/Containment-Units/SefiraIsolate).

Provides methods to get unused rooms, get the [SefiraIsolate](/api/Global/Departments/Containment-Units/SefiraIsolate) of a creature, and other things.
