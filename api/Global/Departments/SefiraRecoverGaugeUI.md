---
uid: Global.SefiraRecoverGaugeUI
canonical_path: /api/Global/IOBserver/SefiraRecoverGaugeUI
---
# Class SefiraRecoverGaugeUI
...
The recovery gauge above main rooms in [departments](/api/Global/Departments/Sefira).
...
## Constructors
### SefiraRecoverGaugeUI()
```csharp
public SefiraRecoverGaugeUI()
```

## Fields
### _oldOfficerAliveLevel
```csharp
