---
title: ChokhmahCoreScript
description: 
published: true
date: 2026-02-20T22:22:28.256Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:45:36.058Z
---

# Class ChokhmahCoreScript
...
### AnimScript
```csharp
public ChokhmahCoreAnim AnimScript { get; }
```
...
### BossBase
```csharp
public ChokhmahBossBase BossBase { get; }
```
...
| Name | Type | Description |
| --- | --- | --- |
| `bossBase` | `Global.ChokhmahBossBase` |  |
