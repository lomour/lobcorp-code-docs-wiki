---
title: ApostleLanceScript
description: 
published: true
date: 2026-02-20T22:22:17.957Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:45:18.722Z
---

# Class ApostleLanceScript
...
### ApostleLanceScript()
```csharp
public ApostleLanceScript()
```

## Fields
### arrive
```csharp
private ApostleLanceScript.DestArrive arrive
```

#### Field Value
**Type:** Global.ApostleLanceScript.DestArrive
...
## Methods
### Attach(WorkerUnit, MapNode, bool)
```csharp
...
### Init(DestArrive)
```csharp
public void Init(ApostleLanceScript.DestArrive arrive)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `arrive` | `Global.ApostleLanceScript.DestArrive` |  |
