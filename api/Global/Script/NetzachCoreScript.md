---
title: NetzachCoreScript
description: 
published: true
date: 2026-02-20T22:23:16.152Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:46:59.251Z
---

# Class NetzachCoreScript
...
Netzach, as he appears in [his core suppression](/api/Global/Misc/NetzachBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Creature/CreatureBase) → NetzachCoreScript
...
#### Field Value
**Type:** Global.NetzachBossBase

## Properties
### AnimScript
```csharp
public NetzachCoreAnim AnimScript { get; }
```
