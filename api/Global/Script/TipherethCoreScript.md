---
title: TipherethCoreScript
description: 
published: true
date: 2026-02-20T22:23:39.053Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:47:40.226Z
---

# Class TipherethCoreScript
...
Tiphereth, as they appear in [Tiphereth's core suppression](/api/Global/Misc/TipherethBossBase).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Creature/CreatureBase) → TipherethCoreScript

## Constructors
### TipherethCoreScript()
```csharp
public TipherethCoreScript()
```
...
### AnimScript
```csharp
public TipherethCoreAnim AnimScript { get; }
```
