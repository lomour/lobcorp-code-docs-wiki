---
title: YesodCoreScript
description: 
published: true
date: 2026-02-20T22:23:46.538Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:47:53.651Z
---

# Class YesodCoreScript
...
Yesod, as he appears in [his core suppression](/api/Global/Misc/YesodBossBase).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Creature/CreatureBase) → YesodCoreScript
...
#### Field Value
**Type:** Global.YesodBossBase

## Properties
### AnimScript
```csharp
public YesodCoreAnim AnimScript { get; }
```
