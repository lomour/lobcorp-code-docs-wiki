---
uid: Global.OutterGodDawn
canonical_path: /api/Global/OutterGodMidnight/OutterGodDawn
---
# Class OutterGodDawn
...
### aggroTime
```csharp
private static float aggroTime { get; }
```
...
### animScript
```csharp
public OutterGodDawnAnim animScript { get; }
```
...
### boomDmg
```csharp
private static int boomDmg { get; }
```
...
### boomTime
```csharp
private static float boomTime { get; }
```
