---
uid: Global.OutterGodMidnight_P
canonical_path: /api/Global/OutterGodMidnight/OutterGodMidnightP
---
# Class OutterGodMidnight_P
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class OutterGodMidnight_P : OutterGodMidnight
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Creature/CreatureBase) → [OutterGodOrdealCreature](/api/Global/Creature/OutterGodOrdealCreature) → [OutterGodMidnight](/api/Global/OutterGodMidnight/OutterGodMidnight) → OutterGodMidnight_P

## Constructors
### OutterGodMidnight_P()
```csharp
public OutterGodMidnight_P()
```

## Fields
### _coolTimeMax
```csharp
private const float _coolTimeMax = 10
```
...
### _coolTimeMin
```csharp
private const float _coolTimeMin = 5
```
...
### attackScript
```csharp
private OutterGodMidnightAttack attackScript
```

#### Field Value
**Type:** Global.OutterGodMidnightAttack
...
### coolTime
```csharp
private static float coolTime { get; }
```
...
### AttackNear()
```csharp
public override void AttackNear()
```
...
### OnAttackArrive()
```csharp
public override void OnAttackArrive()
```

### OnGiveDamage(UnitModel)
```csharp
public override void OnGiveDamage(UnitModel target)
```
