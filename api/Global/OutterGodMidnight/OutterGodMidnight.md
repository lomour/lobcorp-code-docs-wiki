---
uid: Global.OutterGodMidnight
canonical_path: /api/Global/OutterGodMidnight/OutterGodMidnight
---
# Class OutterGodMidnight
...
## Derived
[OutterGodMidnight_B](/api/Global/OutterGodMidnight/OutterGodMidnightB), [OutterGodMidnight_P](/api/Global/OutterGodMidnight/OutterGodMidnightP), [OutterGodMidnight_R](/api/Global/OutterGodMidnight/OutterGodMidnightR), [OutterGodMidnight_W](/api/Global/OutterGodMidnight/OutterGodMidnightW)

## Constructors
### OutterGodMidnight()
```csharp
public OutterGodMidnight()
```
...
#### Field Value
**Type:** Global.OutterGodMidnightAnim
...
### animScript
```csharp
public OutterGodMidnightAnim animScript { get; }
```
...
### attackInitCoolTime
```csharp
private static float attackInitCoolTime { get; }
```
...
## Methods
### Attack(Vector3, Vector3, Vector3)
```csharp
