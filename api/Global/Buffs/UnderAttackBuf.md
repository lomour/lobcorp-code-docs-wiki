---
uid: Global.UnderAttackBuf
canonical_path: /api/Global/UnitBuf/UnderAttackBuf
---
# Class UnderAttackBuf
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → UnderAttackBuf
