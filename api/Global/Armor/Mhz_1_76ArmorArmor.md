---
title: Mhz_1_76ArmorArmor
description: 
published: true
date: 2026-07-07T17:33:20.249Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:14:26.081Z
---

# Class Mhz_1_76ArmorArmor
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class Mhz_1_76ArmorArmor : EquipmentScriptBase
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/Misc/EquipmentScriptBase) → Mhz_1_76ArmorArmor

## Constructors
### Mhz_1_76ArmorArmor()
```csharp
public Mhz_1_76ArmorArmor()
```
