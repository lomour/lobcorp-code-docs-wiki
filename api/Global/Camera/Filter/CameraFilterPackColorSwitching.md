---
uid: Global.CameraFilterPack_Color_Switching
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorSwitching
---
# Class CameraFilterPack_Color_Switching
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Color_Switching
