...
---
uid: Global.CameraFilterPack_Color_Invert
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorInvert
---

# Class CameraFilterPack_Color_Invert
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Color_Invert
