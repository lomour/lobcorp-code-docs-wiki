...
---
uid: Global.CameraFilterPack_Blur_Radial
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurRadial
---

# Class CameraFilterPack_Blur_Radial
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Radial
