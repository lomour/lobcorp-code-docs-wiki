---
uid: Global.CameraFilterPack_Drawing_Curve
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingCurve
---
# Class CameraFilterPack_Drawing_Curve
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Curve
