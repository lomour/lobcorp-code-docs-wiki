---
uid: Global.CameraFilterPack_TV_MovieNoise
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVMovieNoise
---
# Class CameraFilterPack_TV_MovieNoise
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_MovieNoise
