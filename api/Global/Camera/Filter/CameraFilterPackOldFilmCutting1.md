...
---
uid: Global.CameraFilterPack_OldFilm_Cutting1
canonical_path: /api/Global/Camera/Filter/CameraFilterPackOldFilmCutting1
---

# Class CameraFilterPack_OldFilm_Cutting1
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_OldFilm_Cutting1
