---
uid: Global.CameraFilterPack_FX_Spot
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXSpot
---
# Class CameraFilterPack_FX_Spot
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Spot
