...
---
uid: Global.CameraFilterPack_Lut_Plus
canonical_path: /api/Global/Camera/Filter/CameraFilterPackLutPlus
---

# Class CameraFilterPack_Lut_Plus
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Lut_Plus
