...
---
uid: Global.CameraFilterPack_FX_8bits
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFX8bits
---

# Class CameraFilterPack_FX_8bits
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_8bits
