...
---
uid: Global.CameraFilterPack_AAA_SuperComputer
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAAASuperComputer
---

# Class CameraFilterPack_AAA_SuperComputer
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_AAA_SuperComputer
