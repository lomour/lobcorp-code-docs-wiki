---
uid: Global.CameraFilterPack_Gradients_Desert
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsDesert
---
# Class CameraFilterPack_Gradients_Desert
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_Desert
