...
---
uid: Global.CameraFilterPack_Distortion_Heat
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionHeat
---

# Class CameraFilterPack_Distortion_Heat
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Heat
