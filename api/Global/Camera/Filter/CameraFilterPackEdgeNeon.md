---
uid: Global.CameraFilterPack_Edge_Neon
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEdgeNeon
---
# Class CameraFilterPack_Edge_Neon
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Edge_Neon
