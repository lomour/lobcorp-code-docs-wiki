...
---
uid: Global.CameraFilterPack_TV_WideScreenVertical
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVWideScreenVertical
---

# Class CameraFilterPack_TV_WideScreenVertical
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_WideScreenVertical
