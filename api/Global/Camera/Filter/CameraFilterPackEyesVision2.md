...
---
uid: Global.CameraFilterPack_EyesVision_2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEyesVision2
---

# Class CameraFilterPack_EyesVision_2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_EyesVision_2
