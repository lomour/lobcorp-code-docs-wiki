...
---
uid: Global.CameraFilterPack_Drawing_Manga3
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingManga3
---

# Class CameraFilterPack_Drawing_Manga3
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga3
