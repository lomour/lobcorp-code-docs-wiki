...
---
uid: Global.CameraFilterPack_Blend2Camera_GreenScreen
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraGreenScreen
---

# Class CameraFilterPack_Blend2Camera_GreenScreen
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_GreenScreen
