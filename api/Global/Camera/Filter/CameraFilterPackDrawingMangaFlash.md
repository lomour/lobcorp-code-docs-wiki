...
---
uid: Global.CameraFilterPack_Drawing_Manga_Flash
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingMangaFlash
---

# Class CameraFilterPack_Drawing_Manga_Flash
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga_Flash
