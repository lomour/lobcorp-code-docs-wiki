...
---
uid: Global.CameraFilterPack_Pixel_Pixelisation
canonical_path: /api/Global/Camera/Filter/CameraFilterPackPixelPixelisation
---

# Class CameraFilterPack_Pixel_Pixelisation
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Pixel_Pixelisation
