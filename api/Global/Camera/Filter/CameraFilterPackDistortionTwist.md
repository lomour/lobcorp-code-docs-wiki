...
---
uid: Global.CameraFilterPack_Distortion_Twist
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionTwist
---

# Class CameraFilterPack_Distortion_Twist
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Twist
