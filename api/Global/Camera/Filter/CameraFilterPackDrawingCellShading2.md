...
---
uid: Global.CameraFilterPack_Drawing_CellShading2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingCellShading2
---

# Class CameraFilterPack_Drawing_CellShading2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_CellShading2
