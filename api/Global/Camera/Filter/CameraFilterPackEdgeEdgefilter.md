...
---
uid: Global.CameraFilterPack_Edge_Edge_filter
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEdgeEdgefilter
---

# Class CameraFilterPack_Edge_Edge_filter
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Edge_Edge_filter
