...
---
uid: Global.CameraFilterPack_Gradients_ElectricGradient
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsElectricGradient
---

# Class CameraFilterPack_Gradients_ElectricGradient
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_ElectricGradient
