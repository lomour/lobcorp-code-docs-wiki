---
uid: Global.CameraFilterPack_Blend2Camera_Blend
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraBlend
---
# Class CameraFilterPack_Blend2Camera_Blend
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Blend
