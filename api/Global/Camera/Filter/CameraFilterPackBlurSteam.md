...
---
uid: Global.CameraFilterPack_Blur_Steam
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurSteam
---

# Class CameraFilterPack_Blur_Steam
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Steam
