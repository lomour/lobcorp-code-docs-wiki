...
---
uid: Global.CameraFilterPack_Vision_Crystal
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionCrystal
---

# Class CameraFilterPack_Vision_Crystal
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Crystal
