...
---
uid: Global.CameraFilterPack_Drawing_Manga_Flash_Color
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingMangaFlashColor
---

# Class CameraFilterPack_Drawing_Manga_Flash_Color
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga_Flash_Color
