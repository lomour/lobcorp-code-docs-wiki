...
---
uid: Global.CameraFilterPack_Drawing_Halftone
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingHalftone
---

# Class CameraFilterPack_Drawing_Halftone
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Halftone
