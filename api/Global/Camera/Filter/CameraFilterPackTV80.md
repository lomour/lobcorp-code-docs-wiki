...
---
uid: Global.CameraFilterPack_TV_80
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTV80
---

# Class CameraFilterPack_TV_80
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_80
