...
---
uid: Global.CameraFilterPack_Vision_Blood_Fast
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionBloodFast
---

# Class CameraFilterPack_Vision_Blood_Fast
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Blood_Fast
