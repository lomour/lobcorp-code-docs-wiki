---
uid: Global.CameraFilterPack_AAA_SuperHexagon
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAAASuperHexagon
---
# Class CameraFilterPack_AAA_SuperHexagon
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_AAA_SuperHexagon
