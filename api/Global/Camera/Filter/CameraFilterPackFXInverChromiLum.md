...
---
uid: Global.CameraFilterPack_FX_InverChromiLum
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXInverChromiLum
---

# Class CameraFilterPack_FX_InverChromiLum
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_InverChromiLum
