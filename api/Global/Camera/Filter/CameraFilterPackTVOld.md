---
uid: Global.CameraFilterPack_TV_Old
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVOld
---
# Class CameraFilterPack_TV_Old
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Old
