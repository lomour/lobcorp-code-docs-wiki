...
---
uid: Global.CameraFilterPack_Edge_BlackLine
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEdgeBlackLine
---

# Class CameraFilterPack_Edge_BlackLine
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Edge_BlackLine
