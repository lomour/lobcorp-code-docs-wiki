---
uid: Global.CameraFilterPack_Blur_GaussianBlur
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurGaussianBlur
---
# Class CameraFilterPack_Blur_GaussianBlur
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_GaussianBlur
