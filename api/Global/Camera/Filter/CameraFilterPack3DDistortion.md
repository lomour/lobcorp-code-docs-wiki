...
---
uid: Global.CameraFilterPack_3D_Distortion
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DDistortion
---

# Class CameraFilterPack_3D_Distortion
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Distortion
