...
---
uid: Global.CameraFilterPack_Distortion_FishEye
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionFishEye
---

# Class CameraFilterPack_Distortion_FishEye
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_FishEye
