...
---
uid: Global.CameraFilterPack_Distortion_BigFace
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionBigFace
---

# Class CameraFilterPack_Distortion_BigFace
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_BigFace
