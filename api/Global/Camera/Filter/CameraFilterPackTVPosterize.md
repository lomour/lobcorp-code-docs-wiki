...
---
uid: Global.CameraFilterPack_TV_Posterize
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVPosterize
---

# Class CameraFilterPack_TV_Posterize
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Posterize
