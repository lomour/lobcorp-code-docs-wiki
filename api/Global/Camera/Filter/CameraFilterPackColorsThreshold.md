...
---
uid: Global.CameraFilterPack_Colors_Threshold
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsThreshold
---

# Class CameraFilterPack_Colors_Threshold
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_Threshold
