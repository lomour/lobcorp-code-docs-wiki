...
---
uid: Global.CameraFilterPack_Pixelisation_Sweater
canonical_path: /api/Global/Camera/Filter/CameraFilterPackPixelisationSweater
---

# Class CameraFilterPack_Pixelisation_Sweater
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Pixelisation_Sweater
