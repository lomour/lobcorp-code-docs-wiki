...
---
uid: Global.CameraFilterPack_3D_Shield
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DShield
---

# Class CameraFilterPack_3D_Shield
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Shield
