...
---
uid: Global.CameraFilterPack_Blur_Tilt_Shift_Hole
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurTiltShiftHole
---

# Class CameraFilterPack_Blur_Tilt_Shift_Hole
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Tilt_Shift_Hole
