...
---
uid: Global.CameraFilterPack_Noise_TV_3
canonical_path: /api/Global/Camera/Filter/CameraFilterPackNoiseTV3
---

# Class CameraFilterPack_Noise_TV_3
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Noise_TV_3
