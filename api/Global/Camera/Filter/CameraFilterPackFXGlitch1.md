...
---
uid: Global.CameraFilterPack_FX_Glitch1
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXGlitch1
---

# Class CameraFilterPack_FX_Glitch1
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Glitch1
