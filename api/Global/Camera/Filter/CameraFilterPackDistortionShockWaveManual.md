...
---
uid: Global.CameraFilterPack_Distortion_ShockWaveManual
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionShockWaveManual
---

# Class CameraFilterPack_Distortion_ShockWaveManual
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_ShockWaveManual
