...
---
uid: Global.CameraFilterPack_Glasses_On
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGlassesOn
---

# Class CameraFilterPack_Glasses_On
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Glasses_On
