...
---
uid: Global.CameraFilterPack_Distortion_Dream
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionDream
---

# Class CameraFilterPack_Distortion_Dream
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Dream
