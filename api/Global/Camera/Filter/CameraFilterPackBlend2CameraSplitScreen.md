...
---
uid: Global.CameraFilterPack_Blend2Camera_SplitScreen
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraSplitScreen
---

# Class CameraFilterPack_Blend2Camera_SplitScreen
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_SplitScreen
