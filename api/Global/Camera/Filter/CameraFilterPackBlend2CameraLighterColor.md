---
uid: Global.CameraFilterPack_Blend2Camera_LighterColor
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraLighterColor
---
# Class CameraFilterPack_Blend2Camera_LighterColor
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_LighterColor
