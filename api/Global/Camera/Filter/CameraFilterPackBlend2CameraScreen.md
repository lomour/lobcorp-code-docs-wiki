---
uid: Global.CameraFilterPack_Blend2Camera_Screen
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraScreen
---
# Class CameraFilterPack_Blend2Camera_Screen
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Screen
