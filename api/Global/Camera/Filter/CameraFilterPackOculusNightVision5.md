...
---
uid: Global.CameraFilterPack_Oculus_NightVision5
canonical_path: /api/Global/Camera/Filter/CameraFilterPackOculusNightVision5
---

# Class CameraFilterPack_Oculus_NightVision5
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Oculus_NightVision5
