---
uid: Global.CameraFilterPack_3D_Snow
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DSnow
---
# Class CameraFilterPack_3D_Snow
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Snow
