---
uid: Global.CameraFilterPack_FX_DigitalMatrix
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXDigitalMatrix
---
# Class CameraFilterPack_FX_DigitalMatrix
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_DigitalMatrix
