---
uid: Global.CameraFilterPack_TV_Tiles
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVTiles
---
# Class CameraFilterPack_TV_Tiles
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Tiles
