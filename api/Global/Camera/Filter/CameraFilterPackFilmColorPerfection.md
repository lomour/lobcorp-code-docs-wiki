---
uid: Global.CameraFilterPack_Film_ColorPerfection
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFilmColorPerfection
---
# Class CameraFilterPack_Film_ColorPerfection
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Film_ColorPerfection
