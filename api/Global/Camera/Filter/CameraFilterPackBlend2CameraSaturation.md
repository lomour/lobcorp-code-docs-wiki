...
---
uid: Global.CameraFilterPack_Blend2Camera_Saturation
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraSaturation
---

# Class CameraFilterPack_Blend2Camera_Saturation
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Saturation
