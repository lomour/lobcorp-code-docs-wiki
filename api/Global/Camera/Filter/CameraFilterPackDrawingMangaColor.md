...
---
uid: Global.CameraFilterPack_Drawing_Manga_Color
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingMangaColor
---

# Class CameraFilterPack_Drawing_Manga_Color
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga_Color
