...
---
uid: Global.CameraFilterPack_Blend2Camera_Lighten
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraLighten
---

# Class CameraFilterPack_Blend2Camera_Lighten
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Lighten
