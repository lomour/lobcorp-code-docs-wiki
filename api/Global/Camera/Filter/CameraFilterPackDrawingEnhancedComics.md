---
uid: Global.CameraFilterPack_Drawing_EnhancedComics
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingEnhancedComics
---
# Class CameraFilterPack_Drawing_EnhancedComics
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_EnhancedComics
