---
uid: Global.CameraFilterPack_TV_ARCADE
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVARCADE
---
# Class CameraFilterPack_TV_ARCADE
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_ARCADE
