...
---
uid: Global.CameraFilterPack_Distortion_Dream2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionDream2
---

# Class CameraFilterPack_Distortion_Dream2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Dream2
