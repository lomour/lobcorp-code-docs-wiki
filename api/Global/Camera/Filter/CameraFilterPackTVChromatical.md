...
---
uid: Global.CameraFilterPack_TV_Chromatical
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVChromatical
---

# Class CameraFilterPack_TV_Chromatical
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Chromatical
