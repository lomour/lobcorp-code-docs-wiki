...
---
uid: Global.CameraFilterPack_Colors_DarkColor
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsDarkColor
---

# Class CameraFilterPack_Colors_DarkColor
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_DarkColor
