---
uid: Global.CameraFilterPack_Blur_DitherOffset
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurDitherOffset
---
# Class CameraFilterPack_Blur_DitherOffset
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_DitherOffset
