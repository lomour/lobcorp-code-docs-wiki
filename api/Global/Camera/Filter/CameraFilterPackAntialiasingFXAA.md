...
---
uid: Global.CameraFilterPack_Antialiasing_FXAA
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAntialiasingFXAA
---

# Class CameraFilterPack_Antialiasing_FXAA
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Antialiasing_FXAA
