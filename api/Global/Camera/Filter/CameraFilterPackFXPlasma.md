...
---
uid: Global.CameraFilterPack_FX_Plasma
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXPlasma
---

# Class CameraFilterPack_FX_Plasma
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Plasma
