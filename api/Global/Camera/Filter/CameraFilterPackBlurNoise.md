...
---
uid: Global.CameraFilterPack_Blur_Noise
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurNoise
---

# Class CameraFilterPack_Blur_Noise
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Noise
