---
uid: Global.CameraFilterPack_Colors_Brightness
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsBrightness
---
# Class CameraFilterPack_Colors_Brightness
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_Brightness
