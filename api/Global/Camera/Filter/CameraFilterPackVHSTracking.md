...
---
uid: Global.CameraFilterPack_VHS_Tracking
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVHSTracking
---

# Class CameraFilterPack_VHS_Tracking
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_VHS_Tracking
