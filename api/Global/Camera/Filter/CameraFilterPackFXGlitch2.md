...
---
uid: Global.CameraFilterPack_FX_Glitch2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXGlitch2
---

# Class CameraFilterPack_FX_Glitch2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Glitch2
