---
uid: Global.CameraFilterPack_Blend2Camera_Multiply
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraMultiply
---
# Class CameraFilterPack_Blend2Camera_Multiply
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Multiply
