...
---
uid: Global.CameraFilterPack_Vision_Hell_Blood
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionHellBlood
---

# Class CameraFilterPack_Vision_Hell_Blood
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Hell_Blood
