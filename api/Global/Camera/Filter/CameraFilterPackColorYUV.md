---
uid: Global.CameraFilterPack_Color_YUV
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorYUV
---
# Class CameraFilterPack_Color_YUV
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Color_YUV
