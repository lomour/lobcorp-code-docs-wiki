...
---
uid: Global.CameraFilterPack_Distortion_Twist_Square
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionTwistSquare
---

# Class CameraFilterPack_Distortion_Twist_Square
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Twist_Square
