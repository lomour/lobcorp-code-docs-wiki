...
---
uid: Global.CameraFilterPack_FX_Hypno
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXHypno
---

# Class CameraFilterPack_FX_Hypno
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Hypno
