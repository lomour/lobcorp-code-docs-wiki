...
---
uid: Global.CameraFilterPack_Color_RGB
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorRGB
---

# Class CameraFilterPack_Color_RGB
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Color_RGB
