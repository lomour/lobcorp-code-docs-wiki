...
---
uid: Global.CameraFilterPack_TV_Vintage
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVVintage
---

# Class CameraFilterPack_TV_Vintage
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Vintage
