---
uid: Global.CameraFilterPack_EXTRA_Rotation
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEXTRARotation
---
# Class CameraFilterPack_EXTRA_Rotation
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_EXTRA_Rotation
