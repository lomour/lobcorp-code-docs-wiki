...
---
uid: Global.CameraFilterPack_FX_8bits_gb
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFX8bitsgb
---

# Class CameraFilterPack_FX_8bits_gb
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_8bits_gb
