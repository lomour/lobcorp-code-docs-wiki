---
uid: Global.CameraFilterPack_Distortion_Flag
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionFlag
---
# Class CameraFilterPack_Distortion_Flag
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Flag
