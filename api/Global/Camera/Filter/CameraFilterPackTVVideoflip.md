...
---
uid: Global.CameraFilterPack_TV_Videoflip
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVVideoflip
---

# Class CameraFilterPack_TV_Videoflip
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Videoflip
