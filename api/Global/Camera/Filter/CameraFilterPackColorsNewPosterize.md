---
uid: Global.CameraFilterPack_Colors_NewPosterize
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsNewPosterize
---
# Class CameraFilterPack_Colors_NewPosterize
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_NewPosterize
