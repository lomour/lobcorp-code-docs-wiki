...
---
uid: Global.CameraFilterPack_Blend2Camera_Divide
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraDivide
---

# Class CameraFilterPack_Blend2Camera_Divide
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Divide
