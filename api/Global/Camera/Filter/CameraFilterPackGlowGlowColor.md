...
---
uid: Global.CameraFilterPack_Glow_Glow_Color
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGlowGlowColor
---

# Class CameraFilterPack_Glow_Glow_Color
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Glow_Glow_Color
