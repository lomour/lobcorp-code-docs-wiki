...
---
uid: Global.CameraFilterPack_Drawing_CellShading
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingCellShading
---

# Class CameraFilterPack_Drawing_CellShading
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_CellShading
