...
---
uid: Global.CameraFilterPack_Gradients_Stripe
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsStripe
---

# Class CameraFilterPack_Gradients_Stripe
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_Stripe
