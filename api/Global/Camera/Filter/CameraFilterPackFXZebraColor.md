---
uid: Global.CameraFilterPack_FX_ZebraColor
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXZebraColor
---
# Class CameraFilterPack_FX_ZebraColor
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_ZebraColor
