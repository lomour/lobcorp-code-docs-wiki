...
---
uid: Global.CameraFilterPack_Blur_Tilt_Shift
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurTiltShift
---

# Class CameraFilterPack_Blur_Tilt_Shift
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Tilt_Shift
