...
---
uid: Global.CameraFilterPack_Blur_BlurHole
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurBlurHole
---

# Class CameraFilterPack_Blur_BlurHole
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_BlurHole
