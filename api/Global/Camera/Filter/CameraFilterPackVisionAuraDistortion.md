...
---
uid: Global.CameraFilterPack_Vision_AuraDistortion
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionAuraDistortion
---

# Class CameraFilterPack_Vision_AuraDistortion
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_AuraDistortion
