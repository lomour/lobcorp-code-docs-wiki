...
---
uid: Global.CameraFilterPack_Blend2Camera_Luminosity
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraLuminosity
---

# Class CameraFilterPack_Blend2Camera_Luminosity
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Luminosity
