...
---
uid: Global.CameraFilterPack_Gradients_NeonGradient
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsNeonGradient
---

# Class CameraFilterPack_Gradients_NeonGradient
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_NeonGradient
