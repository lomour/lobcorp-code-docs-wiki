...
---
uid: Global.CameraFilterPack_3D_Anomaly
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DAnomaly
---

# Class CameraFilterPack_3D_Anomaly
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Anomaly
