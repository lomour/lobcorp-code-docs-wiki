...
---
uid: Global.CameraFilterPack_3D_Scan_Scene
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DScanScene
---

# Class CameraFilterPack_3D_Scan_Scene
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Scan_Scene
