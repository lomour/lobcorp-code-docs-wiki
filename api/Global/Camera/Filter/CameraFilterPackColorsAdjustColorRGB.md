...
---
uid: Global.CameraFilterPack_Colors_Adjust_ColorRGB
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsAdjustColorRGB
---

# Class CameraFilterPack_Colors_Adjust_ColorRGB
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_Adjust_ColorRGB
