...
---
uid: Global.CameraFilterPack_Edge_Sobel
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEdgeSobel
---

# Class CameraFilterPack_Edge_Sobel
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Edge_Sobel
