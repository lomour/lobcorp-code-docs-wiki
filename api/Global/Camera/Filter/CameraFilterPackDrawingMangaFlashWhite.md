...
---
uid: Global.CameraFilterPack_Drawing_Manga_FlashWhite
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingMangaFlashWhite
---

# Class CameraFilterPack_Drawing_Manga_FlashWhite
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga_FlashWhite
