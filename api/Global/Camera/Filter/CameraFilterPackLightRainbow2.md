...
---
uid: Global.CameraFilterPack_Light_Rainbow2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackLightRainbow2
---

# Class CameraFilterPack_Light_Rainbow2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Light_Rainbow2
