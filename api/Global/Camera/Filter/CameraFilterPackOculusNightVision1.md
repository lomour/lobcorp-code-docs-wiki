...
---
uid: Global.CameraFilterPack_Oculus_NightVision1
canonical_path: /api/Global/Camera/Filter/CameraFilterPackOculusNightVision1
---

# Class CameraFilterPack_Oculus_NightVision1
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Oculus_NightVision1
