---
uid: Global.CameraFilterPack_TV_ARCADE_Fast
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVARCADEFast
---
# Class CameraFilterPack_TV_ARCADE_Fast
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_ARCADE_Fast
