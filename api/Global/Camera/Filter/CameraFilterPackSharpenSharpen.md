...
---
uid: Global.CameraFilterPack_Sharpen_Sharpen
canonical_path: /api/Global/Camera/Filter/CameraFilterPackSharpenSharpen
---

# Class CameraFilterPack_Sharpen_Sharpen
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Sharpen_Sharpen
