...
---
uid: Global.CameraFilterPack_Distortion_Flush
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionFlush
---

# Class CameraFilterPack_Distortion_Flush
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Flush
