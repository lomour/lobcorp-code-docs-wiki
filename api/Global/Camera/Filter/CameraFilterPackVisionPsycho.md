...
---
uid: Global.CameraFilterPack_Vision_Psycho
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionPsycho
---

# Class CameraFilterPack_Vision_Psycho
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Psycho
