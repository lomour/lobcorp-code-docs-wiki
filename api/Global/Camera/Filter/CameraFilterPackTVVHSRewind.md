...
---
uid: Global.CameraFilterPack_TV_VHS_Rewind
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVVHSRewind
---

# Class CameraFilterPack_TV_VHS_Rewind
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_VHS_Rewind
