...
---
uid: Global.CameraFilterPack_Convert_Normal
canonical_path: /api/Global/Camera/Filter/CameraFilterPackConvertNormal
---

# Class CameraFilterPack_Convert_Normal
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Convert_Normal
