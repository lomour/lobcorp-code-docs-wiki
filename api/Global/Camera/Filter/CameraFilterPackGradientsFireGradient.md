---
uid: Global.CameraFilterPack_Gradients_FireGradient
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsFireGradient
---
# Class CameraFilterPack_Gradients_FireGradient
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_FireGradient
