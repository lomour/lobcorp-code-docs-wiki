...
---
uid: Global.CameraFilterPack_Blend2Camera_LinearDodge
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraLinearDodge
---

# Class CameraFilterPack_Blend2Camera_LinearDodge
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_LinearDodge
