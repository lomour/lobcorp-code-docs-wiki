...
---
uid: Global.CameraFilterPack_Lut_TestMode
canonical_path: /api/Global/Camera/Filter/CameraFilterPackLutTestMode
---

# Class CameraFilterPack_Lut_TestMode
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Lut_TestMode
...
| --- | --- | --- |
| `temp2DTex` | `UnityEngine.Texture2D` |  |
