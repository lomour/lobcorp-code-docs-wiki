...
---
uid: Global.CameraFilterPack_Drawing_Manga
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingManga
---

# Class CameraFilterPack_Drawing_Manga
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga
