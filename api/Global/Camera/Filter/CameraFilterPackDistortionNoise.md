...
---
uid: Global.CameraFilterPack_Distortion_Noise
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionNoise
---

# Class CameraFilterPack_Distortion_Noise
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Noise
