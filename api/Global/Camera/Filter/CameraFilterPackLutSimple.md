...
---
uid: Global.CameraFilterPack_Lut_Simple
canonical_path: /api/Global/Camera/Filter/CameraFilterPackLutSimple
---

# Class CameraFilterPack_Lut_Simple
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Lut_Simple
