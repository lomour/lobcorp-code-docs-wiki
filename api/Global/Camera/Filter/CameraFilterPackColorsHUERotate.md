...
---
uid: Global.CameraFilterPack_Colors_HUE_Rotate
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsHUERotate
---

# Class CameraFilterPack_Colors_HUE_Rotate
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_HUE_Rotate
