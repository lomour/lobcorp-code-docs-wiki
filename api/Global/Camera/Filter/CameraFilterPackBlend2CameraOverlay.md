...
---
uid: Global.CameraFilterPack_Blend2Camera_Overlay
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraOverlay
---

# Class CameraFilterPack_Blend2Camera_Overlay
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Overlay
