...
---
uid: Global.CameraFilterPack_Glasses_On_6
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGlassesOn6
---

# Class CameraFilterPack_Glasses_On_6
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Glasses_On_6
