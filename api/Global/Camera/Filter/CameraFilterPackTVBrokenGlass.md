...
---
uid: Global.CameraFilterPack_TV_BrokenGlass
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVBrokenGlass
---

# Class CameraFilterPack_TV_BrokenGlass
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_BrokenGlass
