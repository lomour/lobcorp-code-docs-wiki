...
---
uid: Global.CameraFilterPack_Drawing_NewCellShading
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingNewCellShading
---

# Class CameraFilterPack_Drawing_NewCellShading
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_NewCellShading
