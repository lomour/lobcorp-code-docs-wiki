...
---
uid: Global.CameraFilterPack_Vision_Rainbow
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionRainbow
---

# Class CameraFilterPack_Vision_Rainbow
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Rainbow
