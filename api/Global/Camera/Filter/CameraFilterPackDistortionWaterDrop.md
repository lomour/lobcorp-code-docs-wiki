...
---
uid: Global.CameraFilterPack_Distortion_Water_Drop
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionWaterDrop
---

# Class CameraFilterPack_Distortion_Water_Drop
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Water_Drop
