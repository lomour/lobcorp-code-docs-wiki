...
---
uid: Global.CameraFilterPack_TV_CompressionFX
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVCompressionFX
---

# Class CameraFilterPack_TV_CompressionFX
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_CompressionFX
