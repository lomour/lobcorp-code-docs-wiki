---
uid: Global.CameraFilterPack_AAA_BloodOnScreen
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAAABloodOnScreen
---
# Class CameraFilterPack_AAA_BloodOnScreen
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_AAA_BloodOnScreen
