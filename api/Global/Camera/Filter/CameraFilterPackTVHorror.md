---
uid: Global.CameraFilterPack_TV_Horror
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVHorror
---
# Class CameraFilterPack_TV_Horror
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Horror
