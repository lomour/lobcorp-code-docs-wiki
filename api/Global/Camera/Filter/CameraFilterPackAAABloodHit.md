...
---
uid: Global.CameraFilterPack_AAA_Blood_Hit
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAAABloodHit
---

# Class CameraFilterPack_AAA_Blood_Hit
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_AAA_Blood_Hit
