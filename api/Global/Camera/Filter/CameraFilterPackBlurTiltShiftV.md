...
---
uid: Global.CameraFilterPack_Blur_Tilt_Shift_V
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurTiltShiftV
---

# Class CameraFilterPack_Blur_Tilt_Shift_V
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Tilt_Shift_V
