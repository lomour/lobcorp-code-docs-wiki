...
---
uid: Global.CameraFilterPack_Glow_Glow
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGlowGlow
---

# Class CameraFilterPack_Glow_Glow
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Glow_Glow
