---
uid: Global.CameraFilterPack_Distortion_Wave_Horizontal
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionWaveHorizontal
---
# Class CameraFilterPack_Distortion_Wave_Horizontal
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Wave_Horizontal
