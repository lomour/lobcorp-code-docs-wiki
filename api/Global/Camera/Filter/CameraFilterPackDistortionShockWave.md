---
uid: Global.CameraFilterPack_Distortion_ShockWave
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionShockWave
---
# Class CameraFilterPack_Distortion_ShockWave
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_ShockWave
