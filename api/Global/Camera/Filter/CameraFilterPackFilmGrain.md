---
uid: Global.CameraFilterPack_Film_Grain
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFilmGrain
---
# Class CameraFilterPack_Film_Grain
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Film_Grain
