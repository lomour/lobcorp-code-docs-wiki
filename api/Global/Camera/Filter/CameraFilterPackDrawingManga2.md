...
---
uid: Global.CameraFilterPack_Drawing_Manga2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingManga2
---

# Class CameraFilterPack_Drawing_Manga2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga2
