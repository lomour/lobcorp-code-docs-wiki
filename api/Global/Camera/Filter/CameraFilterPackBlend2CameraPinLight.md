---
uid: Global.CameraFilterPack_Blend2Camera_PinLight
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraPinLight
---
# Class CameraFilterPack_Blend2Camera_PinLight
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_PinLight
