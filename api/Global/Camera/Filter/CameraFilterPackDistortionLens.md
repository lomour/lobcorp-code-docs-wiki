...
---
uid: Global.CameraFilterPack_Distortion_Lens
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionLens
---

# Class CameraFilterPack_Distortion_Lens
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Lens
