...
---
uid: Global.CameraFilterPack_Glasses_On_5
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGlassesOn5
---

# Class CameraFilterPack_Glasses_On_5
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Glasses_On_5
