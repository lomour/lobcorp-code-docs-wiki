...
---
uid: Global.CameraFilterPack_Vision_Aura
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionAura
---

# Class CameraFilterPack_Vision_Aura
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Aura
