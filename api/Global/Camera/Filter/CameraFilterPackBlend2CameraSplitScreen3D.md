...
---
uid: Global.CameraFilterPack_Blend2Camera_SplitScreen3D
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraSplitScreen3D
---

# Class CameraFilterPack_Blend2Camera_SplitScreen3D
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_SplitScreen3D
