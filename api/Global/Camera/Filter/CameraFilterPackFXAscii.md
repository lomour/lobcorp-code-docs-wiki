...
---
uid: Global.CameraFilterPack_FX_Ascii
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXAscii
---

# Class CameraFilterPack_FX_Ascii
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Ascii
