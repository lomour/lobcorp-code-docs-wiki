...
---
uid: Global.CameraFilterPack_Edge_Golden
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEdgeGolden
---

# Class CameraFilterPack_Edge_Golden
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Edge_Golden
