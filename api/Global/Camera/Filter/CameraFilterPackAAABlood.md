...
---
uid: Global.CameraFilterPack_AAA_Blood
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAAABlood
---

# Class CameraFilterPack_AAA_Blood
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_AAA_Blood
