...
---
uid: Global.CameraFilterPack_FX_Screens
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXScreens
---

# Class CameraFilterPack_FX_Screens
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Screens
