...
---
uid: Global.CameraFilterPack_TV_PlanetMars
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVPlanetMars
---

# Class CameraFilterPack_TV_PlanetMars
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_PlanetMars
