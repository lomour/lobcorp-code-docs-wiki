...
---
uid: Global.CameraFilterPack_Vision_Plasma
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionPlasma
---

# Class CameraFilterPack_Vision_Plasma
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Plasma
