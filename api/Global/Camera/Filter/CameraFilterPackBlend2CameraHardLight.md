...
---
uid: Global.CameraFilterPack_Blend2Camera_HardLight
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraHardLight
---

# Class CameraFilterPack_Blend2Camera_HardLight
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_HardLight
