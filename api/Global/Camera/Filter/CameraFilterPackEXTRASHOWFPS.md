...
---
uid: Global.CameraFilterPack_EXTRA_SHOWFPS
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEXTRASHOWFPS
---

# Class CameraFilterPack_EXTRA_SHOWFPS
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_EXTRA_SHOWFPS
