...
---
uid: Global.CameraFilterPack_Real_VHS
canonical_path: /api/Global/Camera/Filter/CameraFilterPackRealVHS
---

# Class CameraFilterPack_Real_VHS
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Real_VHS
...
### GetRTPixels(Texture2D, RenderTexture, int, int)
```csharp
