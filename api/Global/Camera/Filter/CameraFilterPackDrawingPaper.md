...
---
uid: Global.CameraFilterPack_Drawing_Paper
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingPaper
---

# Class CameraFilterPack_Drawing_Paper
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Paper
