...
---
uid: Global.CameraFilterPack_FX_Mirror
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXMirror
---

# Class CameraFilterPack_FX_Mirror
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Mirror
