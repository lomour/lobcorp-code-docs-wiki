...
---
uid: Global.CameraFilterPack_Retro_Loading
canonical_path: /api/Global/Camera/Filter/CameraFilterPackRetroLoading
---

# Class CameraFilterPack_Retro_Loading
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Retro_Loading
