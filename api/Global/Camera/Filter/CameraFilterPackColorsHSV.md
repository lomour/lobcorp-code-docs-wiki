---
uid: Global.CameraFilterPack_Colors_HSV
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsHSV
---
# Class CameraFilterPack_Colors_HSV
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_HSV
