---
uid: Global.CameraFilterPack_Atmosphere_Fog
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAtmosphereFog
---
# Class CameraFilterPack_Atmosphere_Fog
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Atmosphere_Fog
