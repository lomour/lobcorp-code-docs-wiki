...
---
uid: Global.CameraFilterPack_Vision_Tunnel
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionTunnel
---

# Class CameraFilterPack_Vision_Tunnel
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Tunnel
