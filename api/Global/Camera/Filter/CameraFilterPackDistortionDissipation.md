---
uid: Global.CameraFilterPack_Distortion_Dissipation
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionDissipation
---
# Class CameraFilterPack_Distortion_Dissipation
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Dissipation
