...
---
uid: Global.CameraFilterPack_Drawing_Manga4
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingManga4
---

# Class CameraFilterPack_Drawing_Manga4
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Manga4
