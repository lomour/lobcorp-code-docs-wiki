...
---
uid: Global.CameraFilterPack_TV_WideScreenHV
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVWideScreenHV
---

# Class CameraFilterPack_TV_WideScreenHV
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_WideScreenHV
