...
---
uid: Global.CameraFilterPack_Blend2Camera_Color
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraColor
---

# Class CameraFilterPack_Blend2Camera_Color
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Color
