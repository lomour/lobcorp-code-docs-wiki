...
---
uid: Global.CameraFilterPack_3D_Matrix
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DMatrix
---

# Class CameraFilterPack_3D_Matrix
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Matrix
