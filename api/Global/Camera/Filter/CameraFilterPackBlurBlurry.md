...
---
uid: Global.CameraFilterPack_Blur_Blurry
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurBlurry
---

# Class CameraFilterPack_Blur_Blurry
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Blurry
