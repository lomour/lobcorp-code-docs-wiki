...
---
uid: Global.CameraFilterPack_Pixelisation_Dot
canonical_path: /api/Global/Camera/Filter/CameraFilterPackPixelisationDot
---

# Class CameraFilterPack_Pixelisation_Dot
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Pixelisation_Dot
