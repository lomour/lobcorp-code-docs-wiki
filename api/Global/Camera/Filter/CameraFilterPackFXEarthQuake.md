...
---
uid: Global.CameraFilterPack_FX_EarthQuake
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXEarthQuake
---

# Class CameraFilterPack_FX_EarthQuake
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_EarthQuake
