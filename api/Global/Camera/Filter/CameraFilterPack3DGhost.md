...
---
uid: Global.CameraFilterPack_3D_Ghost
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DGhost
---

# Class CameraFilterPack_3D_Ghost
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Ghost
