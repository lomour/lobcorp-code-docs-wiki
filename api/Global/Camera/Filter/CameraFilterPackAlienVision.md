...
---
uid: Global.CameraFilterPack_Alien_Vision
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAlienVision
---

# Class CameraFilterPack_Alien_Vision
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Alien_Vision
