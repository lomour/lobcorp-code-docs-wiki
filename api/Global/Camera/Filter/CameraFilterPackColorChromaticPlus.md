---
uid: Global.CameraFilterPack_Color_Chromatic_Plus
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorChromaticPlus
---
# Class CameraFilterPack_Color_Chromatic_Plus
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Color_Chromatic_Plus
