---
uid: Global.CameraFilterPack_Drawing_BluePrint
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingBluePrint
---
# Class CameraFilterPack_Drawing_BluePrint
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_BluePrint
