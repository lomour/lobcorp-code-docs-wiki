---
uid: Global.CameraFilterPack_Blur_Focus
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurFocus
---
# Class CameraFilterPack_Blur_Focus
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Focus
