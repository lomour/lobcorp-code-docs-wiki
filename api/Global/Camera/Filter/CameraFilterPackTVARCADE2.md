---
uid: Global.CameraFilterPack_TV_ARCADE_2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVARCADE2
---
# Class CameraFilterPack_TV_ARCADE_2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_ARCADE_2
