...
---
uid: Global.CameraFilterPack_3D_Binary
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DBinary
---

# Class CameraFilterPack_3D_Binary
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Binary
