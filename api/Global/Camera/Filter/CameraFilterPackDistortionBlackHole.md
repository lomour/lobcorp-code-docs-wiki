...
---
uid: Global.CameraFilterPack_Distortion_BlackHole
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionBlackHole
---

# Class CameraFilterPack_Distortion_BlackHole
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_BlackHole
