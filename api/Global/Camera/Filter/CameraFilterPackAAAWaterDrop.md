---
uid: Global.CameraFilterPack_AAA_WaterDrop
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAAAWaterDrop
---
# Class CameraFilterPack_AAA_WaterDrop
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_AAA_WaterDrop
