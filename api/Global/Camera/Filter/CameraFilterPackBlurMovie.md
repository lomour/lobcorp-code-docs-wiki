...
---
uid: Global.CameraFilterPack_Blur_Movie
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurMovie
---

# Class CameraFilterPack_Blur_Movie
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Movie
