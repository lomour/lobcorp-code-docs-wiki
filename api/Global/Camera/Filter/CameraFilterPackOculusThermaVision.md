...
---
uid: Global.CameraFilterPack_Oculus_ThermaVision
canonical_path: /api/Global/Camera/Filter/CameraFilterPackOculusThermaVision
---

# Class CameraFilterPack_Oculus_ThermaVision
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Oculus_ThermaVision
