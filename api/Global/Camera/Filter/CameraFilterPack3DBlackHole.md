...
---
uid: Global.CameraFilterPack_3D_BlackHole
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DBlackHole
---

# Class CameraFilterPack_3D_BlackHole
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_BlackHole
