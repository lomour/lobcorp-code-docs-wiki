...
---
uid: Global.CameraFilterPack_Distortion_Aspiration
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionAspiration
---

# Class CameraFilterPack_Distortion_Aspiration
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Aspiration
