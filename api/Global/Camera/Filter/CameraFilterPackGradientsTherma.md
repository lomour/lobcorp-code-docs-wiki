...
---
uid: Global.CameraFilterPack_Gradients_Therma
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsTherma
---

# Class CameraFilterPack_Gradients_Therma
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_Therma
