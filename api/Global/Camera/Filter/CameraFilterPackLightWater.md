...
---
uid: Global.CameraFilterPack_Light_Water
canonical_path: /api/Global/Camera/Filter/CameraFilterPackLightWater
---

# Class CameraFilterPack_Light_Water
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Light_Water
