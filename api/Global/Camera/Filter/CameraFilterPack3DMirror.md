...
---
uid: Global.CameraFilterPack_3D_Mirror
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DMirror
---

# Class CameraFilterPack_3D_Mirror
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Mirror
