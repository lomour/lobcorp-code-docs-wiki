---
uid: Global.CameraFilterPack_Oculus_NightVision3
canonical_path: /api/Global/Camera/Filter/CameraFilterPackOculusNightVision3
---
# Class CameraFilterPack_Oculus_NightVision3
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Oculus_NightVision3
