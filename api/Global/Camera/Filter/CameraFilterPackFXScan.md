---
uid: Global.CameraFilterPack_FX_Scan
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXScan
---
# Class CameraFilterPack_FX_Scan
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Scan
