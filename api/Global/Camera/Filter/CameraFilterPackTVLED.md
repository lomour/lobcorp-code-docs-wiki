---
uid: Global.CameraFilterPack_TV_LED
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVLED
---
# Class CameraFilterPack_TV_LED
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_LED
