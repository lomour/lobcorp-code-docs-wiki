...
---
uid: Global.CameraFilterPack_Broken_Screen
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBrokenScreen
---

# Class CameraFilterPack_Broken_Screen
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Broken_Screen
