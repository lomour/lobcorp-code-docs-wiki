...
---
uid: Global.CameraFilterPack_TV_VHS
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVVHS
---

# Class CameraFilterPack_TV_VHS
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_VHS
