---
uid: Global.CameraFilterPack_Distortion_Half_Sphere
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDistortionHalfSphere
---
# Class CameraFilterPack_Distortion_Half_Sphere
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Distortion_Half_Sphere
