---
uid: Global.CameraFilterPack_Vision_Blood
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionBlood
---
# Class CameraFilterPack_Vision_Blood
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Blood
