...
---
uid: Global.CameraFilterPack_Blend2Camera_PhotoshopFilters
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraPhotoshopFilters
---

# Class CameraFilterPack_Blend2Camera_PhotoshopFilters
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_PhotoshopFilters
