...
---
uid: Global.CameraFilterPack_TV_WideScreenCircle
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVWideScreenCircle
---

# Class CameraFilterPack_TV_WideScreenCircle
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_WideScreenCircle
