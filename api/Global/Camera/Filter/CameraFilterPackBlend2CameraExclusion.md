...
---
uid: Global.CameraFilterPack_Blend2Camera_Exclusion
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraExclusion
---

# Class CameraFilterPack_Blend2Camera_Exclusion
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Exclusion
