...
---
uid: Global.CameraFilterPack_Oculus_NightVision2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackOculusNightVision2
---

# Class CameraFilterPack_Oculus_NightVision2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Oculus_NightVision2
