---
uid: Global.CameraFilterPack_Colors_RgbClamp
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsRgbClamp
---
# Class CameraFilterPack_Colors_RgbClamp
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_RgbClamp
