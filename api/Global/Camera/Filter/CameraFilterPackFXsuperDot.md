...
---
uid: Global.CameraFilterPack_FX_superDot
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXsuperDot
---

# Class CameraFilterPack_FX_superDot
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_superDot
