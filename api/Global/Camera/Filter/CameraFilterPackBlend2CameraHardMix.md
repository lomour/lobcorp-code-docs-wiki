...
---
uid: Global.CameraFilterPack_Blend2Camera_HardMix
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraHardMix
---

# Class CameraFilterPack_Blend2Camera_HardMix
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_HardMix
