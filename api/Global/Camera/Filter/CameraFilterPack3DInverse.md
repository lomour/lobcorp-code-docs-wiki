...
---
uid: Global.CameraFilterPack_3D_Inverse
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DInverse
---

# Class CameraFilterPack_3D_Inverse
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Inverse
