...
---
uid: Global.CameraFilterPack_Color_Noise
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorNoise
---

# Class CameraFilterPack_Color_Noise
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Color_Noise
