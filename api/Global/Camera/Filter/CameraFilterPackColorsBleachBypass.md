---
uid: Global.CameraFilterPack_Colors_BleachBypass
canonical_path: /api/Global/Camera/Filter/CameraFilterPackColorsBleachBypass
---
# Class CameraFilterPack_Colors_BleachBypass
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Colors_BleachBypass
