...
---
uid: Global.CameraFilterPack_Blend2Camera_SoftLight
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraSoftLight
---

# Class CameraFilterPack_Blend2Camera_SoftLight
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_SoftLight
