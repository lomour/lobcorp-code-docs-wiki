...
---
uid: Global.CameraFilterPack_Atmosphere_Snow_8bits
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAtmosphereSnow8bits
---

# Class CameraFilterPack_Atmosphere_Snow_8bits
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Atmosphere_Snow_8bits
