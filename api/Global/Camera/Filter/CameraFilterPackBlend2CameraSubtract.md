...
---
uid: Global.CameraFilterPack_Blend2Camera_Subtract
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraSubtract
---

# Class CameraFilterPack_Blend2Camera_Subtract
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Subtract
