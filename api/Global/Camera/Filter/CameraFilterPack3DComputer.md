...
---
uid: Global.CameraFilterPack_3D_Computer
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DComputer
---

# Class CameraFilterPack_3D_Computer
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Computer
