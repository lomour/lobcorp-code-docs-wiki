...
---
uid: Global.CameraFilterPack_Blend2Camera_Hue
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraHue
---

# Class CameraFilterPack_Blend2Camera_Hue
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Hue
