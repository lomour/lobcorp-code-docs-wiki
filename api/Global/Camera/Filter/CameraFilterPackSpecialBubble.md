...
---
uid: Global.CameraFilterPack_Special_Bubble
canonical_path: /api/Global/Camera/Filter/CameraFilterPackSpecialBubble
---

# Class CameraFilterPack_Special_Bubble
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Special_Bubble
