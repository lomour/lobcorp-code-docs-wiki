...
---
uid: Global.CameraFilterPack_Drawing_Crosshatch
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingCrosshatch
---

# Class CameraFilterPack_Drawing_Crosshatch
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Crosshatch
