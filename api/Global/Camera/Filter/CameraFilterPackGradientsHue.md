...
---
uid: Global.CameraFilterPack_Gradients_Hue
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsHue
---

# Class CameraFilterPack_Gradients_Hue
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_Hue
