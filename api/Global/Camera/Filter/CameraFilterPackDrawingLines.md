...
---
uid: Global.CameraFilterPack_Drawing_Lines
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingLines
---

# Class CameraFilterPack_Drawing_Lines
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Lines
