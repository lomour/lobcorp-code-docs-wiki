...
---
uid: Global.CameraFilterPack_Gradients_Ansi
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsAnsi
---

# Class CameraFilterPack_Gradients_Ansi
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_Ansi
