---
uid: Global.CameraFilterPack_Blend2Camera_BlueScreen
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraBlueScreen
---
# Class CameraFilterPack_Blend2Camera_BlueScreen
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_BlueScreen
