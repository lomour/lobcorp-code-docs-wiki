---
uid: Global.CameraFilterPack_Light_Rainbow
canonical_path: /api/Global/Camera/Filter/CameraFilterPackLightRainbow
---
# Class CameraFilterPack_Light_Rainbow
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Light_Rainbow
