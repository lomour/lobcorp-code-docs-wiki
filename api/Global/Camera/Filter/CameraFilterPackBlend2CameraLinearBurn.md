---
uid: Global.CameraFilterPack_Blend2Camera_LinearBurn
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraLinearBurn
---
# Class CameraFilterPack_Blend2Camera_LinearBurn
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_LinearBurn
