...
---
uid: Global.CameraFilterPack_Blend2Camera_Darken
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraDarken
---

# Class CameraFilterPack_Blend2Camera_Darken
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Darken
