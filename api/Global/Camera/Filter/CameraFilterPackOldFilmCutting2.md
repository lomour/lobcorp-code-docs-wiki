---
uid: Global.CameraFilterPack_OldFilm_Cutting2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackOldFilmCutting2
---
# Class CameraFilterPack_OldFilm_Cutting2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_OldFilm_Cutting2
