...
---
uid: Global.CameraFilterPack_FX_Hexagon
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXHexagon
---

# Class CameraFilterPack_FX_Hexagon
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Hexagon
