---
uid: Global.CameraFilterPack_Blur_Regular
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurRegular
---
# Class CameraFilterPack_Blur_Regular
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Regular
