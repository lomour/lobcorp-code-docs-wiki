...
---
uid: Global.CameraFilterPack_Edge_Sigmoid
canonical_path: /api/Global/Camera/Filter/CameraFilterPackEdgeSigmoid
---

# Class CameraFilterPack_Edge_Sigmoid
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Edge_Sigmoid
