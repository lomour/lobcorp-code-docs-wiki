...
---
uid: Global.CameraFilterPack_Glasses_On_3
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGlassesOn3
---

# Class CameraFilterPack_Glasses_On_3
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Glasses_On_3
