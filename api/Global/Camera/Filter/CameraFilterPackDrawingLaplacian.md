...
---
uid: Global.CameraFilterPack_Drawing_Laplacian
canonical_path: /api/Global/Camera/Filter/CameraFilterPackDrawingLaplacian
---

# Class CameraFilterPack_Drawing_Laplacian
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Drawing_Laplacian
