...
---
uid: Global.CameraFilterPack_TV_Vignetting
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVVignetting
---

# Class CameraFilterPack_TV_Vignetting
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Vignetting
