...
---
uid: Global.CameraFilterPack_TV_Artefact
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVArtefact
---

# Class CameraFilterPack_TV_Artefact
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Artefact
