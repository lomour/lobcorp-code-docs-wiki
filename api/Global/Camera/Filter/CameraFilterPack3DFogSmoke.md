...
---
uid: Global.CameraFilterPack_3D_Fog_Smoke
canonical_path: /api/Global/Camera/Filter/CameraFilterPack3DFogSmoke
---

# Class CameraFilterPack_3D_Fog_Smoke
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_3D_Fog_Smoke
