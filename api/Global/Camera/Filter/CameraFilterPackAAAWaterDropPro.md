...
---
uid: Global.CameraFilterPack_AAA_WaterDropPro
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAAAWaterDropPro
---

# Class CameraFilterPack_AAA_WaterDropPro
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_AAA_WaterDropPro
