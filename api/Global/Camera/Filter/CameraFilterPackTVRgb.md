...
---
uid: Global.CameraFilterPack_TV_Rgb
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVRgb
---

# Class CameraFilterPack_TV_Rgb
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Rgb
