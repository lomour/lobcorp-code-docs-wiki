...
---
uid: Global.CameraFilterPack_Vision_SniperScore
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionSniperScore
---

# Class CameraFilterPack_Vision_SniperScore
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_SniperScore
