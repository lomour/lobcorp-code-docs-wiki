...
---
uid: Global.CameraFilterPack_Noise_TV_2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackNoiseTV2
---

# Class CameraFilterPack_Noise_TV_2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Noise_TV_2
