...
---
uid: Global.CameraFilterPack_TV_Old_Movie
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVOldMovie
---

# Class CameraFilterPack_TV_Old_Movie
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Old_Movie
