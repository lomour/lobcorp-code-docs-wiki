---
uid: Global.CameraFilterPack_Blend2Camera_LinearLight
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraLinearLight
---
# Class CameraFilterPack_Blend2Camera_LinearLight
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_LinearLight
