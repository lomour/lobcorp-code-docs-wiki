---
uid: Global.CameraFilterPack_TV_Chromatical2
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVChromatical2
---
# Class CameraFilterPack_TV_Chromatical2
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Chromatical2
