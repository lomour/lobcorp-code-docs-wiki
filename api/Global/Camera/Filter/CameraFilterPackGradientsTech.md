...
---
uid: Global.CameraFilterPack_Gradients_Tech
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsTech
---

# Class CameraFilterPack_Gradients_Tech
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_Tech
