---
uid: Global.CameraFilterPack_Blur_Bloom
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurBloom
---
# Class CameraFilterPack_Blur_Bloom
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Bloom
