...
---
uid: Global.CameraFilterPack_Gradients_Rainbow
canonical_path: /api/Global/Camera/Filter/CameraFilterPackGradientsRainbow
---

# Class CameraFilterPack_Gradients_Rainbow
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Gradients_Rainbow
