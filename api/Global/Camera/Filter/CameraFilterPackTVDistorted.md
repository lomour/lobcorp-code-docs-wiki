...
---
uid: Global.CameraFilterPack_TV_Distorted
canonical_path: /api/Global/Camera/Filter/CameraFilterPackTVDistorted
---

# Class CameraFilterPack_TV_Distorted
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_TV_Distorted
