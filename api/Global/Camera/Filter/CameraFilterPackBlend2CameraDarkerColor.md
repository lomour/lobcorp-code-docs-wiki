...
---
uid: Global.CameraFilterPack_Blend2Camera_DarkerColor
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraDarkerColor
---

# Class CameraFilterPack_Blend2Camera_DarkerColor
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_DarkerColor
