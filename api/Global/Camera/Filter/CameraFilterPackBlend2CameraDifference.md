...
---
uid: Global.CameraFilterPack_Blend2Camera_Difference
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlend2CameraDifference
---

# Class CameraFilterPack_Blend2Camera_Difference
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blend2Camera_Difference
