---
uid: Global.CameraFilterPack_Atmosphere_Rain
canonical_path: /api/Global/Camera/Filter/CameraFilterPackAtmosphereRain
---
# Class CameraFilterPack_Atmosphere_Rain
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Atmosphere_Rain
