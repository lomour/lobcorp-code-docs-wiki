...
---
uid: Global.CameraFilterPack_FX_DarkMatter
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXDarkMatter
---

# Class CameraFilterPack_FX_DarkMatter
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_DarkMatter
