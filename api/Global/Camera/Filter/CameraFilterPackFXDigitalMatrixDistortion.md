---
uid: Global.CameraFilterPack_FX_DigitalMatrixDistortion
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXDigitalMatrixDistortion
---
# Class CameraFilterPack_FX_DigitalMatrixDistortion
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_DigitalMatrixDistortion
