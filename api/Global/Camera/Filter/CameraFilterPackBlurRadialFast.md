---
uid: Global.CameraFilterPack_Blur_Radial_Fast
canonical_path: /api/Global/Camera/Filter/CameraFilterPackBlurRadialFast
---
# Class CameraFilterPack_Blur_Radial_Fast
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Blur_Radial_Fast
