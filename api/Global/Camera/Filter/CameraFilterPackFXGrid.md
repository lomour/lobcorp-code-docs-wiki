...
---
uid: Global.CameraFilterPack_FX_Grid
canonical_path: /api/Global/Camera/Filter/CameraFilterPackFXGrid
---

# Class CameraFilterPack_FX_Grid
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_FX_Grid
