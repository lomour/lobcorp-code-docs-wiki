...
---
uid: Global.CameraFilterPack_Vision_Warp
canonical_path: /api/Global/Camera/Filter/CameraFilterPackVisionWarp
---

# Class CameraFilterPack_Vision_Warp
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CameraFilterPack_Vision_Warp
