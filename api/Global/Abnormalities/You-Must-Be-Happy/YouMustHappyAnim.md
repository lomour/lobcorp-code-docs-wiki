---
uid: Global.YouMustHappyAnim
canonical_path: /api/Global/Creature/YouMustHappyAnim
---
# Class YouMustHappyAnim
...
Animation handler for [You Must Be Happy](/api/Global/Abnormalities/You-Must-Be-Happy/YouMustHappy).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → YouMustHappyAnim

## Constructors
### YouMustHappyAnim()
```csharp
public YouMustHappyAnim()
```
...
#### Field Value
**Type:** System.Collections.Generic.Queue{AgentModel}
...
#### Field Value
**Type:** Global.YouMustHappyAnimEventHandler
