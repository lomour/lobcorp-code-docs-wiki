...
Buff for [Child of the Galaxy](/api/Global/Abnormalities/Child-of-the-Galaxy/GalaxyBoy)'s favorite workers.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → FriendTokenBuf
