---
uid: Global.GalaxyBoyWeapon
canonical_path: /api/Global/Weapon/GalaxyBoyWeapon
---
# Class GalaxyBoyWeapon
...
Script for [Child of the Galaxy](/api/Global/Abnormalities/Child-of-the-Galaxy/GalaxyBoy)'s EGO Weapon: Our Galaxy. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → GalaxyBoyWeapon

## Constructors
### GalaxyBoyWeapon()
```csharp
public GalaxyBoyWeapon()
```
