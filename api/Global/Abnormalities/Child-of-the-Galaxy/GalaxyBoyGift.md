...
Script for [Child of the Galaxy](/api/Global/Abnormalities/Child-of-the-Galaxy/GalaxyBoy)'s EGO Gift: Our Galaxy.

Heals 1.8 HP and SP every 5 seconds #inc.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → GalaxyBoyGift
