...
Script for [Fragment of the Universe](/api/Global/Abnormalities/Fragment-of-the-Universe/Cosmos)'s EGO Weapon: Fragments from Somewhere.

Increase max SP by 40% for agents with level 4 or lower prudence on attack, at a 10% chance.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → CosmosWeapon
