---
uid: Global.CosmosArmor
canonical_path: /api/Global/Armor/CosmosArmor
---
# Class CosmosArmor
...
```csharp
public class CosmosArmor : EquipmentScriptBase
```
...
Script for [Fragment of the Universe](/api/Global/Abnormalities/Fragment-of-the-Universe/Cosmos)'s EGO Suit: Fragments from Somewhere. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → CosmosArmor
