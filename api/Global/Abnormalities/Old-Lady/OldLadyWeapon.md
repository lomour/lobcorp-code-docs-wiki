---
uid: Global.OldLadyWeapon
canonical_path: /api/Global/Weapon/OldLadyWeapon
---
# Class OldLadyWeapon
...
Script for [Old Lady](/api/Global/Abnormalities/Old-Lady/OldLady)'s EGO Weapon: Solitude. No script.



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → OldLadyWeapon

## Constructors
### OldLadyWeapon()
```csharp
public OldLadyWeapon()
```
