---
uid: Global.OldLadyArmor
canonical_path: /api/Global/Armor/OldLadyArmor
---
# Class OldLadyArmor
...
Script for [Old Lady](/api/Global/Abnormalities/Old-Lady/OldLady)'s EGO Suit: Solitude.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → OldLadyArmor
