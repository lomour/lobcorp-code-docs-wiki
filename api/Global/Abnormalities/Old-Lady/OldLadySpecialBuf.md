...
Effect given to 'solitude' employees after working with an upset [Old Lady](/api/Global/Abnormalities/Old-Lady/OldLady).
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → OldLadySpecialBuf
