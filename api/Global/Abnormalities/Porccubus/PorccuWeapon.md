---
uid: Global.PorccuWeapon
canonical_path: /api/Global/Weapon/PorccuWeapon
---
# Class PorccuWeapon
...
Script for [Porccubus](/api/Global/Abnormalities/Porccubus/Porccu)'s EGO Weapon: Pleasure.

Plays a sound when the attack starts.
After doing damage, gives the target the [PorccuWeaponDebuf](/api/Global/Abnormalities/Porccubus/PorccuWeaponDebuf) debuff for one second.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → PorccuWeapon
