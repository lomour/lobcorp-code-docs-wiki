---
uid: Global.PorccuAnim
canonical_path: /api/Global/Creature/PorccuAnim
---
# Class PorccuAnim
...
Animation handler for [Porccubus](/api/Global/Abnormalities/Porccubus/Porccu).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → PorccuAnim
