---
uid: Global.LumberjackWeapon
canonical_path: /api/Global/Weapon/LumberjackWeapon
---
# Class LumberjackWeapon
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class LumberjackWeapon : EquipmentScriptBase
```
> This class is not used.
{.is-info}


Script for [Warm-Hearted Woodsman](/api/Global/Abnormalities/Warm-Hearted-Woodsman/Lumberjack)'s EGO Weapon: Logging. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → LumberjackWeapon

## Constructors
### LumberjackWeapon()
```csharp
public LumberjackWeapon()
```
