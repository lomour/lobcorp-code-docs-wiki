---
uid: Global.OtherWorldPortrait
canonical_path: /api/Global/IOBserver/OtherWorldPortrait
---
# Class OtherWorldPortrait
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → OtherWorldPortrait
...
#### Field Value
**Type:** Global.OtherWorldPortraitAnim

### _LIMIT_CHANGE_PORTRAIT_1
```csharp
...
### insteadDmgRatio
```csharp
public float insteadDmgRatio { get; }
```
