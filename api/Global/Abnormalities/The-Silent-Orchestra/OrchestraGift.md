---
uid: Global.OrchestraGift
canonical_path: /api/Global/Gift/OrchestraGift
---
# Class OrchestraGift
...
Script for [The Silent Orchestra](/api/Global/Abnormalities/The-Silent-Orchestra/SilentOrchestra)'s EGO Gift: Da Capo. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → OrchestraGift

## Constructors
### OrchestraGift()
```csharp
public OrchestraGift()
```
