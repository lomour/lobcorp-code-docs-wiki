---
uid: Global.SilentOrchestraAnim
canonical_path: /api/Global/Creature/SilentOrchestraAnim
---
...
Animation handler for [The Silent Orchestra](/api/Global/Abnormalities/The-Silent-Orchestra/SilentOrchestra).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → SilentOrchestraAnim
...
### conductorAnim
```csharp
private Animator conductorAnim { get; }
```
