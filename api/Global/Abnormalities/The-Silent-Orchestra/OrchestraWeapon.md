---
uid: Global.OrchestraWeapon
canonical_path: /api/Global/Weapon/OrchestraWeapon
---
# Class OrchestraWeapon
...
Script for [The Silent Orchestra](/api/Global/Abnormalities/The-Silent-Orchestra/SilentOrchestra)'s EGO Weapon: Da Capo.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → OrchestraWeapon

## Constructors
### OrchestraWeapon()
```csharp
public OrchestraWeapon()
```
