---
uid: Global.ProphecyOfSkin
canonical_path: /api/Global/IOBserver/ProphecyOfSkin
---
# Class ProphecyOfSkin
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → ProphecyOfSkin
...
### _readAgentList
```csharp
private List<ProphecyOfSkin.ReadAgent> _readAgentList
```

#### Field Value
**Type:** System.Collections.Generic.List{ProphecyOfSkin.ReadAgent}
