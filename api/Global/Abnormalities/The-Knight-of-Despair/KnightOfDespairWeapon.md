---
uid: Global.KnightOfDespairWeapon
canonical_path: /api/Global/Weapon/KnightOfDespairWeapon
---
# Class KnightOfDespairWeapon
...
Script for [The Knight of Despair](/api/Global/Abnormalities/The-Knight-of-Despair/KnightOfDespair)'s EGO Weapon: The Sword Sharpened with Tears.

Does a special attack which does a bunch of little damages in addition to the normal damage, at a 30% chance.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → KnightOfDespairWeapon

## Constructors
### KnightOfDespairWeapon()
```csharp
public KnightOfDespairWeapon()
```
