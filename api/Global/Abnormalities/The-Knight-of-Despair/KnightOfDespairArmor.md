---
uid: Global.KnightOfDespairArmor
canonical_path: /api/Global/Armor/KnightOfDespairArmor
---
# Class KnightOfDespairArmor
...
Script for [Knight of Despair](/api/Global/Abnormalities/The-Knight-of-Despair/KnightOfDespair)'s EGO Suit: The Sword Sharpened with Tears. Has a method to print to log, but nothing else.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → KnightOfDespairArmor

## Constructors
### KnightOfDespairArmor()
```csharp
public KnightOfDespairArmor()
```
