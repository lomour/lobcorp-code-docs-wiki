---
uid: Global.KnightOfDespairAnim
canonical_path: /api/Global/Creature/KnightOfDespairAnim
---
# Class KnightOfDespairAnim
...
Animation handler for [Knight of Despair](/api/Global/Abnormalities/The-Knight-of-Despair/KnightOfDespair). 

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → KnightOfDespairAnim
...
#### Field Value
**Type:** Global.KnightOfDespairSword[]
...
### MakeTeleportEffect(string, Vector3)
```csharp
...
```csharp
public void SetNormalAnim(KnightOfDespairAnim.AnimKey key)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `key` | `Global.KnightOfDespairAnim.AnimKey` |  |

### SetScript(KnightOfDespair)
```csharp
