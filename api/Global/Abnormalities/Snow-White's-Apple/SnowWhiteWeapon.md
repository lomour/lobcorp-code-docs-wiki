---
uid: Global.SnowWhiteWeapon
canonical_path: /api/Global/Weapon/SnowWhiteWeapon
---
# Class SnowWhiteWeapon
...
Script for [Snow White's Apple](/api/Global/Abnormalities/Snow-White's-Apple/SnowWhite)'s EGO Weapon: Green Stem.

If the user has the corresponding EGO gift, increases the minimum and maximum damage by 5.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SnowWhiteWeapon
