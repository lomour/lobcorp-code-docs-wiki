---
uid: Global.SnowWhiteGift
canonical_path: /api/Global/Gift/SnowWhiteGift
---
# Class SnowWhiteGift
...
Script for [Snow White's Apple](/api/Global/Abnormalities/Snow-White's-Apple/SnowWhite)'s EGO Gift: Green Stem. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SnowWhiteGift

## Constructors
### SnowWhiteGift()
```csharp
public SnowWhiteGift()
```
