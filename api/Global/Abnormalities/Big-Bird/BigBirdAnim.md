---
uid: Global.BigBirdAnim
canonical_path: /api/Global/Creature/BigBirdAnim
---
# Class BigBirdAnim
...
Animation handler for [Big Bird](/api/Global/Abnormalities/Big-Bird/BigBird)


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → BigBirdAnim
