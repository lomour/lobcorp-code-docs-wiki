...
Script for [Big Bird](/api/Global/Abnormalities/Big-Bird/BigBird)'s EGO Weapon: Lamp. Gives weakness to black damage at a 25% chance.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BigBirdWeapon
