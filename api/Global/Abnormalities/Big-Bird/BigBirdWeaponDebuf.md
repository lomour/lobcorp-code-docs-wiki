---
uid: Global.BigBirdWeaponDebuf
canonical_path: /api/Global/UnitBuf/BigBirdWeaponDebuf
---
...
Extra black damage (1.5x) effect given by [Lamp (weapon)](/api/Global/Abnormalities/Big-Bird/BigBirdWeapon).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → BigBirdWeaponDebuf
