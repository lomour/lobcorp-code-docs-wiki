---
uid: Global.Mhz_1_76Gift
canonical_path: /api/Global/Misc/Mhz176Gift
---
# Class Mhz_1_76Gift
...
```csharp
public class Mhz_1_76Gift : EquipmentScriptBase
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → Mhz_1_76Gift
