---
uid: Global.YggdrasilArmor
canonical_path: /api/Global/Armor/YggdrasilArmor
---
# Class YggdrasilArmor
...
Script for [Parasite Tree](/api/Global/Abnormalities/Parasite-Tree/Yggdrasil)'s EGO Suit: Hypocrisy.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → YggdrasilArmor
