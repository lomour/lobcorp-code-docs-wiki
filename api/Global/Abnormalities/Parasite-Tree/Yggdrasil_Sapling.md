---
uid: Global.Yggdrasil_Sapling
canonical_path: /api/Global/Misc/YggdrasilSapling
---
# Class Yggdrasil_Sapling
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class Yggdrasil_Sapling : CreatureBase
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → Yggdrasil_Sapling

## Constructors
### Yggdrasil_Sapling()
```csharp
public Yggdrasil_Sapling()
```

## Fields
### _animScript
```csharp
private Yggdrasil_SaplingAnim _animScript
```

#### Field Value
**Type:** Global.Yggdrasil_SaplingAnim
...
### animScript
```csharp
public Yggdrasil_SaplingAnim animScript { get; }
```
