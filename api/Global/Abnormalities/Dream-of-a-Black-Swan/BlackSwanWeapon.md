---
uid: Global.BlackSwanWeapon
canonical_path: /api/Global/Weapon/BlackSwanWeapon
---
# Class BlackSwanWeapon
...
Script for [Dream of a Black Swan](/api/Global/Abnormalities/Dream-of-a-Black-Swan/BlackSwan)'s EGO Weapon: Black Swan.

Causes damage to be reflected at a 10% chance.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BlackSwanWeapon
...
## Methods
### MakeReflectEffect(UnitDirection)
```csharp
