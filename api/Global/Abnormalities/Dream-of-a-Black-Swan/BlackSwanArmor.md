---
uid: Global.BlackSwanArmor
canonical_path: /api/Global/Armor/BlackSwanArmor
---
# Class BlackSwanArmor
...
Script for [Dream of a Black Swan](/api/Global/Abnormalities/Dream-of-a-Black-Swan/BlackSwan)'s EGO Suit: Black Swan. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BlackSwanArmor

## Constructors
### BlackSwanArmor()
```csharp
public BlackSwanArmor()
```
