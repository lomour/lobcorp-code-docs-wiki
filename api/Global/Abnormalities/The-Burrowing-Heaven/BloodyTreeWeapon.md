---
uid: Global.BloodyTreeWeapon
canonical_path: /api/Global/Weapon/BloodyTreeWeapon
---
# Class BloodyTreeWeapon
...
Script for [The Burrowing Heaven](/api/Global/Abnormalities/The-Burrowing-Heaven/BloodyTree)'s EGO Weapon: Heaven. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BloodyTreeWeapon

## Constructors
### BloodyTreeWeapon()
```csharp
public BloodyTreeWeapon()
```
