---
uid: Global.BloodyTreeAnim
canonical_path: /api/Global/Creature/BloodyTreeAnim
---
# Class BloodyTreeAnim
...
Animation handler for [The Burrowing Heaven](/api/Global/Abnormalities/The-Burrowing-Heaven/BloodyTree).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → BloodyTreeAnim
