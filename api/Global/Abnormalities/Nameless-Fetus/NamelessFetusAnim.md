...
Animation handler for [Nameless Fetus](/api/Global/Abnormalities/Nameless-Fetus/NamelessFetus).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → NamelessFetusAnim
