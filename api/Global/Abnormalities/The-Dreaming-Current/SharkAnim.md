---
uid: Global.SharkAnim
canonical_path: /api/Global/Creature/SharkAnim
---
# Class SharkAnim
...
Animation handler for [The Dreaming Current](/api/Global/Abnormalities/The-Dreaming-Current/Shark).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → SharkAnim
