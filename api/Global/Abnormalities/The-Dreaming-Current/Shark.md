---
uid: Global.Shark
canonical_path: /api/Global/Misc/Shark
---
# Class Shark
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → Shark
...
### passagesDrugged
```csharp
private List<Shark.PassageDrugged> passagesDrugged
```

#### Field Value
**Type:** System.Collections.Generic.List{Shark.PassageDrugged}
...
### animScript
```csharp
public SharkAnim animScript { get; }
```
...
### chargeDmg
```csharp
private static int chargeDmg { get; }
```
