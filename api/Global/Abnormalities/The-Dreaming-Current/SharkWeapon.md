---
uid: Global.SharkWeapon
canonical_path: /api/Global/Weapon/SharkWeapon
---
# Class SharkWeapon
...
Script for [The Dreaming Current](/api/Global/Abnormalities/The-Dreaming-Current/Shark)'s EGO Weapon: Ecstasy. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SharkWeapon
