---
uid: Global.MatchGirlGift
canonical_path: /api/Global/Gift/MatchGirlGift
---
# Class MatchGirlGift
...
Script for [Scorched Girl](/api/Global/Abnormalities/Scorched-Girl/MatchGirl)'s EGO Gift: Fourth Match Flame. No script.



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → MatchGirlGift

## Constructors
### MatchGirlGift()
```csharp
public MatchGirlGift()
```
