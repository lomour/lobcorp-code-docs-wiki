---
uid: Global.MatchGirlWeapon
canonical_path: /api/Global/Weapon/MatchGirlWeapon
---
# Class MatchGirlWeapon
...
Script for [Scorched Girl](/api/Global/Abnormalities/Scorched-Girl/MatchGirl)'s EGO Weapon: Fourth Match Flame. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → MatchGirlWeapon

## Constructors
### MatchGirlWeapon()
```csharp
public MatchGirlWeapon()
```
