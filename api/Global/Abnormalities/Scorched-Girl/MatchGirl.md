---
uid: Global.MatchGirl
canonical_path: /api/Global/Misc/MatchGirl
---
# Class MatchGirl
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → MatchGirl
...
### afterMeetingTime
```csharp
private static float afterMeetingTime { get; }
```
...
### animScript
```csharp
public MatchGirlAnim animScript { get; }
```
