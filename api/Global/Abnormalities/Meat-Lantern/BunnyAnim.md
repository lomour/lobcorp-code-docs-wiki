---
uid: Global.BunnyAnim
canonical_path: /api/Global/Creature/BunnyAnim
---
# Class BunnyAnim
...
Animation handler for [Meat Lantern](/api/Global/Abnormalities/Meat-Lantern/Bunny).



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → BunnyAnim
...
```csharp
private void EventHandler(TrackEntry entry, Event eventData)
```
