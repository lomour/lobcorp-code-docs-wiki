---
uid: Global.IronMaidenAnim
canonical_path: /api/Global/Creature/IronMaidenAnim
---
# Class IronMaidenAnim
...
Animation handler for [We Can Change Anything](/api/Global/Abnormalities/We-Can-Change-Anything/IronMaiden).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → IronMaidenAnim

## Constructors
### IronMaidenAnim()
```csharp
public IronMaidenAnim()
```
...
#### Field Value
**Type:** Global.IronMaidenAnimEventHandler
...
#### Field Value
**Type:** Spine.Unity.Modules.SkeletonPartsRenderer
...
### StartGeneratingEnergy(AgentUnit)
```csharp
