---
uid: Global.DangoCreatureArmor
canonical_path: /api/Global/Armor/DangoCreatureArmor
---
# Class DangoCreatureArmor
...
Script for [Mountain of Smiling Bodies](/api/Global/Abnormalities/Mountain-of-Smiling-Bodies/DangoCreature)'s EGO Suit: Smile.

Eats bodies if close enough to heal the employee.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → DangoCreatureArmor

## Constructors
### DangoCreatureArmor()
```csharp
public DangoCreatureArmor()
```
