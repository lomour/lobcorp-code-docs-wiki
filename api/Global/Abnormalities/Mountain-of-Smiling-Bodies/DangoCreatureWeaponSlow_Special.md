---
uid: Global.DangoCreatureWeaponSlow_Special
canonical_path: /api/Global/UnitBuf/DangoCreatureWeaponSlowSpecial
---
# Class DangoCreatureWeaponSlow_Special
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → DangoCreatureWeaponSlow_Special

## Constructors
### DangoCreatureWeaponSlow_Special()
```csharp
...
### defaultLifeTime
```csharp
private const float defaultLifeTime = 3
```
