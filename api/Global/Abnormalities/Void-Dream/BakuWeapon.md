---
uid: Global.BakuWeapon
canonical_path: /api/Global/Weapon/BakuWeapon
---
# Class BakuWeapon
...
Script for [Void Dream](/api/Global/Abnormalities/Void-Dream/Baku)'s EGO Weapon: Engulfing Dream.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BakuWeapon
