---
uid: Global.BakuAnim
canonical_path: /api/Global/Creature/BakuAnim
---
# Class BakuAnim
...
Animation handler for [Void Dream](/api/Global/Abnormalities/Void-Dream/Baku).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → BakuAnim
...
### animSheep
```csharp
private Animator animSheep { get; }
```
