---
uid: Global.SmallBirdAnim
canonical_path: /api/Global/Creature/SmallBirdAnim
---
# Class SmallBirdAnim
...
Animation handler for [Punishing Bird](/api/Global/Abnormalities/Punishing-Bird/SmallBird).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → SmallBirdAnim
...
#### Field Value
**Type:** System.Collections.Generic.List{UnityEngine.Material}
...
### module
```csharp
public SmallBirdAnim.YAxisModule module
```

#### Field Value
**Type:** Global.SmallBirdAnim.YAxisModule
...
### angryTr1
```csharp
private Transform angryTr1 { get; }
```
...
### angryTr2
```csharp
private Transform angryTr2 { get; }
```
