---
uid: Global.SmallBirdWeapon
canonical_path: /api/Global/Weapon/SmallBirdWeapon
---
# Class SmallBirdWeapon
...
Script for [Punishing Bird](/api/Global/Abnormalities/Punishing-Bird/SmallBird)'s EGO Weapon: Beak. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SmallBirdWeapon

## Constructors
### SmallBirdWeapon()
```csharp
public SmallBirdWeapon()
```
