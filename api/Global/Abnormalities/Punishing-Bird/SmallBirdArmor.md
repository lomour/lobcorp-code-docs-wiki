---
uid: Global.SmallBirdArmor
canonical_path: /api/Global/Armor/SmallBirdArmor
---
# Class SmallBirdArmor
...
Script for [Punishing Bird](/api/Global/Abnormalities/Punishing-Bird/SmallBird)'s EGO Suit: Beak. No script, just a debug log.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SmallBirdArmor

## Constructors
### SmallBirdArmor()
```csharp
public SmallBirdArmor()
```
