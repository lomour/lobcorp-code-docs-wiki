...
Buff applied to [Punishing Bird](/api/Global/Abnormalities/Punishing-Bird/SmallBird) when attacked.

Lasts for one minute.
Multiplies max HP by 5 and restores all health, and gives itself [super armor](/api/Global/Buffs/SuperArmorBuf) (is super armor used...?).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → SmallBirdMadBuf
