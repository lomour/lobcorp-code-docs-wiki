---
uid: Global.Rudolph
canonical_path: /api/Global/Misc/Rudolph
---
# Class Rudolph
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → Rudolph
...
### wayPointer
```csharp
private Rudolph.WayPointManager wayPointer
```

#### Field Value
**Type:** Global.Rudolph.WayPointManager

## Properties
### animScript
```csharp
public RudolphAnim animScript { get; }
```
...
| --- | --- | --- |
| `near` | `System.Collections.Generic.List{WorkerModel}` |  |
