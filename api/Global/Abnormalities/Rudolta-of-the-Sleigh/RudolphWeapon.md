---
uid: Global.RudolphWeapon
canonical_path: /api/Global/Weapon/RudolphWeapon
---
# Class RudolphWeapon
...
Script for [Rudolta of the Sleigh](/api/Global/Abnormalities/Rudolta-of-the-Sleigh/Rudolph)'s EGO Weapon: Christmas. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → RudolphWeapon

## Constructors
### RudolphWeapon()
```csharp
public RudolphWeapon()
```
