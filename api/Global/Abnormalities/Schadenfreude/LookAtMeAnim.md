---
uid: Global.LookAtMeAnim
canonical_path: /api/Global/Creature/LookAtMeAnim
---
# Class LookAtMeAnim
...
Animation handler for [Schadenfreude](/api/Global/Abnormalities/Schadenfreude/LookAtMe).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → LookAtMeAnim
