---
uid: Global.LookAtMeWeapon
canonical_path: /api/Global/Weapon/LookAtMeWeapon
---
# Class LookAtMeWeapon
...
Script for [Schadenfreude](/api/Global/Abnormalities/Schadenfreude/LookAtMe)'s EGO Weapon: Gaze.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → LookAtMeWeapon

## Constructors
### LookAtMeWeapon()
```csharp
public LookAtMeWeapon()
```
