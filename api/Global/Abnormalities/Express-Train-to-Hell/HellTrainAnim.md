---
uid: Global.HellTrainAnim
canonical_path: /api/Global/Creature/HellTrainAnim
---
# Class HellTrainAnim
...
Animation handler for [Express Train to Hell](/api/Global/Abnormalities/Express-Train-to-Hell/HellTrain).



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → HellTrainAnim

## Constructors
### HellTrainAnim()
```csharp
public HellTrainAnim()
```
...
#### Field Value
**Type:** Global.HellTrainAnimEventHandler
