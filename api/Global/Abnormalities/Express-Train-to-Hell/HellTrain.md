---
uid: Global.HellTrain
canonical_path: /api/Global/Misc/HellTrain
---
# Class HellTrain
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → HellTrain
...
#### Field Value
**Type:** Global.HellTrainAnim

### _otherCreatureWorkCount
```csharp
...
### reduceTime
```csharp
private static float reduceTime { get; }
```
