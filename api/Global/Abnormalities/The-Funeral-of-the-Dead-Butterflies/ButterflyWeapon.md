---
uid: Global.ButterflyWeapon
canonical_path: /api/Global/Weapon/ButterflyWeapon
---
# Class ButterflyWeapon
...
Script for [The Funeral of the Dead Butterflies](/api/Global/Abnormalities/The-Funeral-of-the-Dead-Butterflies/Butterfly)'s EGO Weapon: Solemn Lament. Switches between white and black damage between shots.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ButterflyWeapon

## Constructors
### ButterflyWeapon()
```csharp
public ButterflyWeapon()
```
