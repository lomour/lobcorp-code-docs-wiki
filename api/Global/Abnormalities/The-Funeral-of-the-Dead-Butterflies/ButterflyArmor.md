---
uid: Global.ButterflyArmor
canonical_path: /api/Global/Armor/ButterflyArmor
---
# Class ButterflyArmor
...
Script for [The Funeral of the Dead Butterflies](/api/Global/Abnormalities/The-Funeral-of-the-Dead-Butterflies/Butterfly)'s EGO Suit: Solemn Lament. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ButterflyArmor

## Constructors
### ButterflyArmor()
```csharp
public ButterflyArmor()
```
