...
Uncontrollable action for employees affected by [Army in Black](/api/Global/Abnormalities/Army-in-Black/PinkCorps)'s special work type.

Sets the face to display pink eyes while active and removes control of the agent.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [HierarchicalData](/api/Global/Agents-and-Clerks/Uncontrollable-Actions/UncontrollableAction) → PinkCorpsUncontrollable
