...
Buff which makes a level 3 or lower employee uncontrollable during [Army in Black's breach](/api/Global/Abnormalities/Army-in-Black/BlackCorps).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → BlackLoveBuf
