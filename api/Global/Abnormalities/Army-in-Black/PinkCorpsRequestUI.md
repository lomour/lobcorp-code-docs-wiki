---
uid: Global.PinkCorpsRequestUI
canonical_path: /api/Global/UI/PinkCorpsRequestUI
---
# Class PinkCorpsRequestUI
...
UI for [Army in Black](/api/Global/Abnormalities/Army-in-Black/PinkCorps)'s special work type.
...
### PinkCorpsRequestUI()
```csharp
public PinkCorpsRequestUI()
```

## Fields
### _currentOverlayAgent
```csharp
...
### CurrentOverlayAgent
```csharp
public AgentModel CurrentOverlayAgent { get; set; }
```
