---
uid: Global.PinkCorpsWeapon
canonical_path: /api/Global/Weapon/PinkCorpsWeapon
---
# Class PinkCorpsWeapon
...
Script for [Army in Black](/api/Global/Abnormalities/Army-in-Black/PinkCorps)'s EGO Weapon: Pink.

If the agent has both the corresponding [gift](/api/Global/Abnormalities/Army-in-Black/PinkCorpsGift) and suit, increase the minimum and maximum damage of this weapon by 15%.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → PinkCorpsWeapon
