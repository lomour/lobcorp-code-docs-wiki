---
uid: Global.PinkCorpsAnim
canonical_path: /api/Global/Creature/PinkCorpsAnim
---
# Class PinkCorpsAnim
...
Animation handler for [Army in Black](/api/Global/Abnormalities/Army-in-Black/PinkCorps).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → PinkCorpsAnim
...
#### Field Value
**Type:** Global.PinkCorpsRequestUI

## Properties
### CurrentAttackAnimType
```csharp
public int CurrentAttackAnimType { get; private set; }
```
