---
uid: Global.PinkCorpsGift
canonical_path: /api/Global/Gift/PinkCorpsGift
---
# Class PinkCorpsGift
...
Script for [Army in Black](/api/Global/Abnormalities/Army-in-Black/PinkCorps)'s EGO Gift: Pink. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → PinkCorpsGift

## Constructors
### PinkCorpsGift()
```csharp
public PinkCorpsGift()
```
