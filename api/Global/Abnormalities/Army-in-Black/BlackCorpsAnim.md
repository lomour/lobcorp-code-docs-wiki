---
uid: Global.BlackCorpsAnim
canonical_path: /api/Global/Creature/BlackCorpsAnim
---
# Class BlackCorpsAnim
...
Animation handler for [Army in Black's breaching form](/api/Global/Abnormalities/Army-in-Black/BlackCorps).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → BlackCorpsAnim
