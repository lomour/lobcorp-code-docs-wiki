...
Script for [The Little Prince](/api/Global/Abnormalities/The-Little-Prince/YoungPrince)'s EGO Weapon: Spore.

After damage, at a 25% chance, applies [a debuff](/api/Global/Abnormalities/The-Little-Prince/YoungPrinceWeaponDebuf) which increase white damage taken by 50% for 3 seconds.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → YoungPrinceWeapon
