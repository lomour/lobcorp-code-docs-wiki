---
uid: Global.YoungPrinceFriendAnim
canonical_path: /api/Global/Creature/YoungPrinceFriendAnim
---
# Class YoungPrinceFriendAnim
...
Animation handler for [The Little Prince's minion](/api/Global/Abnormalities/The-Little-Prince/YoungPrinceFriend).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → YoungPrinceFriendAnim

## Implements
[IAnimatorEventCalled](/api/Global/Animation/IAnimatorEventCalled)

## Constructors
### YoungPrinceFriendAnim()
```csharp
public YoungPrinceFriendAnim()
```
...
| Name | Type | Description |
| --- | --- | --- |
| `script` | `Global.YoungPrinceFriend` |  |

### SmashDamageTimeCalled()
```csharp
