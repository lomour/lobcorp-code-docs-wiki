---
uid: Global.ScarecrowAnim
canonical_path: /api/Global/Creature/ScarecrowAnim
---
# Class ScarecrowAnim
...
Animation handler for [Scarecrow Searching for Wisdom](/api/Global/Abnormalities/Scarecrow-Searching-for-Wisdom/Scarecrow).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → ScarecrowAnim
