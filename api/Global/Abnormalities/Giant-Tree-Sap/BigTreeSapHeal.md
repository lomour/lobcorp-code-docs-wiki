...
Buff which heals agents when drinking from [Giant Tree Sap](/api/Global/Abnormalities/Giant-Tree-Sap/BigTreeSap).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → BigTreeSapHeal
