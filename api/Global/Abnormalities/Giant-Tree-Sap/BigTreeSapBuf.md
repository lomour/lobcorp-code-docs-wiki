...
Buff which makes agents explode after drinking from [Giant Tree Sap](/api/Global/Abnormalities/Giant-Tree-Sap/BigTreeSap), sometimes.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → BigTreeSapBuf
