...
'Debuff' for [Cobalt Scar (weapon)](/api/Global/Abnormalities/Big-and-Will-be-Bad-Wolf/BigBadWolfWeapon) which causes it to do more damage and friendly fire at low health. 


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → BigBadWolfWeaponDebuf

## Constructors
### BigBadWolfWeaponDebuf()
```csharp
