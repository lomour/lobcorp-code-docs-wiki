---
uid: Global.ArmorCreatureGiftBlue_1
canonical_path: /api/Global/Misc/ArmorCreatureGiftBlue1
---
# Class ArmorCreatureGiftBlue_1
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class ArmorCreatureGiftBlue_1 : EquipmentScriptBase
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ArmorCreatureGiftBlue_1

## Constructors
### ArmorCreatureGiftBlue_1()
```csharp
public ArmorCreatureGiftBlue_1()
```
