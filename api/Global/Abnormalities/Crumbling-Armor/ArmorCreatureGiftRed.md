---
uid: Global.ArmorCreatureGiftRed
canonical_path: /api/Global/Misc/ArmorCreatureGiftRed
---
# Class ArmorCreatureGiftRed
...
EGO Gift Reckless Foolishness (red); obtained by working repression with [Crumbling Armor](/api/Global/Abnormalities/Crumbling-Armor/ArmorCreatureGiftOrange).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ArmorCreatureGiftRed

## Constructors
### ArmorCreatureGiftRed()
```csharp
public ArmorCreatureGiftRed()
```
