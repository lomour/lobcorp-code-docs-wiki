---
uid: Global.ArmorCreatureGiftOrange
canonical_path: /api/Global/Misc/ArmorCreatureGiftOrange
---
# Class ArmorCreatureGiftOrange
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class ArmorCreatureGiftOrange : EquipmentScriptBase
```
> This section may have incomplete or incorrect information.
{.is-warning}


Script for EGO [Crumbling Armor](/api/Global/Abnormalities/Crumbling-Armor/ArmorCreature)'s Gift: Reckless Foolishness (orange).

Obtained by working repression with [Crumbling Armor](/api/Global/Abnormalities/Crumbling-Armor/ArmorCreature) while having Reckless Foolishness (blue).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ArmorCreatureGiftOrange

## Constructors
### ArmorCreatureGiftOrange()
```csharp
public ArmorCreatureGiftOrange()
```
