---
uid: Global.ArmorCreatureWeapon
canonical_path: /api/Global/Weapon/ArmorCreatureWeapon
---
# Class ArmorCreatureWeapon
...
[Crumbling Armor](/api/Global/Abnormalities/Crumbling-Armor/ArmorCreature)'s EGO Weapon: Life for a Daredevil script. Randomly decides to do an alternate pattern half the time.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ArmorCreatureWeapon

## Constructors
### ArmorCreatureWeapon()
```csharp
public ArmorCreatureWeapon()
```
