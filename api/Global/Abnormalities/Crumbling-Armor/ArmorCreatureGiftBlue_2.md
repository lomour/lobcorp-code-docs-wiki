---
uid: Global.ArmorCreatureGiftBlue_2
canonical_path: /api/Global/Misc/ArmorCreatureGiftBlue2
---
# Class ArmorCreatureGiftBlue_2
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class ArmorCreatureGiftBlue_2 : EquipmentScriptBase
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ArmorCreatureGiftBlue_2

## Constructors
### ArmorCreatureGiftBlue_2()
```csharp
public ArmorCreatureGiftBlue_2()
```
