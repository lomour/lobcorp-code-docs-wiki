---
uid: Global.ArmorCreature
canonical_path: /api/Global/IOBserver/ArmorCreature
---
# Class ArmorCreature
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → ArmorCreature
...
### _specialAgentList
```csharp
private List<ArmorCreature.StackAgent> _specialAgentList
```

#### Field Value
**Type:** System.Collections.Generic.List{ArmorCreature.StackAgent}

## Methods
### ChangeGift(StackAgent)
```csharp
...
| --- | --- | --- |
| `specialAgent` | `Global.ArmorCreature.StackAgent` |  |
