---
uid: Global.RedHoodRequestUI
canonical_path: /api/Global/UI/RedHoodRequestUI
---
# Class RedHoodRequestUI
...
UI for using [Little Red](/api/Global/Abnormalities/Little-Red-Riding-Hooded-Mercenary/RedHood)'s special work type.
...
### _redHood
```csharp
private RedHood _redHood { get; }
```

#### Property Value
**Type:** Global.RedHood

### CurrentOverlayCreature
```csharp
public UnitModel CurrentOverlayCreature { get; set; }
```
...
| Name | Type | Description |
| --- | --- | --- |
| `redHoodAnim` | `Global.RedHoodAnim` |  |
