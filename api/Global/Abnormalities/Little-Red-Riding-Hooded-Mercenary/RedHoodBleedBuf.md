...
Bleeding debuff from [Little Red](/api/Global/Abnormalities/Little-Red-Riding-Hooded-Mercenary/RedHood)'s attacks.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → RedHoodBleedBuf
