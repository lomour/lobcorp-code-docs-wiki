---
uid: Global.RedHoodArmor
canonical_path: /api/Global/Armor/RedHoodArmor
---
# Class RedHoodArmor
...
Script for [Little Red](/api/Global/Abnormalities/Little-Red-Riding-Hooded-Mercenary/RedHood)'s EGO Suit: Crimson Scar.

When the weapon is held out, increases the user's speed by 30% until their weapon is put away.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → RedHoodArmor
