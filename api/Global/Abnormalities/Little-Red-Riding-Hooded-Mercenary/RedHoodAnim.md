...
Animation handler for [Little Red Riding Hooded Mercenary](/api/Global/Abnormalities/Little-Red-Riding-Hooded-Mercenary/RedHood).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → RedHoodAnim
