---
uid: Global.RedHoodThrowedAxe
canonical_path: /api/Global/Misc/RedHoodThrowedAxe
---
# Class RedHoodThrowedAxe
...
Animator script for [Little Red](/api/Global/Abnormalities/Little-Red-Riding-Hooded-Mercenary/RedHood)'s thrown axe. 
...
### IsDamageEnabled
```csharp
public bool IsDamageEnabled { get; set; }
```
