---
uid: Global.Fairy
canonical_path: /api/Global/Misc/Fairy
---
# Class Fairy
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → Fairy
...
### animScript
```csharp
public FairyAnim animScript { get; }
```
