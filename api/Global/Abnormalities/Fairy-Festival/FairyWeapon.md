---
uid: Global.FairyWeapon
canonical_path: /api/Global/Weapon/FairyWeapon
---
# Class FairyWeapon
...
Script for [Fairy Festival](/api/Global/Abnormalities/Fairy-Festival/Fairy)'s EGO Weapon: Wingbeat. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → FairyWeapon
