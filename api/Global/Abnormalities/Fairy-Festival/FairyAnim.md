---
uid: Global.FairyAnim
canonical_path: /api/Global/Creature/FairyAnim
---
# Class FairyAnim
...
Animation handler for [Fairy Festival](/api/Global/Abnormalities/Fairy-Festival/Fairy).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → FairyAnim
