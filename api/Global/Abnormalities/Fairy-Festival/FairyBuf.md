...
Effect given by [Fairy Festival](/api/Global/Abnormalities/Fairy-Festival/Fairy) which heals over time, and kills instantly if assigned to work another abnormality.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → FairyBuf
