...
[CENSORED](/api/Global/Abnormalities/CENSORED/Censored) spawn.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CENSORED/CensoredCreatureBase) → CensoredChild
