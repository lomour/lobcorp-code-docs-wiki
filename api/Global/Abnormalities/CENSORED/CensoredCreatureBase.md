...
Parent class for [CENSORED](/api/Global/Abnormalities/CENSORED/Censored) and its spawn.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → CensoredCreatureBase

## Derived
[Censored](/api/Global/Abnormalities/CENSORED/CensoredChild)
