---
uid: Global.CensoredChildAnim
canonical_path: /api/Global/Creature/CensoredChildAnim
---
# Class CensoredChildAnim
...
Animation handler for [CENSORED's spawn](/api/Global/Abnormalities/CENSORED/CensoredChild).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → CensoredChildAnim
