---
uid: Global.FengYunAnim
canonical_path: /api/Global/Creature/FengYunAnim
---
# Class FengYunAnim
...
Animation handler for [Clouded Monk](/api/Global/Abnormalities/Clouded-Monk/FengYun).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → FengYunAnim
...
### _curState
```csharp
private FengYunAnim.CURSTATE _curState
```
...
### GetCurState()
```csharp
public FengYunAnim.CURSTATE GetCurState()
```
...
```csharp
public bool SetCurState(FengYunAnim.CURSTATE c, bool forcibility = false)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `c` | `Global.FengYunAnim.CURSTATE` |  |
| `forcibility` | `System.Boolean` |  |
