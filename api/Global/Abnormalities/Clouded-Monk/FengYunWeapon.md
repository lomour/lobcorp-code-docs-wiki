---
uid: Global.FengYunWeapon
canonical_path: /api/Global/Weapon/FengYunWeapon
---
# Class FengYunWeapon
...
Script for [Clouded Monk](/api/Global/Abnormalities/Clouded-Monk/FengYun)'s EGO Weapon: Amrita.

Does damage thrice.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → FengYunWeapon

## Constructors
### FengYunWeapon()
```csharp
public FengYunWeapon()
```
