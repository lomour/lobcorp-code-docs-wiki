...
Animation handler for [Clouded Monk](/api/Global/Abnormalities/Clouded-Monk/FengYun)'s escaping form.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimatorEventHandler](/api/Global/Animation/AnimatorEventHandler) → FengYunGhoulAnimEventHandler
