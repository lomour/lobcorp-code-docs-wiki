---
uid: Global.SakuraAnim
canonical_path: /api/Global/Creature/SakuraAnim
---
# Class SakuraAnim
...
Animation handler for [Grave of the Cherry Blossoms](/api/Global/Abnormalities/Grave-of-the-Cherry-Blossoms/Sakura).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → SakuraAnim
