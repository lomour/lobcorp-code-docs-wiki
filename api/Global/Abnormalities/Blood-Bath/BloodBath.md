---
uid: Global.BloodBath
canonical_path: /api/Global/Misc/BloodBath
---
# Class BloodBath
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → BloodBath
...
#### Field Value
**Type:** Global.BloodBathAnim

### currentHandState
```csharp
private BloodBath.BloodHandState currentHandState
```
...
| Name | Type | Description |
| --- | --- | --- |
| `handState` | `Global.BloodBath.BloodHandState` |  |
