---
uid: Global.BloodBathWeapon
canonical_path: /api/Global/Weapon/BloodBathWeapon
---
# Class BloodBathWeapon
...
Script for [Blood Bath](/api/Global/Abnormalities/Blood-Bath/BloodBath)'s EGO Weapon: Wrist Cutter. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BloodBathWeapon

## Constructors
### BloodBathWeapon()
```csharp
public BloodBathWeapon()
```
