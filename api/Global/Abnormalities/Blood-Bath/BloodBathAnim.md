---
uid: Global.BloodBathAnim
canonical_path: /api/Global/Creature/BloodBathAnim
---
# Class BloodBathAnim
...
Animation handler for [Blood Bath](/api/Global/Abnormalities/Blood-Bath/BloodBath).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → BloodBathAnim
...
| Name | Type | Description |
| --- | --- | --- |
| `state` | `Global.BloodBath.BloodHandState` |  |
