---
uid: Global.SnowQueenAnim
canonical_path: /api/Global/Creature/SnowQueenAnim
---
# Class SnowQueenAnim
...
Animation handler for [The Snow Queen](/api/Global/Abnormalities/The-Snow-Queen/SnowQueen).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → SnowQueenAnim
