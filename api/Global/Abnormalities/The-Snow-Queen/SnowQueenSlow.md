...
Slowing buff applied by [Frost Splinter (weapon)](/api/Global/Abnormalities/The-Snow-Queen/SnowQueenWeapon).
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → SnowQueenSlow
