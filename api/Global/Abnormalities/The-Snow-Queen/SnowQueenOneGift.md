---
uid: Global.SnowQueenOneGift
canonical_path: /api/Global/Gift/SnowQueenOneGift
---
# Class SnowQueenOneGift
...
Script for [The Snow Queen](/api/Global/Abnormalities/The-Snow-Queen/SnowQueen)'s EGO Gift: Those who know the Cruelty of Winter and the Aroma of Roses. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SnowQueenOneGift

## Constructors
### SnowQueenOneGift()
```csharp
public SnowQueenOneGift()
```
