---
uid: Global.SnowQueenWeapon
canonical_path: /api/Global/Weapon/SnowQueenWeapon
---
# Class SnowQueenWeapon
...
Script for [The Snow Queen](/api/Global/Abnormalities/The-Snow-Queen/SnowQueen)'s EGO Weapon: Frost Splinter.

[Slows](/api/Global/Core-Suppressions/Binah-Suppression/BinahCoreScript) are targetable? And only if they have less health after taking damage. ^\[verify\]^




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SnowQueenWeapon
