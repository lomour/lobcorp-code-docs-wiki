...
Parent class for [Yin](/api/Global/Abnormalities/Yin-and-Yang/Yang/Yang).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → YinAndYangBase

## Derived
[Yang](/api/Global/Abnormalities/Yin-and-Yang/Yin/Yin)
