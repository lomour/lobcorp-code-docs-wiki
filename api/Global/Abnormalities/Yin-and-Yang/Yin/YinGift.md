...
Script for [Yin](/api/Global/Abnormalities/Yin-and-Yang/Yin/Yin)'s EGO Gift: Discord.

When hit, at an 8% chance, recover all damage taken.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → YinGift
