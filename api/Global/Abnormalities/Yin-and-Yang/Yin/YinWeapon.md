---
uid: Global.YinWeapon
canonical_path: /api/Global/Weapon/YinWeapon
---
# Class YinWeapon
...
Script for [Yin](/api/Global/Abnormalities/Yin-and-Yang/Yin/Yin)'s EGO Weapon: Discord.

Does a special skill at a 10% chance which does 5 attacks.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → YinWeapon
