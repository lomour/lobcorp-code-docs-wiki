---
uid: Global.YinLaserExplosionCollider
canonical_path: /api/Global/Collider/YinLaserExplosionCollider
---
# Class YinLaserExplosionCollider
...
Collider for [Yin](/api/Global/Abnormalities/Yin-and-Yang/Yin/Yin)'s laser explosion attack.
...
## Constructors
### YinLaserExplosionCollider()
```csharp
public YinLaserExplosionCollider()
```
...
### explosionDmg
```csharp
public DamageInfo explosionDmg { get; set; }
```
