---
uid: Global.FireBirdArmor
canonical_path: /api/Global/Armor/FireBirdArmor
---
# Class FireBirdArmor
...
Script for [The Firebird](/api/Global/Abnormalities/The-Firebird/FireBird)'s EGO Suit: Feather of Honor. No script.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → FireBirdArmor

## Constructors
### FireBirdArmor()
```csharp
public FireBirdArmor()
```
