...
[The Firebird](/api/Global/Abnormalities/The-Firebird/FireBird)'s heal buff (for when its Qliphoth Counter is 1, or an agent has <20% of max HP at the end of work).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → FireBirdHealBuf
