---
uid: Global.FireBirdWeapon
canonical_path: /api/Global/Weapon/FireBirdWeapon
---
# Class FireBirdWeapon
...
Script for [The Firebird](/api/Global/Abnormalities/The-Firebird/FireBird)'s EGO Weapon: Feather of Honor.

Rolls damage twice.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → FireBirdWeapon

## Constructors
### FireBirdWeapon()
```csharp
public FireBirdWeapon()
```
