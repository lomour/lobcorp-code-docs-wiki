...
Buff marking an employee as [Melting Love](/api/Global/Abnormalities/Melting-Love/SlimeGirl)'s favorite.

Infects other employees in the same room every 10 seconds at a 25% chance each, unless paused due to successful work with Melting Love. Infecting gives them the [SlimePawnBuf](/api/Global/Abnormalities/Melting-Love/Slime-Pawn/SlimePawnBuf).
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → SlimeLoverBuf
