---
uid: Global.SlimeLover
canonical_path: /api/Global/Misc/SlimeLover
---
# Class SlimeLover
...
[Melting Love](/api/Global/Abnormalities/Melting-Love/SlimeGirl)'s big minion.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Melting-Love/SlimeCreature) → SlimeLover
...
### animScript
```csharp
public SlimeLoverAnim animScript { get; }
```
...
### AttackTarget
```csharp
public UnitModel AttackTarget { get; private set; }
```
