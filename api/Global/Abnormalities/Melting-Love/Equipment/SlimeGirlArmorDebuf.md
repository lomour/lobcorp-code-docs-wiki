---
uid: Global.SlimeGirlArmorDebuf
canonical_path: /api/Global/UnitBuf/SlimeGirlArmorDebuf
---
# Class SlimeGirlArmorDebuf
...
Debuff for [Melting Love's EGO Suit](/api/Global/Abnormalities/Melting-Love/Equipment/SlimeGirlArmor) which slows the user to 30% speed for 3 seconds when the suit's shield activates.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → SlimeGirlArmorDebuf
