...
Buff given to [Melting Love](/api/Global/Abnormalities/Melting-Love/Lover/SlimeLoverBuf)).
...
After some time randomly between 100 and 120 seconds, applies the [SlimeTransformBuf](/api/Global/Abnormalities/Melting-Love/SlimeTransformBuf) to this worker.

If another worker is within 1 unit, randomly infects them at a 25% chance with this buff and plays an effect.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → SlimePawnBuf
