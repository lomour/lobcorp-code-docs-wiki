...
Parent class for [Melting Love](/api/Global/Abnormalities/Melting-Love/SlimeGirl) and her spawn.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → SlimeCreature

## Derived
[SlimeGirl](/api/Global/Abnormalities/Melting-Love/Slime-Pawn/SlimePawn)
