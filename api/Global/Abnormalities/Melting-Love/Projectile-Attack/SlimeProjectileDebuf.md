...
DOT debuff applied by [Melting Love's projectile](/api/Global/Abnormalities/Melting-Love/Projectile-Attack/SlimeGirlProjectile).

Does 2-3 black damage every 2 seconds for 10 seconds.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → SlimeProjectileDebuf
