...
Stores the event to call when called by [SkillTriggerCheck](/api/Global/Abnormalities/Skill-Trigger/SkillTriggerCheck).
...
## Derived
[UseSkillTrigger](/api/Global/Abnormalities/Skill-Trigger/UseSkillTrigger)
