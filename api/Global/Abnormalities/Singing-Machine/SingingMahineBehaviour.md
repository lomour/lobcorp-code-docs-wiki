---
uid: Global.SingingMahineBehaviour
canonical_path: /api/Global/StateMachineBehaviour/SingingMahineBehaviour
---
# Class SingingMahineBehaviour
...
Part of [Singing Machine](/api/Global/Abnormalities/Singing-Machine/SingingMachine)'s animator.

When this state is entered, sets "Kill" to false. 
...
## Constructors
### SingingMahineBehaviour()
```csharp
public SingingMahineBehaviour()
```
