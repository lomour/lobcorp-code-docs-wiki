...
Gives an attack speed bonus of 10 for 5 seconds. Given by [SingingMachineGift](/api/Global/Abnormalities/Singing-Machine/SingingMachineGift).



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitStatBuf) → SingingMachineGiftBuf
...
```
Constructs this buff, setting its [UnitBufType](/api/Global/Buffs/UnitBufType) to SINGING_MACHINE_GIFT_BUF and specifying that only one of this buff can exist at a time on the user.
