...
Behaviour for an uncontrollable employee attracted by [Singing Machine](/api/Global/Abnormalities/Singing-Machine/SingingMachine). Used by  ^\[verify\]^.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitCommand](/api/Global/Units/Unit-Commands/Worker-Commands/WorkerCommand) → SingingMachineAttackCommand
