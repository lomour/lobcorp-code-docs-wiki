...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Animation/AnimScript) → CreatureAnimScript

## Derived
[AlriuneAnim](/api/Global/Abnormalities/The-Little-Prince/YoungPrinceAnim), [DeathAngelAnim](/api/Legacy/DeathAngelAnim), [DeathAngelApostleAnim](/api/Legacy/DeathAngelApostleAnim), [PlagueDoctorAnim](/api/Legacy/PlagueDoctorAnim)
