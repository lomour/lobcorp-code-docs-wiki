---
uid: Global.WraithAnim
canonical_path: /api/Global/Creature/WraithAnim
---
# Class WraithAnim
...
Animation handler for [Dimensional Refraction Variant](/api/Global/Abnormalities/Dimensional-Refraction-Variant/Wraith).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → WraithAnim
