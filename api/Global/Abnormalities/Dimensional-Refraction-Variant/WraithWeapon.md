---
uid: Global.WraithWeapon
canonical_path: /api/Global/Weapon/WraithWeapon
---
# Class WraithWeapon
...
Script for [Dimensional Refraction Variant](/api/Global/Abnormalities/Dimensional-Refraction-Variant/Wraith)'s EGO Weapon: Diffraction.

Randomly chooses to use one of two sounds.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → WraithWeapon
