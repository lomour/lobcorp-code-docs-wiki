...
Eggs for [Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird)'s fight.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Apocalypse-Bird/BirdCreatureBase) → BossEggBase
...
```
[Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird).
...
When at 70%, 40%, and 10% HP for the first time, tells [Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird) to teleport to this egg.
