---
uid: Global.BossGateWay
canonical_path: /api/Global/Misc/BossGateWay
---
# Class BossGateWay
...
Entrance to the Black Forest, as seen in [Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird)'s fight.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Apocalypse-Bird/BirdCreatureBase) → BossGateWay
...
### __GatewayState
```csharp
private BossGateWay.GateWayState __GatewayState
```
...
#### Field Value
**Type:** Global.BossGateWayAnim

### bigBird
```csharp
private BigBird bigBird
```
[Big Bird](/api/Global/Abnormalities/Big-Bird/BigBird)'s instance.
...
```
[Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird)'s instance.
...
### animScript
```csharp
public BossGateWayAnim animScript { get; }
```
...
### gateWayState
```csharp
public BossGateWay.GateWayState gateWayState { get; }
```
...
### SetBirds(BigBird, SmallBird, LongBird, BossBird)
```csharp
