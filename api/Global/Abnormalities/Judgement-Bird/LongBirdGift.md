---
uid: Global.LongBirdGift
canonical_path: /api/Global/Gift/LongBirdGift
---
# Class LongBirdGift
...
Script for [Judgement Bird](/api/Global/Abnormalities/Judgement-Bird/LongBird)'s EGO Gift: Justitia.

Increases the success rate of repression work by 6.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → LongBirdGift
