---
uid: Global.LongBirdScaffoldScript
canonical_path: /api/Global/IANimatorEventCalled/LongBirdScaffoldScript
---
# Class LongBirdScaffoldScript
...
Script for the hanging death animation when [Judgement Bird](/api/Global/Abnormalities/Judgement-Bird/LongBird) kills a worker.
...
## Constructors
### LongBirdScaffoldScript()
```csharp
public LongBirdScaffoldScript()
```
