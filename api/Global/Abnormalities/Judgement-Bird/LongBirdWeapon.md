---
uid: Global.LongBirdWeapon
canonical_path: /api/Global/Weapon/LongBirdWeapon
---
# Class LongBirdWeapon
...
Script for [Judgement Bird](/api/Global/Abnormalities/Judgement-Bird/LongBird)'s EGO Weapon: Justitia.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → LongBirdWeapon

## Constructors
### LongBirdWeapon()
```csharp
public LongBirdWeapon()
```
