...
Parent class for [Amber ordeal](/api/Global/Abnormalities/Ordeals/Amber-Ordeals/BugOrdeal) creatures.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → BugOrdealCreature

## Derived
[BugDawn](/api/Global/Abnormalities/Ordeals/Amber-Ordeals/Amber-Midnight/BugMidnight)
