---
uid: Global.BugDawnAnim
canonical_path: /api/Global/Creature/BugDawnAnim
---
# Class BugDawnAnim
...
Animation handler for [The Perfect Food](/api/Global/Abnormalities/Ordeals/Amber-Ordeals/Amber-Dawn/BugDawn).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → BugDawnAnim
...
| Name | Type | Description |
| --- | --- | --- |
| `animState` | `Global.BugDawn.AnimationState` |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `script` | `Global.BugDawn` |  |

### SoundMake(string, float)
```csharp
public void SoundMake(string src, float volume = 1)
```
