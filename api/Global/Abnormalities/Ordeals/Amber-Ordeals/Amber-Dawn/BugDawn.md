---
uid: Global.BugDawn
canonical_path: /api/Global/Misc/BugDawn
---
# Class BugDawn
...
See [BugDawnOrdeal](/api/Global/Abnormalities/Ordeals/Amber-Ordeals/Amber-Dawn/BugDawnOrdeal).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Ordeals/Amber-Ordeals/BugOrdealCreature) → BugDawn
...
### animScript
```csharp
public BugDawnAnim animScript { get; }
```
