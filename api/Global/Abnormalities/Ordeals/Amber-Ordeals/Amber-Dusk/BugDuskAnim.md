...
Animation handler for [The Food Chain](/api/Global/Abnormalities/Ordeals/Amber-Ordeals/Amber-Dusk/BugDusk).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → BugDuskAnim
