...
Parent class for the shrines in [Violet Midnight](/api/Global/Abnormalities/Ordeals/Violet-Ordeals/Violet-Midnight/OutterGodMidnightOrdeal).
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Ordeals/Violet-Ordeals/OutterGodOrdealCreature) → OutterGodMidnight
