---
uid: Global.OutterGodDawnAnim
canonical_path: /api/Global/Creature/OutterGodDawnAnim
---
# Class OutterGodDawnAnim
...
Animation handler for [The Fruit of Understanding](/api/Global/Abnormalities/Ordeals/Violet-Ordeals/Violet-Dawn/OutterGodDawn).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → OutterGodDawnAnim
