...
Creature for [Violet Dawn](/api/Global/Abnormalities/Ordeals/Violet-Ordeals/Violet-Dawn/OutterGodDawnOrdeal).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Ordeals/Violet-Ordeals/OutterGodOrdealCreature) → OutterGodDawn
