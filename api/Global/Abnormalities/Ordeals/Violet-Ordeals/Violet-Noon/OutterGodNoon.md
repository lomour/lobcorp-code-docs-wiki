---
uid: Global.OutterGodNoon
canonical_path: /api/Global/OutterGodMidnight/OutterGodNoon
---
# Class OutterGodNoon
...
Creature for [Violet Noon](/api/Global/Abnormalities/Ordeals/Violet-Ordeals/Violet-Noon/OutterGodNoonOrdeal).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Ordeals/Violet-Ordeals/OutterGodOrdealCreature) → OutterGodNoon

## Constructors
### OutterGodNoon()
```csharp
public OutterGodNoon()
```
...
## Methods
### DecreaseCreaturesQliphothCounter()
```csharp
...
| `range` | `System.Single` |  |
| `dmgAmount` | `System.Int32` |  |
| `isDownAtk` | `System.Boolean` |  |
