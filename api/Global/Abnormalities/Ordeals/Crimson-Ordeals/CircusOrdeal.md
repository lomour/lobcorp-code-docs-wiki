...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [OrdealBase](/api/Global/Abnormalities/Ordeals/OrdealBase) → CircusOrdeal

## Derived
[CircusDawnOrdeal](/api/Global/Abnormalities/Ordeals/Crimson-Ordeals/Crimson-Noon/CircusNoonOrdeal)
