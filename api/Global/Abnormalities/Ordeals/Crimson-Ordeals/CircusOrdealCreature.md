...
Parent class for [Crimson ordeal](/api/Global/Abnormalities/Ordeals/Crimson-Ordeals/CircusOrdeal) creatures.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → CircusOrdealCreature

## Derived
[CircusDawn](/api/Global/Abnormalities/Ordeals/Crimson-Ordeals/Crimson-Noon/CircusNoon)
