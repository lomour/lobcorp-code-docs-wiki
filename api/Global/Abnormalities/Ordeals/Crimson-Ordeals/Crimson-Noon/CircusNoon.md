---
uid: Global.CircusNoon
canonical_path: /api/Global/Misc/CircusNoon
---
# Class CircusNoon
...
[Crimson Noon](/api/Global/Abnormalities/Ordeals/Crimson-Ordeals/Crimson-Noon/CircusNoonOrdeal) creature.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Ordeals/Crimson-Ordeals/CircusOrdealCreature) → CircusNoon
...
### animScript
```csharp
public CircusNoonAnim animScript { get; }
```
...
### appearDelay
```csharp
private static float appearDelay { get; }
```
...
### pierceDmg
```csharp
private static int pierceDmg { get; }
```
...
### IsInRange(UnitModel, float, UnitDirection)
```csharp
