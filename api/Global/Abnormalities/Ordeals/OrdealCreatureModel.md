---
uid: Global.OrdealCreatureModel
canonical_path: /api/Global/Creature/OrdealCreatureModel
---
# Class OrdealCreatureModel
...
Base class for [ordeal](/api/Global/Abnormalities/Ordeals/OrdealBase) spawns.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitModel](/api/Global/Abnormalities/CreatureModel) → OrdealCreatureModel

## Implements
[IObserver](/api/Global/Mouse-Usage/Mouse-Listeners/IMouseCommandTargetModel)

## Constructors
### OrdealCreatureModel(long)
```csharp
...
### OrdealBase
```csharp
public OrdealBase OrdealBase { get; private set; }
```
