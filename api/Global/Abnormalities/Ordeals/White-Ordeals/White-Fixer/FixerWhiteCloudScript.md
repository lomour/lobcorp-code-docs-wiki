---
uid: Global.FixerWhiteCloudScript
canonical_path: /api/Global/Script/FixerWhiteCloudScript
---
# Class FixerWhiteCloudScript
...
Script for [White Fixer](/api/Global/Abnormalities/Ordeals/White-Ordeals/White-Fixer/FixerWhite)'s cloud attack.
...
## Constructors
### FixerWhiteCloudScript()
```csharp
public FixerWhiteCloudScript()
```
...
### list
```csharp
private List<FixerWhiteCloudScript.DamageUnit> list
```

#### Field Value
**Type:** System.Collections.Generic.List{FixerWhiteCloudScript.DamageUnit}
