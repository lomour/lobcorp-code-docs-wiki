...
Buff which slows down employees in the [White Fixer](/api/Global/Abnormalities/Ordeals/White-Ordeals/White-Fixer/FixerWhite)'s cloud attack.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → FixerWhiteCloudDebuf
