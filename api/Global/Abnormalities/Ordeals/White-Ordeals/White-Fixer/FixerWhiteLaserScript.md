---
uid: Global.FixerWhiteLaserScript
canonical_path: /api/Global/Script/FixerWhiteLaserScript
---
# Class FixerWhiteLaserScript
...
Script for [White Fixer](/api/Global/Abnormalities/Ordeals/White-Ordeals/White-Fixer/FixerWhite)'s laser attack.
...
## Constructors
### FixerWhiteLaserScript()
```csharp
public FixerWhiteLaserScript()
```
...
### makers
```csharp
private List<FixerWhiteLaserScript.EffectMaker> makers
```

#### Field Value
**Type:** System.Collections.Generic.List{FixerWhiteLaserScript.EffectMaker}
