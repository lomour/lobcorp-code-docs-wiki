---
uid: Global.FixerClawUltimateScript
canonical_path: /api/Global/Script/FixerClawUltimateScript
---
# Class FixerClawUltimateScript
...
Collider for [The Claw](/api/Global/Abnormalities/Ordeals/White-Ordeals/The-Claw/FixerClaw)'s three-serum attack.
...
## Constructors
### FixerClawUltimateScript()
```csharp
public FixerClawUltimateScript()
```
...
### Init(FixerClaw, Vector3, Vector3)
```csharp
