---
uid: Global.FixerClawAnim
canonical_path: /api/Global/Creature/FixerClawAnim
---
# Class FixerClawAnim
...
Animation handler for [The Claw](/api/Global/Abnormalities/Ordeals/White-Ordeals/The-Claw/FixerClaw).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → FixerClawAnim
...
### MakeNoise(float)
```csharp
public SoundEffectPlayer MakeNoise(float vol = 1)
```
...
| Name | Type | Description |
| --- | --- | --- |
| `script` | `Global.FixerClaw` |  |

### SetStrongEffect(bool)
```csharp
