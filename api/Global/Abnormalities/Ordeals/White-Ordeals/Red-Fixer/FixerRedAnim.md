---
uid: Global.FixerRedAnim
canonical_path: /api/Global/Creature/FixerRedAnim
---
# Class FixerRedAnim
...
Animation handler for the [Red Fixer](/api/Global/Abnormalities/Ordeals/White-Ordeals/Red-Fixer/FixerRed).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → FixerRedAnim
