---
uid: Global.FixerPaleAnim
canonical_path: /api/Global/Creature/FixerPaleAnim
---
# Class FixerPaleAnim
...
Animation handler for the [Pale Fixer](/api/Global/Abnormalities/Ordeals/White-Ordeals/Pale-Fixer/FixerPale).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → FixerPaleAnim
