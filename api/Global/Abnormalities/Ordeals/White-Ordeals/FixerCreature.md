...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → FixerCreature

## Derived
[FixerBlack](/api/Global/Abnormalities/Ordeals/White-Ordeals/White-Fixer/FixerWhite)
