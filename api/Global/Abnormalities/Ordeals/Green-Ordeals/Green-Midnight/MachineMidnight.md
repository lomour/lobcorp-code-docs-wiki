---
uid: Global.MachineMidnight
canonical_path: /api/Global/Machine/MachineMidnight
---
# Class MachineMidnight
...
[Green Midnight](/api/Global/Abnormalities/Ordeals/Green-Ordeals/Green-Midnight/MachineMidnightOrdeal) creature.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Ordeals/Green-Ordeals/MachineOrdealCreature) → MachineMidnight
...
### AnimScript
```csharp
public MachineMidnightAnim AnimScript { get; }
```

#### Property Value
**Type:** Global.MachineMidnightAnim
