...
Parent class for creatures spawned by the [Ordeals of Green](/api/Global/Abnormalities/Ordeals/Green-Ordeals/MachineOrdeal).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → MachineOrdealCreature

## Derived
[MachineDawn](/api/Global/Abnormalities/Ordeals/Green-Ordeals/Green-Noon/MachineNoon)
