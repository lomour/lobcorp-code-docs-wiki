---
uid: Global.MachineDawnAnim
canonical_path: /api/Global/Creature/MachineDawnAnim
---
# Class MachineDawnAnim
...
Animation handler for [Doubt](/api/Global/Abnormalities/Ordeals/Green-Ordeals/Green-Dawn/MachineDawn).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → MachineDawnAnim
...
#### Field Value
**Type:** Global.MachineDawnAnimEventHandler
