---
uid: Global.MachineDawn
canonical_path: /api/Global/Machine/MachineDawn
---
# Class MachineDawn
...
[Green Dawn](/api/Global/Abnormalities/Ordeals/Green-Ordeals/Green-Dawn/MachineDawnOrdeal) creature.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/Ordeals/Green-Ordeals/MachineOrdealCreature) → MachineDawn
...
#### Field Value
**Type:** Global.MachineDawnAnim

### killMotionAfterDelay
```csharp
