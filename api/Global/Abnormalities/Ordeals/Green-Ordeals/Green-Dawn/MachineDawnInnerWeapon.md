...
The 'weapon' wielded by [Doubt](/api/Global/Abnormalities/Ordeals/Green-Ordeals/Green-Dawn/MachineDawn).
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → MachineDawnInnerWeapon
