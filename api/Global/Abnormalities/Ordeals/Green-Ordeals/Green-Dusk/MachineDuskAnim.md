---
uid: Global.MachineDuskAnim
canonical_path: /api/Global/Creature/MachineDuskAnim
---
# Class MachineDuskAnim
...
Animation handler for [Where We Must Reach](/api/Global/Abnormalities/Ordeals/Green-Ordeals/Green-Dusk/MachineDusk).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → MachineDuskAnim
