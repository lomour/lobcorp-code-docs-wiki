---
uid: Global.MachineNoonAnim
canonical_path: /api/Global/Creature/MachineNoonAnim
---
# Class MachineNoonAnim
...
Animation handler for [The Process of Understanding](/api/Global/Abnormalities/Ordeals/Green-Ordeals/Green-Noon/MachineNoon).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → MachineNoonAnim
...
```csharp
public SoundEffectPlayer MakeSound(string src, float volume = 1)
```
