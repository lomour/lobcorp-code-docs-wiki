---
uid: Global.NothingAnim
canonical_path: /api/Global/Creature/NothingAnim
---
# Class NothingAnim
...
Animation handler for [Nothing There](/api/Global/Abnormalities/Nothing-There/Nothing).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → NothingAnim
