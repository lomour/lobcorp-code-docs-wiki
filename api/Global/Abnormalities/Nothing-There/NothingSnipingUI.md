---
uid: Global.NothingSnipingUI
canonical_path: /api/Global/UI/NothingSnipingUI
---
# Class NothingSnipingUI
...
UI for [Nothing There](/api/Global/Abnormalities/Nothing-There/Nothing)'s sniping interface during its special breach.
...
| --- | --- | --- |
| `_list` | `System.Collections.Generic.List{UnitModel}` |  |
