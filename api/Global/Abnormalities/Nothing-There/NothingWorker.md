---
uid: Global.NothingWorker
canonical_path: /api/Global/Worker/NothingWorker
---
# Class NothingWorker
...
The fake 'worker' during [Nothing There](/api/Global/Abnormalities/Nothing-There/Nothing)'s special breach.
...
## Implements
[IOverlapOnclick](/api/Global/Unused/IOverlapOnclick)

## Constructors
### NothingWorker()
```csharp
public NothingWorker()
```
