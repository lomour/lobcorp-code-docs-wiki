---
uid: Global.RedShoesAnimBehaviour
canonical_path: /api/Global/StateMachineBehaviour/RedShoesAnimBehaviour
---
# Class RedShoesAnimBehaviour
...
Used for [Red Shoes](/api/Global/Abnormalities/Red-Shoes/RedShoes)' creature animator. 
...
## Constructors
### RedShoesAnimBehaviour()
```csharp
public RedShoesAnimBehaviour()
```
