...
Weapon given to the employee attracted by [Red Shoes](/api/Global/Abnormalities/Red-Shoes/RedShoes).
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → RedShoesAttractedWeapon
