---
uid: Global.StraitJacketAnim
canonical_path: /api/Global/Creature/StraitJacketAnim
---
# Class StraitJacketAnim
...
Animation handler for [Forsaken Murderer](/api/Global/Abnormalities/Forsaken-Murderer/StraitJacket).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → StraitJacketAnim
