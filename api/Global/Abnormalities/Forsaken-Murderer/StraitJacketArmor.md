---
uid: Global.StraitJacketArmor
canonical_path: /api/Global/Armor/StraitJacketArmor
---
# Class StraitJacketArmor
...
Script for [Forsaken Murderer](/api/Global/Abnormalities/Forsaken-Murderer/StraitJacket)'s EGO Suit: Regret. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → StraitJacketArmor

## Constructors
### StraitJacketArmor()
```csharp
public StraitJacketArmor()
```
