---
uid: Global.StraitJacketWeapon
canonical_path: /api/Global/Weapon/StraitJacketWeapon
---
# Class StraitJacketWeapon
...
Script for [Forsaken Murderer](/api/Global/Abnormalities/Forsaken-Murderer/StraitJacket)'s EGO Weapon: Regret. No script.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → StraitJacketWeapon

## Constructors
### StraitJacketWeapon()
```csharp
public StraitJacketWeapon()
```
