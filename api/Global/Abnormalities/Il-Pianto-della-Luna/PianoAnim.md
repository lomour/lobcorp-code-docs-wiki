---
uid: Global.PianoAnim
canonical_path: /api/Global/Creature/PianoAnim
---
# Class PianoAnim
...
Animation handler for [Il Pianto della Luna](/api/Global/Abnormalities/Il-Pianto-della-Luna/Piano).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → PianoAnim
