---
uid: Global.PianoCreatureAnim
canonical_path: /api/Global/Creature/PianoCreatureAnim
---
# Class PianoCreatureAnim
...
Animation handler for [Il Pianto della Luna's breaching form](/api/Global/Abnormalities/Il-Pianto-della-Luna/PianoCreature).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → PianoCreatureAnim
