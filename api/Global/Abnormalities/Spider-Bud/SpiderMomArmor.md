---
uid: Global.SpiderMomArmor
canonical_path: /api/Global/Armor/SpiderMomArmor
---
# Class SpiderMomArmor
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class SpiderMomArmor : EquipmentScriptBase
```
> This section may have incomplete or incorrect information.
{.is-warning}


Script for [Spider Bud](/api/Global/Abnormalities/Spider-Bud/SpiderMom)'s EGO Suit: Red Eyes.

(Prints debug text on equip.)

While suppressing (holding a weapon), if the user has at least 4 fortitude ^\[verify\]^, gives a +5 movement speed buff for 30000 seconds or until the weapon is put away.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SpiderMomArmor

## Constructors
### SpiderMomArmor()
```csharp
public SpiderMomArmor()
```
