---
uid: Global.SpiderMomGift
canonical_path: /api/Global/Gift/SpiderMomGift
---
# Class SpiderMomGift
...
Script for [Spider Bud](/api/Global/Abnormalities/Spider-Bud/SpiderMom)'s EGO Gift: Red Eyes. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → SpiderMomGift

## Constructors
### SpiderMomGift()
```csharp
public SpiderMomGift()
```
