---
uid: Global.SpiderMomAnim
canonical_path: /api/Global/Creature/SpiderMomAnim
---
# Class SpiderMomAnim
...
Animation handler for [Spider Bud](/api/Global/Abnormalities/Spider-Bud/SpiderMom).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → SpiderMomAnim
