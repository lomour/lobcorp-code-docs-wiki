---
uid: Global.AlriuneAnim
canonical_path: /api/Global/Creature/AlriuneAnim
---
# Class AlriuneAnim
...
Animation handler for [Alriune](/api/Global/Abnormalities/Alriune/Alriune).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → AlriuneAnim
