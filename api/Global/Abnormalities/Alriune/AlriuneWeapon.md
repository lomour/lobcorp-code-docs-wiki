---
uid: Global.AlriuneWeapon
canonical_path: /api/Global/Weapon/AlriuneWeapon
---
# Class AlriuneWeapon
...
Script for [Alriune](/api/Global/Abnormalities/Alriune/Alriune)'s EGO Weapon: Faint Aroma. No script.



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → AlriuneWeapon

## Constructors
### AlriuneWeapon()
```csharp
public AlriuneWeapon()
```
