---
uid: Global.LittleWitchAnim
canonical_path: /api/Global/Creature/LittleWitchAnim
---
# Class LittleWitchAnim
...
Animation handler for [Laetitia](/api/Global/Abnormalities/Laetitia/LittleWitch).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → LittleWitchAnim
...
### _state
```csharp
private LittleWitchAnim.AnimationState _state
```
...
### State
```csharp
public LittleWitchAnim.AnimationState State { get; set; }
```
