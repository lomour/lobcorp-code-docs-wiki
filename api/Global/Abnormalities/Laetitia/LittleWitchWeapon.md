---
uid: Global.LittleWitchWeapon
canonical_path: /api/Global/Weapon/LittleWitchWeapon
---
# Class LittleWitchWeapon
...
Script for [Laetitia](/api/Global/Abnormalities/Laetitia/LittleWitch)'s EGO Weapon: Laetitia.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → LittleWitchWeapon

## Constructors
### LittleWitchWeapon()
```csharp
public LittleWitchWeapon()
```
