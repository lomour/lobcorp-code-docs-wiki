---
uid: Global.LittleWitchMonsterAnim
canonical_path: /api/Global/Creature/LittleWitchMonsterAnim
---
# Class LittleWitchMonsterAnim
...
Animation handler for [Laetitia](/api/Global/Abnormalities/Laetitia/LittleWitchMonster).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → LittleWitchMonsterAnim
...
#### Field Value
**Type:** Global.LittleWitchMonster

## Properties
### _randAttackType
```csharp
private int _randAttackType { get; }
```
...
### Script
```csharp
public LittleWitchMonster Script { get; }
```
...
| Name | Type | Description |
| --- | --- | --- |
| `script` | `Global.LittleWitchMonster` |  |
