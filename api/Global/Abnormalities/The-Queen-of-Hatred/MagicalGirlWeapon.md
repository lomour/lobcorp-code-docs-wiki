...
Script for [Queen of Hatred](/api/Global/Abnormalities/The-Queen-of-Hatred/MagicalGirl)'s EGO Weapon: In the Name of Love and Hate.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → MagicalGirlWeapon
