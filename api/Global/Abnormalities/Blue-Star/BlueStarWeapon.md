---
uid: Global.BlueStarWeapon
canonical_path: /api/Global/Weapon/BlueStarWeapon
---
# Class BlueStarWeapon
...
Script for [Blue Star](/api/Global/Abnormalities/Blue-Star/BlueStar)'s EGO Weapon: Sound of a Star.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BlueStarWeapon
...
### worker
```csharp
private WorkerModel worker { get; }
```
