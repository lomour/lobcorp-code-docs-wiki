---
uid: Global.BlueStarAnim
canonical_path: /api/Global/Creature/BlueStarAnim
---
# Class BlueStarAnim
...
Animation handler for [Blue Star](/api/Global/Abnormalities/Blue-Star/BlueStar).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → BlueStarAnim
...
#### Field Value
**Type:** Global.BlueStarAttackEffect
