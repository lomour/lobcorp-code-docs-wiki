...
Buff marking employees who got killed by [Blue Star](/api/Global/Abnormalities/Blue-Star/BlueStar)?


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → BlueStarBuf
