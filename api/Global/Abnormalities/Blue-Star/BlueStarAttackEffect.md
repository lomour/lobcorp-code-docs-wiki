---
uid: Global.BlueStarAttackEffect
canonical_path: /api/Global/Effect/BlueStarAttackEffect
---
# Class BlueStarAttackEffect
...
Effect for [Blue Star](/api/Global/Abnormalities/Blue-Star/BlueStar)'s attack.
...
## Constructors
### BlueStarAttackEffect()
```csharp
public BlueStarAttackEffect()
```
...
```csharp
[HideInInspector]
public BlueStarAnim _blueStarAnim
```
...
#### Field Value
**Type:** Global.BlueStarAttackCollider

### currentState
```csharp
private BlueStarAttackEffect.State currentState
```
