---
uid: Global.PpodaeAnim
canonical_path: /api/Global/Creature/PpodaeAnim
---
# Class PpodaeAnim
...
Animation handler for [Ppodae](/api/Global/Abnormalities/Ppodae/Ppodae).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → PpodaeAnim
...
#### Field Value
**Type:** Global.PpodaeAnimEventHandler
