---
uid: Global.WellcheersArmor
canonical_path: /api/Global/Armor/WellcheersArmor
---
# Class WellcheersArmor
...
Script for [Opened Can of Wellcheers](/api/Global/Abnormalities/Opened-Can-of-Wellcheers/Wellcheers)' EGO Suit: Soda. No script, just a debug log.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → WellcheersArmor

## Constructors
### WellcheersArmor()
```csharp
public WellcheersArmor()
```
