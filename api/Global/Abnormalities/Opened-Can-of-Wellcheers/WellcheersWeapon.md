---
uid: Global.WellcheersWeapon
canonical_path: /api/Global/Weapon/WellcheersWeapon
---
# Class WellcheersWeapon
...
Script for [Opened Can of Wellcheers](/api/Global/Abnormalities/Opened-Can-of-Wellcheers/Wellcheers)' EGO Weapon: Soda. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → WellcheersWeapon

## Constructors
### WellcheersWeapon()
```csharp
public WellcheersWeapon()
```
