---
uid: Global.Freischutz
canonical_path: /api/Global/Misc/Freischutz
---
# Class Freischutz
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → Freischutz
...
#### Field Value
**Type:** Global.FreischutzAnim

### _CONDITION_JUSTICE_LEVEL
```csharp
