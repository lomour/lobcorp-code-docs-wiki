...
Script for [Der Freischütz](/api/Global/Abnormalities/Der-Freischutz/Freischutz)'s EGO Weapon: Magic Bullet.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → FreischutzWeapon
