---
uid: Global.FreischutzGift
canonical_path: /api/Global/Gift/FreischutzGift
---
# Class FreischutzGift
...
Script for [Der Freischütz](/api/Global/Abnormalities/Der-Freischutz/Freischutz)'s EGO Gift: Magic Bullet. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → FreischutzGift

## Constructors
### FreischutzGift()
```csharp
public FreischutzGift()
```
