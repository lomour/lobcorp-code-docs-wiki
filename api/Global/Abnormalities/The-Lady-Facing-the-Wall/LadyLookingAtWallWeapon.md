---
uid: Global.LadyLookingAtWallWeapon
canonical_path: /api/Global/Weapon/LadyLookingAtWallWeapon
---
# Class LadyLookingAtWallWeapon
...
Script for [The Lady Facing the Wall](/api/Global/Abnormalities/The-Lady-Facing-the-Wall/LadyLookingAtWall)'s EGO Weapon: Screaming Wedge.

On attack, randomly damages the user for 5 SP at a 50% chance if their fortitude and prudence are both less than 3.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → LadyLookingAtWallWeapon

## Constructors
### LadyLookingAtWallWeapon()
```csharp
public LadyLookingAtWallWeapon()
```

## Fields
### _AMOUNT_DECREASE_MENTAL
```csharp
