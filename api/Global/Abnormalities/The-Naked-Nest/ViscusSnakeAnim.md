---
uid: Global.ViscusSnakeAnim
canonical_path: /api/Global/Creature/ViscusSnakeAnim
---
# Class ViscusSnakeAnim
...
Animation handler for [The Naked Nest](/api/Global/Abnormalities/The-Naked-Nest/ViscusSnake).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimEventCalled) → ViscusSnakeAnim
