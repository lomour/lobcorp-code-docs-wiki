---
uid: Global.ViscusInfestedWeapon
canonical_path: /api/Global/Weapon/ViscusInfestedWeapon
---
# Class ViscusInfestedWeapon
...
Equipment for [The Naked Nest](/api/Global/Abnormalities/The-Naked-Nest/ViscusSnake)'s minions. ^\[verify\]^


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ViscusInfestedWeapon

## Constructors
### ViscusInfestedWeapon()
```csharp
public ViscusInfestedWeapon()
```
