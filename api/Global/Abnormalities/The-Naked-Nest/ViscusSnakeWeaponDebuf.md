...
Debuff applied by [Exuviae (weapon)](/api/Global/Abnormalities/The-Naked-Nest/ViscusSnakeWeapon).

Causes the target to take more 50% more red damage for three seconds.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → ViscusSnakeWeaponDebuf
