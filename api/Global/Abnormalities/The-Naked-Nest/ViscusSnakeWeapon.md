---
uid: Global.ViscusSnakeWeapon
canonical_path: /api/Global/Weapon/ViscusSnakeWeapon
---
# Class ViscusSnakeWeapon
...
Script for [The Naked Nest](/api/Global/Abnormalities/The-Naked-Nest/ViscusSnake)'s EGO Weapon: Exuviae.

Inflicts a [buff](/api/Global/Abnormalities/The-Naked-Nest/ViscusSnakeWeaponDebuf) at a 25% chance after damage which causes the target to take more 50% more red damage for three seconds.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ViscusSnakeWeapon

## Constructors
### ViscusSnakeWeapon()
```csharp
public ViscusSnakeWeapon()
```
