---
uid: Global.ViscusSnakeArmor
canonical_path: /api/Global/Armor/ViscusSnakeArmor
---
# Class ViscusSnakeArmor
...
Script for [The Naked Nest](/api/Global/Abnormalities/The-Naked-Nest/ViscusSnake)'s EGO Suit: Exuviae. No script, just a debug log.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → ViscusSnakeArmor

## Constructors
### ViscusSnakeArmor()
```csharp
public ViscusSnakeArmor()
```
