---
uid: Global.QueenBee
canonical_path: /api/Global/Misc/QueenBee
---
# Class QueenBee
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → QueenBee
...
### animScript
```csharp
public QueenBeeAnim animScript { get; }
```
