---
uid: Global.QueenBeeArmor
canonical_path: /api/Global/Armor/QueenBeeArmor
---
# Class QueenBeeArmor
...
Script for [Queen Bee](/api/Global/Abnormalities/Queen-Bee/QueenBee)'s EGO Suit: Hornet.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → QueenBeeArmor

## Constructors
### QueenBeeArmor()
```csharp
public QueenBeeArmor()
```
