---
uid: Global.QueenBeeWorkerAnim
canonical_path: /api/Global/Creature/QueenBeeWorkerAnim
---
...
Animation handler for [Queen Bee's workers](/api/Global/Abnormalities/Queen-Bee/QueenBeeWorker).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [AnimScript](/api/Global/Abnormalities/CreatureAnimScript) → QueenBeeWorkerAnim
