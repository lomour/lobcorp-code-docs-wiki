...
Damage over time debuff from [Queen Bee](/api/Global/Abnormalities/Queen-Bee/QueenBee).

Halves speed and does 8 red damage every 2 seconds for 20 seconds. Also adds a visual effect.

If the worker dies, spawns a [QueenBeeWorker](/api/Global/Abnormalities/Queen-Bee/QueenBeeWorker).


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → QueenBeeBuf
