---
uid: Global.QueenBeeWeapon
canonical_path: /api/Global/Weapon/QueenBeeWeapon
---
# Class QueenBeeWeapon
...
Script for [Queen Bee](/api/Global/Abnormalities/Queen-Bee/QueenBee)'s EGO Weapon: Hornet. No script.




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → QueenBeeWeapon
