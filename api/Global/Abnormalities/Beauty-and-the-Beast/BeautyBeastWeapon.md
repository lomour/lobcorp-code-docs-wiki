---
uid: Global.BeautyBeastWeapon
canonical_path: /api/Global/Weapon/BeautyBeastWeapon
---
# Class BeautyBeastWeapon
...
Script for [Beauty and the Beast](/api/Global/Abnormalities/Beauty-and-the-Beast/BeautyBeast)'s EGO Weapon: Horn.



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BeautyBeastWeapon

## Constructors
### BeautyBeastWeapon()
```csharp
public BeautyBeastWeapon()
```
