---
uid: Global.BeautyBeast
canonical_path: /api/Global/Misc/BeautyBeast
---
# Class BeautyBeast
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → BeautyBeast
...
### animScript
```csharp
public BeautyBeastAnim animScript { get; }
```
