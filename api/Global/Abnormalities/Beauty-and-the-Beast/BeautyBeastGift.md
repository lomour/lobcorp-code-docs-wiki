---
uid: Global.BeautyBeastGift
canonical_path: /api/Global/Gift/BeautyBeastGift
---
# Class BeautyBeastGift
...
Script for [Beauty and the Beast](/api/Global/Abnormalities/Beauty-and-the-Beast/BeautyBeast)'s EGO Gift: Horn. No script.



## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → BeautyBeastGift

## Constructors
### BeautyBeastGift()
```csharp
public BeautyBeastGift()
```
