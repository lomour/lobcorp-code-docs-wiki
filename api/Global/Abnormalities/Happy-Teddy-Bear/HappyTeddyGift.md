---
uid: Global.HappyTeddyGift
canonical_path: /api/Global/Gift/HappyTeddyGift
---
# Class HappyTeddyGift
...
Script for [Happy Teddy Bear](/api/Global/Abnormalities/Happy-Teddy-Bear/HappyTeddy)'s EGO Gift: Bear Paws.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → HappyTeddyGift

## Constructors
### HappyTeddyGift()
```csharp
public HappyTeddyGift()
```
