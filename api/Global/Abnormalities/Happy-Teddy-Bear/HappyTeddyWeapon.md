---
uid: Global.HappyTeddyWeapon
canonical_path: /api/Global/Weapon/HappyTeddyWeapon
---
# Class HappyTeddyWeapon
...
Script for [Happy Teddy Bear](/api/Global/Abnormalities/Happy-Teddy-Bear/HappyTeddy)'s EGO Weapon: Bear Paws.

Rolls damage twice when it hits.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → HappyTeddyWeapon
