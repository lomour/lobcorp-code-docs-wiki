---
uid: Global.HappyTeddy
canonical_path: /api/Global/Misc/HappyTeddy
---
# Class HappyTeddy
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Abnormalities/CreatureBase/CreatureBase) → HappyTeddy
...
### animScript
```csharp
public TeddyAnim animScript { get; }
```
