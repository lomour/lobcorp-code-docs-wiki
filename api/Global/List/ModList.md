...
---
uid: Global.ModList
canonical_path: /api/Global/List/ModList
---
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → ModList
...
#### Field Value
**Type:** System.Collections.Generic.List{ModInfo}
...
### MakeModInfo2(ModInfo, GameObject)
```csharp
