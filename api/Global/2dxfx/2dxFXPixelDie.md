...
---
uid: Global._2dxFX_PixelDie
canonical_path: /api/Global/2dxfx/2dxFXPixelDie
---

# Class _2dxFX_PixelDie
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → _2dxFX_PixelDie
