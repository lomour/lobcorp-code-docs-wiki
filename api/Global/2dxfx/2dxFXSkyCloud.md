...
---
uid: Global._2dxFX_SkyCloud
canonical_path: /api/Global/2dxfx/2dxFXSkyCloud
---

# Class _2dxFX_SkyCloud
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → _2dxFX_SkyCloud
