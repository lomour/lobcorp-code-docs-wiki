...
---
uid: Global._2dxFX_Pattern
canonical_path: /api/Global/2dxfx/2dxFXPattern
---

# Class _2dxFX_Pattern
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → _2dxFX_Pattern
