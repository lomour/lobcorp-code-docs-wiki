...
---
uid: Global._2dxFX_AL_Fire
canonical_path: /api/Global/2dxfx/2dxFXALFire
---

# Class _2dxFX_AL_Fire
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → _2dxFX_AL_Fire
