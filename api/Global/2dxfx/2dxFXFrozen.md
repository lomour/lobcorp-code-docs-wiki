...
---
uid: Global._2dxFX_Frozen
canonical_path: /api/Global/2dxfx/2dxFXFrozen
---
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → _2dxFX_Frozen
