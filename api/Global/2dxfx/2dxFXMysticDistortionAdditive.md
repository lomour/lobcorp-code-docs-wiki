---
uid: Global._2dxFX_Mystic_Distortion_Additive
canonical_path: /api/Global/2dxfx/2dxFXMysticDistortionAdditive
---
# Class _2dxFX_Mystic_Distortion_Additive
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → _2dxFX_Mystic_Distortion_Additive

## Constructors
### _2dxFX_Mystic_Distortion_Additive()
```csharp
