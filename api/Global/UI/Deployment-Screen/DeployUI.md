...
The deployment UI, including [all departments](/api/Global/UI/CheckPointUI), a button for the [E.G.O List](/api/Inventory/InventoryUI), a button to access the [manual](/api/Manual), and the Begin Management button.
