...
Represents a department on the [deployment screen](/api/Global/UI/Deployment-Screen/Agent-Deploying/DeploySefiraAgentSlot) for assigning agents.
...
## Implements
[IDeployResetCalled](/api/Global/UI/Deployment-Screen/IDeployResetCalled)
