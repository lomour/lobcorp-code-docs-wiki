---
uid: Global.SefiraPanelMissionUI
canonical_path: /api/Global/UI/SefiraPanelMissionUI
---
# Class SefiraPanelMissionUI
...
Displays a mission (or the prerequisites needed) on the [deployment screen](/api/Global/UI/Deployment-Screen/DeployUI).
...
### InitRequireBossStarting(List<string>)
```csharp
...
| Name | Type | Description |
| --- | --- | --- |
| `requireText` | `System.Collections.Generic.List{System.String}` |  |

### InitRequireMission(List<string>)
```csharp
