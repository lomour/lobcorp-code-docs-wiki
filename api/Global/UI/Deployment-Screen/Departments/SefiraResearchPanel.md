---
uid: Global.SefiraResearchPanel
canonical_path: /api/Global/Misc/SefiraResearchPanel
---
# Class SefiraResearchPanel
...
UI element for the research tab ^\[verify\]^on a [department on the deployment screen](/api/Global/UI/Deployment-Screen/Departments/SefiraPanel).
...
#### Field Value
**Type:** System.Collections.Generic.List{SefiraResearchSlot}
