...
Pop-up to display [agent](/api/Global/UI/Deployment-Screen/DeployUI) when an agent is selected.
...
## Implements
[IObserver](/api/Global/UI/Deployment-Screen/IDeployResetCalled)
