...
Stores sprite information about an [agent](/api/Global/Agents-and-Clerks/Agents/AgentUnit).

Used by [AgentPortrait](/api/Global/UI/Agent-UI/Agent-Portrait/AgentPortrait)
