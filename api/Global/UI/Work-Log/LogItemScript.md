---
uid: Global.LogItemScript
canonical_path: /api/Global/Script/LogItemScript
---
# Class LogItemScript
...
A message unit in the [work log](/api/Global/UI/Work-Log/LoggingScript).
...
### SetText(string, float, int, float, float)
```csharp
...
| --- | --- | --- |
| `context` | `System.String` |  |
| `maxXWidth` | `System.Single` |  |
| `size` | `System.Int32` |  |
| `h_spacing` | `System.Single` |  |
| `v_spacing` | `System.Single` |  |
