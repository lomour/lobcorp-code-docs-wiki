---
uid: Global.LogCanvasScaler
canonical_path: /api/Global/Misc/LogCanvasScaler
---
# Class LogCanvasScaler
...
UI element which sets the size of the [work log](/api/Global/UI/Work-Log/LoggingScript) when dragged.
...
### _rectTr
```csharp
private RectTransform _rectTr { get; }
```
