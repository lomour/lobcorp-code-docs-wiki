...
Holds a list of notable events during each quarter, mainly abnormality escapes and dead/panicked workers. Not sure how it works yet, but used by [ResultScreen](/api/Global/UI/Results-and-History/ResultScreen)'s Report.
