---
uid: Global.ResultScreenAgentSlot
canonical_path: /api/Global/Misc/ResultScreenAgentSlot
---
# Class ResultScreenAgentSlot
...
Displays an agent for the promotion window of the [ResultScreen](/api/Global/UI/Results-and-History/ResultScreen).
...
## Constructors
### ResultScreenAgentSlot()
```csharp
public ResultScreenAgentSlot()
```
...
## Methods
### Init(AgentModel, WorkerPrimaryStatBonus, int[], int)
```csharp
...
| `oldStat` | `Global.WorkerPrimaryStatBonus` |  |
| `oldStatLevels` | `System.Int32[]` |  |
