...
... Which is to say, by [Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird).




## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitModel](/api/Global/Abnormalities/CreatureModel) → EventCreatureModel
