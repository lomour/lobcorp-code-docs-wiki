...
```
List of all abnormalities, except [Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird).
...
```
The first entry of the first list, `r1[0][0]`, is the ID for [One Sin and Hundreds of Good Deeds](/api/Global/Abnormalities/One-Sin-and-Thousands-of-Good-Deeds/OneBadManyGood) to be used on Day 0. The rest of the values are unused.
...
```
Returns a list of all abnormalities except [WhiteNight](/api/WhiteNightSpace/DeathAngel) and [Apocalypse Bird](/api/Global/Abnormalities/Apocalypse-Bird/BossBird), and without tool abnormalities if removeTool is true.
