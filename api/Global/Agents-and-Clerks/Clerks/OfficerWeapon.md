---
uid: Global.OfficerWeapon
canonical_path: /api/Global/Weapon/OfficerWeapon
---
# Class OfficerWeapon
...
Script for a [clerk](/api/Global/Agents-and-Clerks/Clerks/OfficerUnit)'s weapon.
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/EGO/EquipmentScriptBase) → OfficerWeapon

## Constructors
### OfficerWeapon()
```csharp
public OfficerWeapon()
```
