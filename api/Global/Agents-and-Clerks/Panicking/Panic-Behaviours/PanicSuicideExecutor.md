...
Panic behaviour for an [agent](/api/Global/Agents-and-Clerks/Agents/AgentModel) to commit suicide after a certain amount of time.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [PanicAction](/api/Global/Agents-and-Clerks/Panicking/Panic-Behaviours/PanicAction) → PanicSuicideExecutor
