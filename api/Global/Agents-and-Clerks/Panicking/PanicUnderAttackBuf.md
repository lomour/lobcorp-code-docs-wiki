---
uid: Global.PanicUnderAttackBuf
canonical_path: /api/Global/UnitBuf/PanicUnderAttackBuf
---
# Class PanicUnderAttackBuf
...
Buff given to panicking employees with the [roaming](/api/Global/Agents-and-Clerks/Panicking/Panic-Behaviours/PanicOpenIsolate) panic behaviours when attacked. Slows movement to 0.5x for 3 seconds ^\[verify\]^.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Buffs/UnitBuf) → PanicUnderAttackBuf
