...
Class for [agent](/api/Global/Agents-and-Clerks/Agents/AgentUnit) yapping messages (and encounter/reaction text)

See [AgentSpeech](/api/Global/Agents-and-Clerks/Agents/Lyrics/AgentSpeech)
