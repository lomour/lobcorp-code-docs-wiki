---
uid: Global.ResultScreen
canonical_path: /api/Global/IANimatorEventCalled/ResultScreen
---
...
**Type:** Global.ResultScreen.Report
...
```csharp
public static ResultScreen instance { get; }
```
