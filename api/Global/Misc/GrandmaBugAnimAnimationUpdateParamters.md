---
uid: Global.GrandmaBugAnim.AnimationUpdateParamters
canonical_path: /api/Global/Misc/GrandmaBugAnimAnimationUpdateParamters
---
# Struct GrandmaBugAnim.AnimationUpdateParamters
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
private struct GrandmaBugAnim.AnimationUpdateParamters
```

## Fields
### animState
```csharp
public GrandmaBug.AnimationState animState
```
