---
title: ToolMapPassage
description: 
published: true
date: 2026-02-20T22:17:38.576Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:36:50.508Z
---

# Class ToolMapPassage
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → ToolMapPassage

## Constructors
### ToolMapPassage()
```csharp
public ToolMapPassage()
```
...
#### Field Value
**Type:** Global.ToolMapPassage_bloodPoint
...
| --- | --- | --- |
| `sefira` | `Global.ToolMapSefiraArea` |  |

#### Returns
**Type:** Global.ToolMapPassage
