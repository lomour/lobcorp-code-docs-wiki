---
title: CensoredCreatureBase
description: 
published: true
date: 2026-02-20T21:58:46.772Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:03:37.461Z
---

# Class CensoredCreatureBase
...
## Derived
[Censored](/api/Global/Misc/Censored), [CensoredChild](/api/Global/Misc/CensoredChild)

## Constructors
### CensoredCreatureBase()
```csharp
public CensoredCreatureBase()
```

## Fields
### _agentLevelCondition
```csharp
...
### motionDelay
```csharp
protected static float motionDelay { get; }
```
