...
description: 
published: true
date: 2026-02-23T19:55:48.991Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:19:41.686Z
---
...
```csharp
public class Mhz_1_76 : CreatureBase
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [CreatureBase](/api/Global/Creature/CreatureBase) → Mhz_1_76
...
### _anim
```csharp
private Mhz_1_76Anim _anim
```

#### Field Value
**Type:** Global.Mhz_1_76Anim

### _curWorkAgent
```csharp
private AgentModel _curWorkAgent
```
...
### _MAX_QLIPHOTH
```csharp
private readonly int _MAX_QLIPHOTH
```
...
### _noiseArea
```csharp
private List<Mhz_1_76.NoiseDmg> _noiseArea
```

#### Field Value
**Type:** System.Collections.Generic.List{Mhz_1_76.NoiseDmg}

### _noiseMakingFreq
```csharp
private readonly float _noiseMakingFreq
```
...
### _noiseMakingTimer
```csharp
private AutoTimer _noiseMakingTimer
```
...
### _SOUND_ACTIVE
```csharp
private readonly string _SOUND_ACTIVE
```
...
### _SOUND_ACTIVE_FREQ
```csharp
private readonly float _SOUND_ACTIVE_FREQ
```
...
### _SOUND_DEFAULT2
```csharp
private readonly string _SOUND_DEFAULT2
```
...
### _SOUND_FREQ
```csharp
private readonly float _SOUND_FREQ
```
...
### _soundActive
```csharp
private SoundEffectPlayer _soundActive
```
...
### _soundActiveTimer
```csharp
private AutoTimer _soundActiveTimer
```
...
### _soundDefault2
```csharp
private SoundEffectPlayer _soundDefault2
```
