...
description: 
published: true
date: 2026-02-20T22:10:03.349Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:23:18.952Z
---
...
### _curState
```csharp
private Ppodae.PpodaeState _curState
```
...
## Properties
### _targetArriveCondition
```csharp
private bool _targetArriveCondition { get; }
```

#### Property Value
**Type:** System.Boolean

### _targetChangeCondition
```csharp
private bool _targetChangeCondition { get; }
```
...
```csharp
private void SetState(Ppodae.PpodaeState state)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `state` | `Global.Ppodae.PpodaeState` |  |
