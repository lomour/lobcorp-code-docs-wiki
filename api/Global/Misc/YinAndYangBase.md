---
title: YinAndYangBase
description: 
published: true
date: 2026-02-20T22:19:33.264Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:40:19.904Z
---

# Class YinAndYangBase
...
## Derived
[Yang](/api/Global/Misc/Yang), [Yin](/api/Global/Misc/Yin)

## Constructors
### YinAndYangBase()
```csharp
public YinAndYangBase()
```
...
### DstNode
```csharp
protected MapNode DstNode { get; set; }
```
...
## Methods
### AddCollisionUnit(object)
```csharp
public void AddCollisionUnit(object unit)
```
