...
---
uid: Global.UIEffectManager.TempException
canonical_path: /api/Global/Misc/UIEffectManagerTempException
---

# Class UIEffectManager.TempException
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class UIEffectManager.TempException : Exception, ISerializable, _Exception
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/dotnet/api/system.exception) → UIEffectManager.TempException
...
### TempException(int, string)
```csharp
public TempException(int type, string message)
```
