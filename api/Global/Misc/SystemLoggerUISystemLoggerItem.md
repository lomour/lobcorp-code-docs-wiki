...
```csharp
public class SystemLoggerUI.SystemLoggerItem
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → SystemLoggerUI.SystemLoggerItem
...
### SystemLoggerItem(long)
```csharp
public SystemLoggerItem(long id)
```
