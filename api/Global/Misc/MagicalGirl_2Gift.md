---
title: MagicalGirl_2Gift
description: 
published: true
date: 2026-02-23T20:00:13.072Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:18:12.614Z
---

# Class MagicalGirl_2Gift
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class MagicalGirl_2Gift : EquipmentScriptBase
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [EquipmentScriptBase](/api/Global/Misc/EquipmentScriptBase) → MagicalGirl_2Gift

## Constructors
### MagicalGirl_2Gift()
```csharp
public MagicalGirl_2Gift()
```
