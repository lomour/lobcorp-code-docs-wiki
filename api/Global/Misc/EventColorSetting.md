---
title: EventColorSetting
description: 
published: true
date: 2026-02-20T22:02:19.440Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:09:52.037Z
---

# Class EventColorSetting
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → EventColorSetting
...
| --- | --- | --- |
| `target` | `UnityEngine.EventSystems.EventTrigger.Entry` |  |
| `added` | `Global.EventColorSetting.EventAdded` |  |
