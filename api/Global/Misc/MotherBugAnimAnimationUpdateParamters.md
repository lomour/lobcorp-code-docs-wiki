---
uid: Global.MotherBugAnim.AnimationUpdateParamters
canonical_path: /api/Global/Misc/MotherBugAnimAnimationUpdateParamters
---
# Struct MotherBugAnim.AnimationUpdateParamters
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
private struct MotherBugAnim.AnimationUpdateParamters
```

## Fields
### animState
```csharp
public MotherBug.AnimationState animState
```
