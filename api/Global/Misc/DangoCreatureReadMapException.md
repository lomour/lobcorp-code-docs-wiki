...
---
uid: Global.DangoCreature.ReadMapException
canonical_path: /api/Global/Misc/DangoCreatureReadMapException
---

# Class DangoCreature.ReadMapException
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
private class DangoCreature.ReadMapException : Exception, ISerializable, _Exception
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/dotnet/api/system.exception) → DangoCreature.ReadMapException
