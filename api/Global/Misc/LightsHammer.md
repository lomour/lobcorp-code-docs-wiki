...
---
uid: Global.LightsHammer
canonical_path: /api/Global/Misc/LightsHammer
---
...
### filterState
```csharp
private LightsHammer.HammerFilterState filterState
```
...
### CreatreWarrior(AgentModel, UnitModel, int)
```csharp
...
| --- | --- | --- |
| `baseWorker` | `Global.AgentModel` |  |
| `target` | `Global.UnitModel` |  |
| `num` | `System.Int32` |  |

### EquipHammer(AgentModel)
```csharp
