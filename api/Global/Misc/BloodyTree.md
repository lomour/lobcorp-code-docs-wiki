...
description: 
published: true
date: 2026-02-20T21:57:14.392Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:00:58.868Z
---
...
### escapedUtil
```csharp
private CreatureCameraUtil escapedUtil
```
...
### nonEscapedUtil
```csharp
private CreatureCameraUtil nonEscapedUtil
```

#### Field Value
**Type:** CreatureCameraUtil.CreatureCameraUtil

### QliphothCounterSubDelay
```csharp
...
### AnimScript
```csharp
public BloodyTreeAnim AnimScript { get; }
```

#### Property Value
**Type:** Global.BloodyTreeAnim

### MaxWork
```csharp
private int MaxWork { get; }
```
...
### CheckTeleportState(out PassageObjectModel)
```csharp
