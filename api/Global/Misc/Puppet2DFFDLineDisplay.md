---
title: Puppet2DFFDLineDisplay
description: 
published: true
date: 2026-02-20T22:10:23.550Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:23:55.228Z
---

# Class Puppet2D_FFDLineDisplay
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → Puppet2D_FFDLineDisplay

## Constructors
### Puppet2D_FFDLineDisplay()
```csharp
public Puppet2D_FFDLineDisplay()
```
...
### internalWeights
```csharp
private List<float> internalWeights
```
