...
---
uid: Global.InventoryScrollArrowController
canonical_path: /api/Global/Misc/InventoryScrollArrowController
---

# Class InventoryScrollArrowController
...
### InventoryScrollArrowController()
```csharp
public InventoryScrollArrowController()
```
...
### RectTr
```csharp
public RectTransform RectTr { get; }
```
