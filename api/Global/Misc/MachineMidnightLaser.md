---
title: MachineMidnightLaser
description: 
published: true
date: 2026-02-20T22:07:04.101Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:17:59.344Z
---

# Class MachineMidnightLaser
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → MachineMidnightLaser

## Constructors
### MachineMidnightLaser()
```csharp
...
### list
```csharp
private List<MachineMidnightLaser.DamageUnit> list
```

#### Field Value
**Type:** System.Collections.Generic.List{MachineMidnightLaser.DamageUnit}

## Properties
### Collider
```csharp
private BoxCollider2D Collider { get; }
```
...
### damageInfo
```csharp
private DamageInfo damageInfo { get; }
```
...
### damageType
```csharp
private RwbpType damageType { get; }
```
