...
---
uid: Global.ScavengerNoon
canonical_path: /api/Global/Misc/ScavengerNoon
---
...
### animScript
```csharp
public ScavengerNoonAnim animScript { get; }
```
...
### MakeExplodeEffect(WorkerModel, float, bool)
```csharp
