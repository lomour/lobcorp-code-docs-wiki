...
description: 
published: true
date: 2026-02-20T22:12:37.731Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:27:48.621Z
---
...
### animScript
```csharp
public SakuraAnim animScript { get; }
```
...
### cancelAttractDmg
```csharp
private static DamageInfo cancelAttractDmg { get; }
```
...
### CheckHealCondition(WorkerModel)
```csharp
