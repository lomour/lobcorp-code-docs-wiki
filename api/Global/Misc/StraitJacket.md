---
uid: Global.StraitJacket
canonical_path: /api/Global/Misc/StraitJacket
---
# Class StraitJacket
...
### animScript
```csharp
private StraitJacketAnim animScript { get; }
```
...
### MoveSoundFreq
```csharp
private float MoveSoundFreq { get; }
```
...
### StandSoundFreq
```csharp
private float StandSoundFreq { get; }
```
