---
title: CFXSpawnSystem
description: 
published: true
date: 2026-02-20T21:58:36.525Z
tags: 
editor: markdown
dateCreated: 2026-01-15T04:03:20.742Z
---
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → CFX_SpawnSystem
...
#### Field Value
**Type:** System.Collections.Generic.Dictionary{System.Int32,System.Collections.Generic.List{UnityEngine.GameObject}}
...
## Methods
### addObjectToPool(GameObject, int)
```csharp
...
| --- | --- | --- |
| `sourceObject` | `UnityEngine.GameObject` |  |
| `number` | `System.Int32` |  |
...
| Name | Type | Description |
| --- | --- | --- |
| `sourceObj` | `UnityEngine.GameObject` |  |
| `activateObject` | `System.Boolean` |  |

#### Returns
**Type:** UnityEngine.GameObject

### increasePoolCursor(int)
```csharp
...
### removeObjectsFromPool(GameObject)
```csharp
