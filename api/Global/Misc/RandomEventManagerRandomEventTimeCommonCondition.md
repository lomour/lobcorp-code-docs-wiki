...
---
uid: Global.RandomEventManager.RandomEventTime.CommonCondition
canonical_path: /api/Global/Misc/RandomEventManagerRandomEventTimeCommonCondition
---

# Struct RandomEventManager.RandomEventTime.CommonCondition
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public struct RandomEventManager.RandomEventTime.CommonCondition
```
