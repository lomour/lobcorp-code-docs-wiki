---
uid: Global.SceneDataSave
canonical_path: /api/Global/Misc/SceneDataSave
---
# Class SceneDataSave
...
#### Field Value
**Type:** System.Collections.Generic.List{CreatureMaxObserve.Angela}
...
## Methods
### AddMaxObservedCreautre(CreatureMaxObserve)
```csharp
...
| --- | --- | --- |
| `module` | `Global.CreatureMaxObserve` |  |
