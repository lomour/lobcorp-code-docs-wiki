...
---
uid: Global.ResearcherNote.ResearcherNoteEquipBuf
canonical_path: /api/Global/UnitStatBuf/ResearcherNoteResearcherNoteEquipBuf
---

# Class ResearcherNote.ResearcherNoteEquipBuf
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class ResearcherNote.ResearcherNoteEquipBuf : UnitStatBuf
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Misc/UnitBuf) → [UnitStatBuf](/api/Global/UnitBuf/UnitStatBuf) → ResearcherNote.ResearcherNoteEquipBuf

## Constructors

### ResearcherNoteEquipBuf()
```csharp
public ResearcherNoteEquipBuf()
```
