...
---
uid: Global.DesireHeart.DesireHeartEquipBuf
canonical_path: /api/Global/UnitStatBuf/DesireHeartDesireHeartEquipBuf
---

# Class DesireHeart.DesireHeartEquipBuf
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class DesireHeart.DesireHeartEquipBuf : UnitStatBuf
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Misc/UnitBuf) → [UnitStatBuf](/api/Global/UnitBuf/UnitStatBuf) → DesireHeart.DesireHeartEquipBuf

## Constructors

### DesireHeartEquipBuf()
```csharp
public DesireHeartEquipBuf()
```
