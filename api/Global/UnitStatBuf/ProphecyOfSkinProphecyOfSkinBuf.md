---
uid: Global.ProphecyOfSkin.ProphecyOfSkinBuf
canonical_path: /api/Global/UnitStatBuf/ProphecyOfSkinProphecyOfSkinBuf
---
# Class ProphecyOfSkin.ProphecyOfSkinBuf
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class ProphecyOfSkin.ProphecyOfSkinBuf : UnitStatBuf
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Misc/UnitBuf) → [UnitStatBuf](/api/Global/UnitBuf/UnitStatBuf) → ProphecyOfSkin.ProphecyOfSkinBuf

## Constructors
### ProphecyOfSkinBuf(int)
```csharp
public ProphecyOfSkinBuf(int a)
```
