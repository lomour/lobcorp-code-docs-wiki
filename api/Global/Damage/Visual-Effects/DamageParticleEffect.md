...
Particle that shows up on hit, sometimes (NOT to be confused with [DamageEffect](/api/Global/Damage/Visual-Effects/DamageEffect), which displays damage type and amount).

Has different particles for each damage type.


## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → [EffectInvoker](/api/Global/Visual-Effects/EffectInvoker) → DamageParticleEffect
