---
title: SystemLoggerUI
description: 
published: true
date: 2026-02-20T21:50:00.541Z
tags: 
editor: markdown
dateCreated: 2026-01-15T03:48:27.232Z
---
...
### creatureList
```csharp
private List<SystemLoggerUI.CreatureSystemLog> creatureList
```

#### Field Value
**Type:** System.Collections.Generic.List{SystemLoggerUI.CreatureSystemLog}
...
### CheckContains(long)
```csharp
public SystemLoggerUI.CreatureSystemLog CheckContains(long target)
```
...
#### Returns
**Type:** Global.SystemLoggerUI.CreatureSystemLog
