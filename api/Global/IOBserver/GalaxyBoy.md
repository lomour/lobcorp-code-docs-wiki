...
---
uid: Global.GalaxyBoy
canonical_path: /api/Global/IOBserver/GalaxyBoy
---
...
### speechTimer
```csharp
private CreatureBase.CreatureTimer speechTimer
```
...
### QliphothActivated
```csharp
public bool QliphothActivated { get; }
```
...
### OnOtherCreatureReleaseWork(CreatureModel)
```csharp
