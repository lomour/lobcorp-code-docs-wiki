...
---
uid: Global.CheckPointUI
canonical_path: /api/Global/IOBserver/CheckPointUI
---
...
### _endEvent
```csharp
private CheckPointUI.EndEvnet _endEvent
```

#### Field Value
**Type:** Global.CheckPointUI.EndEvnet
...
### SetEndEvent(EndEvnet)
```csharp
public void SetEndEvent(CheckPointUI.EndEvnet e)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `e` | `Global.CheckPointUI.EndEvnet` |  |
