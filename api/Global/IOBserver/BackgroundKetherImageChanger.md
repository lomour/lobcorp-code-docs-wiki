---
uid: Global.BackgroundKetherImageChanger
canonical_path: /api/Global/IOBserver/BackgroundKetherImageChanger
---

# Class BackgroundKetherImageChanger
...
### BackgroundKetherImageChanger()

```csharp
public BackgroundKetherImageChanger()
```
