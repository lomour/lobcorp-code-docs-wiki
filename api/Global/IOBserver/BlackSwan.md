---
uid: Global.BlackSwan
canonical_path: /api/Global/IOBserver/BlackSwan
---
# Class BlackSwan
...
### animScript
```csharp
public BlackSwanAnim animScript { get; }
```
