...
---
uid: Global.YouMustHappy
canonical_path: /api/Global/IOBserver/YouMustHappy
---
...
### _curUsingAgent
```csharp
private YouMustHappy.UsedAgent _curUsingAgent
```

#### Field Value
**Type:** Global.YouMustHappy.UsedAgent

### _DEFAULT_CHANGE_FREQ
```csharp
...
### _usedAgentList
```csharp
private List<YouMustHappy.UsedAgent> _usedAgentList
```

#### Field Value
**Type:** System.Collections.Generic.List{YouMustHappy.UsedAgent}

## Properties

### BufEquation
```csharp
private int BufEquation { get; }
```
