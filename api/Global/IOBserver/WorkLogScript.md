...
---
uid: Global.WorkLogScript
canonical_path: /api/Global/IOBserver/WorkLogScript
---
...
### WorkLogScript()
```csharp
public WorkLogScript()
```

## Fields

### _currentTargetCreature
```csharp
...
### currentTargetCreature
```csharp
public CreatureModel currentTargetCreature { get; set; }
```
