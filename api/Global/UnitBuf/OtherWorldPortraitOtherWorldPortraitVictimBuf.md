...
---
uid: Global.OtherWorldPortrait.OtherWorldPortraitVictimBuf
canonical_path: /api/Global/UnitBuf/OtherWorldPortraitOtherWorldPortraitVictimBuf
---

# Class OtherWorldPortrait.OtherWorldPortraitVictimBuf
**Namespace:** [Global](/api/Global)
**Assembly:** Assembly-CSharp.dll

```csharp
public class OtherWorldPortrait.OtherWorldPortraitVictimBuf : UnitBuf
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [UnitBuf](/api/Global/Misc/UnitBuf) → OtherWorldPortrait.OtherWorldPortraitVictimBuf

## Constructors

### OtherWorldPortraitVictimBuf()
```csharp
