...
### GenEffect(GlobalBulletType, Vector3)
```csharp
...
#### Returns
**Type:** GlobalBullet.GlobalBulletEffect

### GetEffectSrc(GlobalBulletType)
```csharp
...
| Name | Type | Description |
| --- | --- | --- |
| `t` | `GlobalBullet.GlobalBulletType` |  |
