...
```csharp
[ExecuteInEditMode]
public class KetherBossDust : MonoBehaviour
```

## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → KetherBossDust

## Constructors

### KetherBossDust()
```csharp
public KetherBossDust()
```
