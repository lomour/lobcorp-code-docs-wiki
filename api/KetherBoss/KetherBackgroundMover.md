...
public class KetherBackgroundMover : MonoBehaviour
```
...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → KetherBackgroundMover

## Constructors

### KetherBackgroundMover()
```csharp
public KetherBackgroundMover()
```
