...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [SefiraBossBase](/api/Global/Core-Suppressions/SefiraBossBase) → [KetherBossBase](/api/KetherBoss/KetherBossBase) → KetherUpperBossBase
