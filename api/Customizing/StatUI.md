...
description: 
published: true
date: 2026-07-07T17:21:29.596Z
tags: 
editor: markdown
dateCreated: 2026-01-15T02:56:36.231Z
---
...
### BStat
```csharp
public StatUI.StatController BStat
```

#### Field Value
**Type:** Customizing.StatUI.StatController
...
### PStat
```csharp
public StatUI.StatController PStat
```
...
### RStat
```csharp
public StatUI.StatController RStat
```
...
### WStat
```csharp
public StatUI.StatController WStat
```
...
### CurrentData
```csharp
public AgentData CurrentData { get; }
```
...
### MaxStatLevel
```csharp
public static int MaxStatLevel { get; }
```
