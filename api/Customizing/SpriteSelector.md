...
### action
```csharp
public SpriteSelector.OnSetSpriteAction action
```

#### Field Value
**Type:** Customizing.SpriteSelector.OnSetSpriteAction
...
| Name | Type | Description |
| --- | --- | --- |
| `sprites` | `System.Collections.Generic.List{UnityEngine.Sprite}` |  |
...
```csharp
public void OnSetSpriteActionInit(SpriteSelector.OnSetSpriteAction action)
```

#### Parameters
| Name | Type | Description |
| --- | --- | --- |
| `action` | `Customizing.SpriteSelector.OnSetSpriteAction` |  |
