...
## Inheritance
[object](https://learn.microsoft.com/dotnet/api/system.object) → [Object](#) → [Component](#) → [Behaviour](#) → [MonoBehaviour](#) → ForceCameraRatio

## Constructors
### ForceCameraRatio()
```csharp
public ForceCameraRatio()
```
...
#### Field Value
**Type:** System.Collections.Generic.List{LetterboxCamera.CameraRatio}

### createCameraForLetterBoxRendering
```csharp
public bool createCameraForLetterBoxRendering
```

#### Field Value
**Type:** System.Boolean

### findCamerasAutomatically
```csharp
public bool findCamerasAutomatically
```
...
### letterBoxCameraColor
```csharp
public Color letterBoxCameraColor
```
...
```csharp
public bool listenForWindowChanges
```
...
#### Returns
**Type:** LetterboxCamera.CameraRatio
...
### SetCameraAnchor(Camera, Vector2)
```csharp
